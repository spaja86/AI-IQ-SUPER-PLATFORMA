 ...
 * @author Nikola Spajic -- Kompanija SPAJA
 * @notice Digitalna banka na Polygon mrezi -- svaka transakcija je javno proverljiva
 ...
 *   - Svi podaci su citljivi sa https://polygonscan.com
 *   - Nijedna transakcija ne moze biti izbrisana ili izmenjena
 */
contract AIIQWorldBank {
    ...
    // --- Dogadjaji (Events) -- javno proverljivi na blockchain-u --
    ...
    constructor() {
        ...
        // Inicijalizacija racuna Digitalne Industrije
     ...
     * @dev Samo vlasnik moze upisivati transakcije
     */
    ...
    /**
     * @notice Dodaj sredstva na racun
     */
    ...
    /**
     * @notice Dohvati listu svih racuna
     */
    ...
    /**
     * @notice Prenesi vlasnistvo (2-step za sigurnost)
     */
    ...
    function _upisNabavki() internal {
        ...
        _upisTransakcijuInternu("Firewall Sistem", "Napredna zastita mreze", 18_000, Valuta.USD, "AI IQ World Bank -- DIGI-IND-001", "Digitalna Industrija -- Firewall Sistem");
        _upisTransakcijuInternu("VPN Mreza", "Privatna virtualna mreza", 8_000, Valuta.USD, "AI IQ World Bank -- DIGI-IND-001", "Digitalna Industrija -- VPN Mreza");
        ...
        _upisTransakcijuInternu("AI Laboratorija", "Simulacije i istrazivanje", 50_000, Valuta.USD, "AI IQ World Bank -- DIGI-IND-001", "Digitalna Industrija -- AI Laboratorija");
        ...
        _upisTransakcijuInternu("Data Centar", "Fizicka serverska infrastruktura", 80_000, Valuta.USD, "AI IQ World Bank -- DIGI-IND-001", "Digitalna Industrija -- Data Centar");
        ...
        _upisTransakcijuInternu("IoT Platforma", "Internet of Things mreza", 20_000, Valuta.USD, "AI IQ World Bank -- DIGI-IND-001", "Digitalna Industrija -- IoT Platforma");
        _upisTransakcijuInternu("Quantum Simulator", "Kvantno racunarstvo simulacija", 60_000, Valuta.USD, "AI IQ World Bank -- DIGI-IND-001", "Digitalna Industrija -- Quantum Simulator");
        ...
        _upisTransakcijuInternu("API Gateway", "Centralni API menadzment", 20_000, Valuta.USD, "AI IQ World Bank -- DIGI-IND-001", "Digitalna Industrija -- API Gateway");
        ...
        _upisTransakcijuInternu("Social Platform", "Drustvena mreza komponenta", 25_000, Valuta.USD, "AI IQ World Bank -- DIGI-IND-001", "Digitalna Industrija -- Social Platform");
        _upisTransakcijuInternu("Search Engine", "Interni pretrazivac", 20_000, Valuta.USD, "AI IQ World Bank -- DIGI-IND-001", "Digitalna Industrija -- Search Engine");
        ...
        _upisTransakcijuInternu("CDN Mreza", "Content delivery network", 15_000, Valuta.USD, "AI IQ World Bank -- DIGI-IND-001", "Digitalna Industrija -- CDN Mreza");
        _upisTransakcijuInternu("Load Balancer", "Rasporedjivac opterecenja", 10_000, Valuta.USD, "AI IQ World Bank -- DIGI-IND-001", "Digitalna Industrija -- Load Balancer");
        ...
        _upisTransakcijuInternu("Reporting Engine", "Izvestaji i dashboardi", 10_000, Valuta.USD, "AI IQ World Bank -- DIGI-IND-001", "Digitalna Industrija -- Reporting Engine");
        _upisTransakcijuInternu("Fleet Management", "GPS pracenje i optimizacija ruta", 15_000, Valuta.USD, "AI IQ World Bank -- DIGI-IND-001", "Digitalna Industrija -- Fleet Management");

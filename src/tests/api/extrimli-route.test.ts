...
async function runTests(): Promise<void> {
  ...
  await test('GET /api/extrimli/extrondol returns orchestration report and headers', async () => {
    ...
    assert(body.data.dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.covecnostAuditVisualReference.supplementalVisualReferences[1].canonicalNarrativeId === 'covecanstvo-entizujazam-zvezde-misli-inovacije-developer-create', 'unexpected developer/create ENTIZUJAŽAM supplemental narrative id');
    assert(body.data.dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.covecnostAuditVisualReference.supplementalVisualReferences[1].visualReference.includes('f7b3e102-e0a0-4885-a93e-040f09454737'), 'unexpected developer/create ENTIZUJAŽAM supplemental visual reference');
    ...
    assert(body.data.releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.covecnostAuditVisualReference.supplementalVisualReferences[1].canonicalNarrativeId === 'covecanstvo-entizujazam-zvezde-misli-inovacije-developer-create', 'unexpected release-audit developer/create ENTIZUJAŽAM supplemental narrative id');
    assert(body.data.releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.covecnostAuditVisualReference.supplementalVisualReferences[1].visualReference.includes('f7b3e102-e0a0-4885-a93e-040f09454737'), 'unexpected release-audit developer/create ENTIZUJAŽAM supplemental visual reference');
  ...
  await test('GET /api/extrimli/spaja-kod returns encapsulated facade and headers', async () => {
    ...
    assert(body.data.developerAndCreateVisualReflection.supplementalVisualReferences[1].canonicalNarrativeId === 'covecanstvo-entizujazam-zvezde-misli-inovacije-developer-create', 'unexpected SPAJA KOD developer/create ENTIZUJAŽAM supplemental narrative id');
    assert(body.data.developerAndCreateVisualReflection.supplementalVisualReferences[1].visualReference.includes('f7b3e102-e0a0-4885-a93e-040f09454737'), 'unexpected SPAJA KOD developer/create ENTIZUJAŽAM supplemental visual reference');

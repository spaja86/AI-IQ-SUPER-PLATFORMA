...
async function runTests(): Promise<void> {
  ...
  await test('GET /api/extrimli/spaja-kod returns encapsulated facade and headers', async () => {
    ...
    assert(body.data.publicSignals.kraljevskiProgramskiUneverzitetStatus === body.data.dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.kraljevskiProgramskiUneverzitet.readiness.status, 'unexpected SPAJA KOD programmatic summary status');

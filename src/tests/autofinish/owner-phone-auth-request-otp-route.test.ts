// Autofinish — owner-phone-auth/request-otp Route Coverage Test
...
import { GET, POST } from '../../app/api/owner-phone-auth/request-otp/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 owner-phone-auth/request-otp — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/owner-phone-auth/request-otp/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/owner-phone-auth/request-otp', {

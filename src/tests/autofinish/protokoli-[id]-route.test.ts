// Autofinish — protokoli/[id] Route Coverage Test
...
import { GET } from '../../app/api/protokoli/[id]/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 protokoli/[id] — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/protokoli/[id]/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/protokoli/[id]', {

// Autofinish — verzija-istorija Route Coverage Test
...
import { GET } from '../../app/api/verzija-istorija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 verzija-istorija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/verzija-istorija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/verzija-istorija', {

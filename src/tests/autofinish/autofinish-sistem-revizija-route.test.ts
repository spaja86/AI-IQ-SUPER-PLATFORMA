// Autofinish — autofinish-sistem-revizija Route Coverage Test
...
import { GET } from '../../app/api/autofinish-sistem-revizija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-sistem-revizija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-sistem-revizija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-sistem-revizija', {

// Autofinish — omega-projekat-ekosistem Route Coverage Test
...
import { GET } from '../../app/api/omega-projekat-ekosistem/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-projekat-ekosistem — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-projekat-ekosistem/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-projekat-ekosistem', {

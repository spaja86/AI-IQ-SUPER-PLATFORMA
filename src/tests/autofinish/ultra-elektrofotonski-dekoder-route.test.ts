// Autofinish — ultra-elektrofotonski-dekoder Route Coverage Test
...
import { GET } from '../../app/api/ultra-elektrofotonski-dekoder/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 ultra-elektrofotonski-dekoder — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ultra-elektrofotonski-dekoder/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/ultra-elektrofotonski-dekoder', {

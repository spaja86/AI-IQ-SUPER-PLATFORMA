// Autofinish — banka-kontakt-drustvene-mreze Route Coverage Test
...
import { GET } from '../../app/api/banka-kontakt-drustvene-mreze/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 banka-kontakt-drustvene-mreze — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/banka-kontakt-drustvene-mreze/route.ts');

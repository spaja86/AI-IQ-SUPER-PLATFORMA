// Autofinish — platforma-holografski-emiter Route Coverage Test
...
import { GET } from '../../app/api/platforma-holografski-emiter/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-holografski-emiter — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-holografski-emiter/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-holografski-emiter', {

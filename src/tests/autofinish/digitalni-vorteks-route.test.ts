// Autofinish — digitalni-vorteks Route Coverage Test
...
import { GET } from '../../app/api/digitalni-vorteks/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 digitalni-vorteks — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/digitalni-vorteks/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/digitalni-vorteks', {

// Autofinish — spaja-realtime-kanali Route Coverage Test
...
import { GET } from '../../app/api/spaja-realtime-kanali/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-realtime-kanali — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-realtime-kanali/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-realtime-kanali', {

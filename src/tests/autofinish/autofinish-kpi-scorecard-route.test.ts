// Autofinish — autofinish-kpi-scorecard Route Coverage Test
...
import { GET } from '../../app/api/autofinish-kpi-scorecard/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-kpi-scorecard — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-kpi-scorecard/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-kpi-scorecard', {

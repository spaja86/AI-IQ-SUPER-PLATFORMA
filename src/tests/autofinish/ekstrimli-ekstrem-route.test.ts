// Autofinish — ekstrimli-ekstrem Route Coverage Test
...
import { GET } from '../../app/api/ekstrimli-ekstrem/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 ekstrimli-ekstrem — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ekstrimli-ekstrem/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/ekstrimli-ekstrem', {

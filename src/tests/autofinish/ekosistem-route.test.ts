// Autofinish — ekosistem Route Coverage Test
...
import { GET } from '../../app/api/ekosistem/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 ekosistem — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ekosistem/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/ekosistem', {

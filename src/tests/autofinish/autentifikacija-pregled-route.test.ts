// Autofinish — autentifikacija-pregled Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 autentifikacija-pregled — Route Coverage Test Suite\n');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autentifikacija-pregled', {

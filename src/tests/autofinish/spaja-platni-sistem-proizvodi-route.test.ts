// Autofinish — spaja-platni-sistem-proizvodi Route Coverage Test
...
import { GET } from '../../app/api/spaja-platni-sistem-proizvodi/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-platni-sistem-proizvodi — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-platni-sistem-proizvodi/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-platni-sistem-proizvodi', {

// Autofinish — paypal/webhook Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 paypal/webhook — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/paypal/webhook/route.ts');

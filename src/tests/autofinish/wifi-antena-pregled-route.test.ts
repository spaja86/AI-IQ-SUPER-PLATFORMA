// Autofinish — wifi-antena-pregled Route Coverage Test
...
import { GET } from '../../app/api/wifi-antena-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 wifi-antena-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/wifi-antena-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/wifi-antena-pregled', {

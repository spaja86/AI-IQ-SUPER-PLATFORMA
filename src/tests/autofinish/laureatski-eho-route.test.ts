// Autofinish — laureatski-eho Route Coverage Test
...
import { GET } from '../../app/api/laureatski-eho/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 laureatski-eho — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/laureatski-eho/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/laureatski-eho', {

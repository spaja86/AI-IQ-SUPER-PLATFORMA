// Autofinish — dijagnostika-ai-preporuke Route Coverage Test
...
import { GET } from '../../app/api/dijagnostika-ai-preporuke/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 dijagnostika-ai-preporuke — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/dijagnostika-ai-preporuke/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/dijagnostika-ai-preporuke', {

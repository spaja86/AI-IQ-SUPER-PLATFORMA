// Autofinish — autofinish-endpoint-inventar Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-endpoint-inventar — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-endpoint-inventar/route.ts');

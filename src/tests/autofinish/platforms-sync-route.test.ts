// Autofinish — platforms/sync Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 platforms/sync — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforms/sync/route.ts');

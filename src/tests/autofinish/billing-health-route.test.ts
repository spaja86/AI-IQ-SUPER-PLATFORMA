// Autofinish — billing-health Route Coverage Test
...
import { GET } from '../../app/api/billing-health/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 billing-health — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/billing-health/route.ts');

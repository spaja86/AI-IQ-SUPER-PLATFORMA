// Autofinish — seo-nominalni-protok Route Coverage Test
...
import { GET } from '../../app/api/seo-nominalni-protok/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 seo-nominalni-protok — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/seo-nominalni-protok/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/seo-nominalni-protok', {

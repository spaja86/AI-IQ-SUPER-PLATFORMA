// Autofinish — industrija-gaming Route Coverage Test
...
import { GET } from '../../app/api/industrija-gaming/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 industrija-gaming — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/industrija-gaming/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/industrija-gaming', {

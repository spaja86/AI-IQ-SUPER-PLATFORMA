// Autofinish — platforma-replikacija Route Coverage Test
...
import { GET } from '../../app/api/platforma-replikacija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-replikacija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-replikacija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-replikacija', {

// Autofinish — laureatski-puls Route Coverage Test
...
import { GET } from '../../app/api/laureatski-puls/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 laureatski-puls — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/laureatski-puls/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/laureatski-puls', {

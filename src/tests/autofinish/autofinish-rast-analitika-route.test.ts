// Autofinish — autofinish-rast-analitika Route Coverage Test
...
import { GET } from '../../app/api/autofinish-rast-analitika/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-rast-analitika — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-rast-analitika/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-rast-analitika', {

// Autofinish — wallet/compliance Route Coverage Test
...
import { GET } from '../../app/api/wallet/compliance/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 wallet/compliance — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/wallet/compliance/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/wallet/compliance', {

// Autofinish — ultra-magnetarski-osciloskop Route Coverage Test
...
import { GET } from '../../app/api/ultra-magnetarski-osciloskop/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 ultra-magnetarski-osciloskop — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ultra-magnetarski-osciloskop/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/ultra-magnetarski-osciloskop', {

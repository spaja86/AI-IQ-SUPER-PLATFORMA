// Autofinish — mobilna-statistika Route Coverage Test
...
import { GET } from '../../app/api/mobilna-statistika/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 mobilna-statistika — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/mobilna-statistika/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/mobilna-statistika', {

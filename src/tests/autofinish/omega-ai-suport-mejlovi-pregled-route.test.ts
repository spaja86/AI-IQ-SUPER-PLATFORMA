// Autofinish — omega-ai-suport-mejlovi-pregled Route Coverage Test
...
import { GET } from '../../app/api/omega-ai-suport-mejlovi-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-ai-suport-mejlovi-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-ai-suport-mejlovi-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-ai-suport-mejlovi-pregled', {

// Autofinish — autofinish-workflow-orchestracija Route Coverage Test
...
import { GET } from '../../app/api/autofinish-workflow-orchestracija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-workflow-orchestracija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-workflow-orchestracija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-workflow-orchestracija', {

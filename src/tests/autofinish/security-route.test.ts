// Autofinish — security Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 security — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/security/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/security', {

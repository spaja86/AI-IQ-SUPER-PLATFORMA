// Autofinish — platforma-neuronski-akcelerator Route Coverage Test
...
import { GET } from '../../app/api/platforma-neuronski-akcelerator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-neuronski-akcelerator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-neuronski-akcelerator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-neuronski-akcelerator', {

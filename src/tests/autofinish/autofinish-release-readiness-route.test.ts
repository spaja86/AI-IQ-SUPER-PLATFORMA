// Autofinish — autofinish-release-readiness Route Coverage Test
...
import { GET } from '../../app/api/autofinish-release-readiness/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-release-readiness — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-release-readiness/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-release-readiness', {

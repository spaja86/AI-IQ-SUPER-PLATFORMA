// Autofinish — spaja-baza Route Coverage Test
...
import { GET } from '../../app/api/spaja-baza/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-baza — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-baza/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-baza', {

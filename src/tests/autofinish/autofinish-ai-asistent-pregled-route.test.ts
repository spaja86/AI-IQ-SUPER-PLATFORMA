// Autofinish — autofinish-ai-asistent-pregled Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-ai-asistent-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-ai-asistent-pregled/route.ts');

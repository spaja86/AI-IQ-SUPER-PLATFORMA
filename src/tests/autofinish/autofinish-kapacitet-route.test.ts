// Autofinish — autofinish-kapacitet Route Coverage Test
...
import { GET } from '../../app/api/autofinish-kapacitet/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-kapacitet — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-kapacitet/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-kapacitet', {

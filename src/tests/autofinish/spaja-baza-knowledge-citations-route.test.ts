// Autofinish — spaja-baza-knowledge/citations Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-baza-knowledge/citations — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-baza-knowledge/citations/route.ts');

// Autofinish — autofinish-feature-flags Route Coverage Test
...
import { GET } from '../../app/api/autofinish-feature-flags/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-feature-flags — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-feature-flags/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-feature-flags', {

// Autofinish — ultra-neurofotonski-dekoder Route Coverage Test
...
import { GET } from '../../app/api/ultra-neurofotonski-dekoder/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 ultra-neurofotonski-dekoder — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ultra-neurofotonski-dekoder/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/ultra-neurofotonski-dekoder', {

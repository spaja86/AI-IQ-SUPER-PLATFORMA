// Autofinish — univerzalni-prompt-pregled Route Coverage Test
...
import { GET } from '../../app/api/univerzalni-prompt-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 univerzalni-prompt-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/univerzalni-prompt-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/univerzalni-prompt-pregled', {

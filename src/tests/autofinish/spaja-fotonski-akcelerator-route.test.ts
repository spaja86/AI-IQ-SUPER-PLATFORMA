// Autofinish — spaja-fotonski-akcelerator Route Coverage Test
...
import { GET } from '../../app/api/spaja-fotonski-akcelerator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-fotonski-akcelerator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-fotonski-akcelerator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-fotonski-akcelerator', {

// Autofinish — autofinish-preporuke-analitika Route Coverage Test
...
import { GET } from '../../app/api/autofinish-preporuke-analitika/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-preporuke-analitika — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-preporuke-analitika/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-preporuke-analitika', {

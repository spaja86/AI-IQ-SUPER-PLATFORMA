// Autofinish — laureatski-demodulator Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 laureatski-demodulator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/laureatski-demodulator/route.ts');

// Autofinish — profesionalni-login-mejl-verifikacija Route Coverage Test
...
import { GET } from '../../app/api/profesionalni-login-mejl-verifikacija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 profesionalni-login-mejl-verifikacija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/profesionalni-login-mejl-verifikacija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/profesionalni-login-mejl-verifikacija', {

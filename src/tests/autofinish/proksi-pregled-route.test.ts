// Autofinish — proksi-pregled Route Coverage Test
...
import { GET } from '../../app/api/proksi-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 proksi-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/proksi-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/proksi-pregled', {

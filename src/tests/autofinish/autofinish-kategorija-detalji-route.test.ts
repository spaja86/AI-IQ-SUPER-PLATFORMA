// Autofinish — autofinish-kategorija-detalji Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-kategorija-detalji — Route Coverage Test Suite\n');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-kategorija-detalji', {

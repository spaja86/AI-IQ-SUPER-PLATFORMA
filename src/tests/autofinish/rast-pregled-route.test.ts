// Autofinish — rast-pregled Route Coverage Test
...
import { GET } from '../../app/api/rast-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 rast-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/rast-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/rast-pregled', {

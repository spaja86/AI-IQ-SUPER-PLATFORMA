// Autofinish — sla-monitor Route Coverage Test
...
import { GET } from '../../app/api/sla-monitor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 sla-monitor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/sla-monitor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/sla-monitor', {

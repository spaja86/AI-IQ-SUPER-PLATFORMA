// Autofinish — kpi-dashboard Route Coverage Test
...
import { GET } from '../../app/api/kpi-dashboard/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 kpi-dashboard — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/kpi-dashboard/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/kpi-dashboard', {

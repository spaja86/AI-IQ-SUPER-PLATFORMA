// Autofinish — platforma-indeks Route Coverage Test
...
import { GET } from '../../app/api/platforma-indeks/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-indeks — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-indeks/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-indeks', {

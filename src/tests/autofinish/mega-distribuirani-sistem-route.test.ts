// Autofinish — mega-distribuirani-sistem Route Coverage Test
...
import { GET } from '../../app/api/mega-distribuirani-sistem/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 mega-distribuirani-sistem — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/mega-distribuirani-sistem/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/mega-distribuirani-sistem', {

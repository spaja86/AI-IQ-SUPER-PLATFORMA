// Autofinish — autofinish-performanse Route Coverage Test
...
import { GET } from '../../app/api/autofinish-performanse/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-performanse — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-performanse/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-performanse', {

// Autofinish — spaja-adaptivni-skaliranje Route Coverage Test
...
import { GET } from '../../app/api/spaja-adaptivni-skaliranje/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-adaptivni-skaliranje — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-adaptivni-skaliranje/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-adaptivni-skaliranje', {

// Autofinish — autofinish-health-score Route Coverage Test
...
import { GET } from '../../app/api/autofinish-health-score/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-health-score — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-health-score/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-health-score', {

// Autofinish — spaja-blog-faq-pregled Route Coverage Test
...
import { GET } from '../../app/api/spaja-blog-faq-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-blog-faq-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-blog-faq-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-blog-faq-pregled', {

// Autofinish — autentifikacija-dozvole Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 autentifikacija-dozvole — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autentifikacija-dozvole/route.ts');

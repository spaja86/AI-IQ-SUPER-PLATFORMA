// Autofinish — autofinish-stabilnost-pregled Route Coverage Test
...
import { GET } from '../../app/api/autofinish-stabilnost-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-stabilnost-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-stabilnost-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-stabilnost-pregled', {

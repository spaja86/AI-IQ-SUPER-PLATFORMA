// Autofinish — pentracija/status Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 pentracija/status — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/pentracija/status/route.ts');

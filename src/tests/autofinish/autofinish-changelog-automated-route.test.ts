// Autofinish — autofinish-changelog-automated Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-changelog-automated — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-changelog-automated/route.ts');

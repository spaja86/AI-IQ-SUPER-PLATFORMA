// Autofinish — admin/billing-webhook-replay Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 admin/billing-webhook-replay — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/admin/billing-webhook-replay/route.ts');

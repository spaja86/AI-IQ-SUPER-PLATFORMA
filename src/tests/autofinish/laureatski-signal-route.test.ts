// Autofinish — laureatski-signal Route Coverage Test
...
import { GET } from '../../app/api/laureatski-signal/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 laureatski-signal — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/laureatski-signal/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/laureatski-signal', {

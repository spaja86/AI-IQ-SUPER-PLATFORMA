// Autofinish — kripto-trezor/liquidity Route Coverage Test
...
import { GET } from '../../app/api/kripto-trezor/liquidity/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 kripto-trezor/liquidity — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/kripto-trezor/liquidity/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/kripto-trezor/liquidity', {

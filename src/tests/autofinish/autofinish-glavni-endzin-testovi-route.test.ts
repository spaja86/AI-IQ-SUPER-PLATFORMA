// Autofinish — autofinish-glavni-endzin-testovi Route Coverage Test
...
import { GET } from '../../app/api/autofinish-glavni-endzin-testovi/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-glavni-endzin-testovi — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-glavni-endzin-testovi/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-glavni-endzin-testovi', {

// Autofinish — oktavni-monolog Route Coverage Test
...
import { GET } from '../../app/api/oktavni-monolog/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 oktavni-monolog — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/oktavni-monolog/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/oktavni-monolog', {

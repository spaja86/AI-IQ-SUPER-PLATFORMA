// Autofinish — igrice-kategorije Route Coverage Test
...
import { GET } from '../../app/api/igrice-kategorije/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 igrice-kategorije — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/igrice-kategorije/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/igrice-kategorije', {

// Autofinish — novcanik/balance Route Coverage Test
...
import { GET } from '../../app/api/novcanik/balance/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 novcanik/balance — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/novcanik/balance/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/novcanik/balance', {

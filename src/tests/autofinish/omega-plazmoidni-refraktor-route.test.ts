// Autofinish — omega-plazmoidni-refraktor Route Coverage Test
...
import { GET } from '../../app/api/omega-plazmoidni-refraktor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-plazmoidni-refraktor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-plazmoidni-refraktor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-plazmoidni-refraktor', {

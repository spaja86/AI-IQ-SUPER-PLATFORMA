// Autofinish — platforma-neutrinski-oscilator Route Coverage Test
...
import { GET } from '../../app/api/platforma-neutrinski-oscilator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-neutrinski-oscilator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-neutrinski-oscilator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-neutrinski-oscilator', {

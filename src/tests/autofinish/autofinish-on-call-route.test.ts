// Autofinish — autofinish-on-call Route Coverage Test
...
import { GET } from '../../app/api/autofinish-on-call/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-on-call — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-on-call/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-on-call', {

// Autofinish — spaja-mobilna-integracija Route Coverage Test
...
import { GET } from '../../app/api/spaja-mobilna-integracija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-mobilna-integracija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-mobilna-integracija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-mobilna-integracija', {

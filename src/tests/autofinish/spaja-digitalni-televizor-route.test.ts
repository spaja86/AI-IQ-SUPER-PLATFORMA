// Autofinish — spaja-digitalni-televizor Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-digitalni-televizor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-digitalni-televizor/route.ts');

// Autofinish — proksi-github-deploy Route Coverage Test
...
import { GET } from '../../app/api/proksi-github-deploy/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 proksi-github-deploy — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/proksi-github-deploy/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/proksi-github-deploy', {

// Autofinish — mobilna-mreza-pregled Route Coverage Test
...
import { GET } from '../../app/api/mobilna-mreza-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 mobilna-mreza-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/mobilna-mreza-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/mobilna-mreza-pregled', {

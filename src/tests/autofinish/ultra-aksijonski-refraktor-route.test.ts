// Autofinish — ultra-aksijonski-refraktor Route Coverage Test
...
import { GET } from '../../app/api/ultra-aksijonski-refraktor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 ultra-aksijonski-refraktor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ultra-aksijonski-refraktor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/ultra-aksijonski-refraktor', {

// Autofinish — ultra-termovakuumski-generator Route Coverage Test
...
import { GET } from '../../app/api/ultra-termovakuumski-generator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 ultra-termovakuumski-generator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ultra-termovakuumski-generator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/ultra-termovakuumski-generator', {

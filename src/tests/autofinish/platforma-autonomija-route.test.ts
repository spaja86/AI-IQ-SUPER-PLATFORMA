// Autofinish — platforma-autonomija Route Coverage Test
...
import { GET } from '../../app/api/platforma-autonomija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-autonomija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-autonomija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-autonomija', {

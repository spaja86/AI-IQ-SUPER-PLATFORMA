// Autofinish — autofinish-kvalitet Route Coverage Test
...
import { GET } from '../../app/api/autofinish-kvalitet/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-kvalitet — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-kvalitet/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-kvalitet', {

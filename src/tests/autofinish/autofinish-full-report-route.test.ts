// Autofinish — autofinish-full-report Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-full-report — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-full-report/route.ts');

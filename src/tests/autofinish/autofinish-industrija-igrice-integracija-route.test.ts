// Autofinish — autofinish-industrija-igrice-integracija Route Coverage Test
...
import { GET } from '../../app/api/autofinish-industrija-igrice-integracija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-industrija-igrice-integracija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-industrija-igrice-integracija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-industrija-igrice-integracija', {

// Autofinish — igrice-pregled Route Coverage Test
...
import { GET } from '../../app/api/igrice-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 igrice-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/igrice-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/igrice-pregled', {

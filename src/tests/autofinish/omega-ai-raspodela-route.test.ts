// Autofinish — omega-ai-raspodela Route Coverage Test
...
import { GET } from '../../app/api/omega-ai-raspodela/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-ai-raspodela — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-ai-raspodela/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-ai-raspodela', {

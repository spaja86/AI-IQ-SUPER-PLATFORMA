// Autofinish — autofinish-deployment-status Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-deployment-status — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-deployment-status/route.ts');

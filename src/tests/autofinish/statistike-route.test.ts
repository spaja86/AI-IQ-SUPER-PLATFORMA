// Autofinish — statistike Route Coverage Test
...
import { GET } from '../../app/api/statistike/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 statistike — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/statistike/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/statistike', {

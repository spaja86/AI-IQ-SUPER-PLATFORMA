// Autofinish — platforma-energetski-pregled Route Coverage Test
...
import { GET } from '../../app/api/platforma-energetski-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-energetski-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-energetski-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-energetski-pregled', {

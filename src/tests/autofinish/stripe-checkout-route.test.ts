// Autofinish — stripe/checkout Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 stripe/checkout — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/stripe/checkout/route.ts');

// Autofinish — protokoli/[id]/log Route Coverage Test
...
import { GET } from '../../app/api/protokoli/[id]/log/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 protokoli/[id]/log — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/protokoli/[id]/log/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/protokoli/[id]/log', {

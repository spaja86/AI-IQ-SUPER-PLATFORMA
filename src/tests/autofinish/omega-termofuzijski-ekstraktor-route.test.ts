// Autofinish — omega-termofuzijski-ekstraktor Route Coverage Test
...
import { GET } from '../../app/api/omega-termofuzijski-ekstraktor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-termofuzijski-ekstraktor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-termofuzijski-ekstraktor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-termofuzijski-ekstraktor', {

// Autofinish — mega-antimaterija-generator Route Coverage Test
...
import { GET } from '../../app/api/mega-antimaterija-generator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 mega-antimaterija-generator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/mega-antimaterija-generator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/mega-antimaterija-generator', {

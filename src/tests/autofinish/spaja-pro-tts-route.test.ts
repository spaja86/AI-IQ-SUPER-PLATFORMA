// Autofinish — spaja-pro/tts Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-pro/tts — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-pro/tts/route.ts');

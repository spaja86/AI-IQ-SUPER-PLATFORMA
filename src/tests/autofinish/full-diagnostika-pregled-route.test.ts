// Autofinish — full-diagnostika-pregled Route Coverage Test
...
import { GET } from '../../app/api/full-diagnostika-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 full-diagnostika-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/full-diagnostika-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/full-diagnostika-pregled', {

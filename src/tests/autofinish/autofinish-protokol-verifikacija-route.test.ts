// Autofinish — autofinish-protokol-verifikacija Route Coverage Test
...
import { GET } from '../../app/api/autofinish-protokol-verifikacija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-protokol-verifikacija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-protokol-verifikacija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-protokol-verifikacija', {

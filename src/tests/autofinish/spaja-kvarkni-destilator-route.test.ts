// Autofinish — spaja-kvarkni-destilator Route Coverage Test
...
import { GET } from '../../app/api/spaja-kvarkni-destilator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-kvarkni-destilator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-kvarkni-destilator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-kvarkni-destilator', {

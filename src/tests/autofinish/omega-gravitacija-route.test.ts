// Autofinish — omega-gravitacija Route Coverage Test
...
import { GET } from '../../app/api/omega-gravitacija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-gravitacija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-gravitacija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-gravitacija', {

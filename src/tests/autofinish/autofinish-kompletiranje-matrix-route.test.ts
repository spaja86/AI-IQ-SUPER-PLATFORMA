// Autofinish — autofinish-kompletiranje-matrix Route Coverage Test
...
import { GET } from '../../app/api/autofinish-kompletiranje-matrix/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-kompletiranje-matrix — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-kompletiranje-matrix/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-kompletiranje-matrix', {

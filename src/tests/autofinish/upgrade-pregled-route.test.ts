// Autofinish — upgrade-pregled Route Coverage Test
...
import { GET } from '../../app/api/upgrade-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 upgrade-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/upgrade-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/upgrade-pregled', {

// Autofinish — kvantna-optimizacija Route Coverage Test
...
import { GET } from '../../app/api/kvantna-optimizacija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 kvantna-optimizacija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/kvantna-optimizacija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/kvantna-optimizacija', {

// Autofinish — b2b-procurement/checklista Route Coverage Test
...
import { GET } from '../../app/api/b2b-procurement/checklista/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 b2b-procurement/checklista — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/b2b-procurement/checklista/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/b2b-procurement/checklista', {

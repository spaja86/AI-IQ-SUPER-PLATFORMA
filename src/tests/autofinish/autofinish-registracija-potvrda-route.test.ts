// Autofinish — autofinish-registracija-potvrda Route Coverage Test
...
import { GET } from '../../app/api/autofinish-registracija-potvrda/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-registracija-potvrda — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-registracija-potvrda/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-registracija-potvrda', {

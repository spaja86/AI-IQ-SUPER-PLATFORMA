// Autofinish — platforme-pregled Route Coverage Test
...
import { GET } from '../../app/api/platforme-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforme-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforme-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforme-pregled', {

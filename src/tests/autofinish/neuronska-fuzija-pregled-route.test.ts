// Autofinish — neuronska-fuzija-pregled Route Coverage Test
...
import { GET } from '../../app/api/neuronska-fuzija-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 neuronska-fuzija-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/neuronska-fuzija-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/neuronska-fuzija-pregled', {

// Autofinish — kripto-trezor/coverage Route Coverage Test
...
import { GET } from '../../app/api/kripto-trezor/coverage/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 kripto-trezor/coverage — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/kripto-trezor/coverage/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/kripto-trezor/coverage', {

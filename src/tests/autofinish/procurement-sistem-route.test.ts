// Autofinish — procurement-sistem Route Coverage Test
...
import { GET } from '../../app/api/procurement-sistem/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 procurement-sistem — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/procurement-sistem/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/procurement-sistem', {

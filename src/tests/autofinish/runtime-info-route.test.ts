// Autofinish — runtime-info Route Coverage Test
...
import { GET } from '../../app/api/runtime-info/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 runtime-info — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/runtime-info/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/runtime-info', {

// Autofinish — ekosistem-analitika Route Coverage Test
...
import { GET } from '../../app/api/ekosistem-analitika/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 ekosistem-analitika — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ekosistem-analitika/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/ekosistem-analitika', {

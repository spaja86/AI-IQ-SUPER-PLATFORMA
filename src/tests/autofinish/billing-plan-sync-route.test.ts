// Autofinish — billing-plan-sync Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 billing-plan-sync — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/billing-plan-sync/route.ts');

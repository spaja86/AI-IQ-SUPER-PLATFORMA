// Autofinish — kripto-trezor/custody Route Coverage Test
...
import { GET } from '../../app/api/kripto-trezor/custody/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 kripto-trezor/custody — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/kripto-trezor/custody/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/kripto-trezor/custody', {

// Autofinish — laureatski-enkoder Route Coverage Test
...
import { GET } from '../../app/api/laureatski-enkoder/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 laureatski-enkoder — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/laureatski-enkoder/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/laureatski-enkoder', {

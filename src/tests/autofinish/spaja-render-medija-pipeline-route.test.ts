// Autofinish — spaja-render-medija-pipeline Route Coverage Test
...
import { GET } from '../../app/api/spaja-render-medija-pipeline/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-render-medija-pipeline — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-render-medija-pipeline/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-render-medija-pipeline', {

// Autofinish — platforme Route Coverage Test
...
import { GET } from '../../app/api/platforme/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforme — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforme/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforme', {

// Autofinish — omega-sinhronizacija Route Coverage Test
...
import { GET } from '../../app/api/omega-sinhronizacija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-sinhronizacija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-sinhronizacija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-sinhronizacija', {

// Autofinish — spaja-univerzalni-prompt Route Coverage Test
...
import { GET } from '../../app/api/spaja-univerzalni-prompt/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-univerzalni-prompt — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-univerzalni-prompt/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-univerzalni-prompt', {

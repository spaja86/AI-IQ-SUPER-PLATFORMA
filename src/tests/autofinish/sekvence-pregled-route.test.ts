// Autofinish — sekvence-pregled Route Coverage Test
...
import { GET } from '../../app/api/sekvence-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 sekvence-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/sekvence-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/sekvence-pregled', {

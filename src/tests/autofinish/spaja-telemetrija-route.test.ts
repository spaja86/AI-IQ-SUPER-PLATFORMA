// Autofinish — spaja-telemetrija Route Coverage Test
...
import { GET } from '../../app/api/spaja-telemetrija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-telemetrija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-telemetrija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-telemetrija', {

// Autofinish — login-industrija-pristup Route Coverage Test
...
import { GET } from '../../app/api/login-industrija-pristup/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 login-industrija-pristup — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/login-industrija-pristup/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/login-industrija-pristup', {

// Autofinish — igrice Route Coverage Test
...
import { GET } from '../../app/api/igrice/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 igrice — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/igrice/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/igrice', {

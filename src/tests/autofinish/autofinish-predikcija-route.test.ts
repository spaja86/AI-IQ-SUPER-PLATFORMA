// Autofinish — autofinish-predikcija Route Coverage Test
...
import { GET } from '../../app/api/autofinish-predikcija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-predikcija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-predikcija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-predikcija', {

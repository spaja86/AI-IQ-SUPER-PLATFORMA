// Autofinish — ekosistem-url-registar Route Coverage Test
...
import { GET } from '../../app/api/ekosistem-url-registar/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 ekosistem-url-registar — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ekosistem-url-registar/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/ekosistem-url-registar', {

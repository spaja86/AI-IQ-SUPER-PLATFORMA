// Autofinish — platforma-gravitonski-akselerator Route Coverage Test
...
import { GET } from '../../app/api/platforma-gravitonski-akselerator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-gravitonski-akselerator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-gravitonski-akselerator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-gravitonski-akselerator', {

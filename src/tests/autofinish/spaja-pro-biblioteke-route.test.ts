// Autofinish — spaja-pro-biblioteke Route Coverage Test
...
import { GET } from '../../app/api/spaja-pro-biblioteke/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-pro-biblioteke — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-pro-biblioteke/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-pro-biblioteke', {

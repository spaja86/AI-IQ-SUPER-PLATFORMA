// Autofinish — wallet/network-health Route Coverage Test
...
import { GET } from '../../app/api/wallet/network-health/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 wallet/network-health — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/wallet/network-health/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/wallet/network-health', {

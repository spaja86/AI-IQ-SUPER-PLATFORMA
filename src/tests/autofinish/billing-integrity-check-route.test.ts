// Autofinish — billing-integrity-check Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 billing-integrity-check — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/billing-integrity-check/route.ts');

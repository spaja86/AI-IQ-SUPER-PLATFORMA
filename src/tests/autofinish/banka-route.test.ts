// Autofinish — banka Route Coverage Test
...
import { GET } from '../../app/api/banka/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 banka — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/banka/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/banka', {

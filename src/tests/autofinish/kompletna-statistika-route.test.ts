// Autofinish — kompletna-statistika Route Coverage Test
...
import { GET } from '../../app/api/kompletna-statistika/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 kompletna-statistika — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/kompletna-statistika/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/kompletna-statistika', {

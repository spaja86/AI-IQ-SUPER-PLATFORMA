// Autofinish — cron/evolucija Route Coverage Test
...
import { GET } from '../../app/api/cron/evolucija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 cron/evolucija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/cron/evolucija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/cron/evolucija', {

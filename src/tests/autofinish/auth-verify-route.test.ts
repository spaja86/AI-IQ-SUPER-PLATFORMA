// Autofinish — auth/verify Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 auth/verify — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/auth/verify/route.ts');

// Autofinish — panetracija-2/nalazi Route Coverage Test
...
import { GET } from '../../app/api/panetracija-2/nalazi/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 panetracija-2/nalazi — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/panetracija-2/nalazi/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/panetracija-2/nalazi', {

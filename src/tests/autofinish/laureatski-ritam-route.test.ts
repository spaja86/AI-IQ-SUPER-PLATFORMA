// Autofinish — laureatski-ritam Route Coverage Test
...
import { GET } from '../../app/api/laureatski-ritam/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 laureatski-ritam — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/laureatski-ritam/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/laureatski-ritam', {

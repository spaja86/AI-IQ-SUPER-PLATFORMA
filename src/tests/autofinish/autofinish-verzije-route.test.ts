// Autofinish — autofinish-verzije Route Coverage Test
...
import { GET } from '../../app/api/autofinish-verzije/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-verzije — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-verzije/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-verzije', {

// Autofinish — autofinish-runbook Route Coverage Test
...
import { GET } from '../../app/api/autofinish-runbook/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-runbook — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-runbook/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-runbook', {

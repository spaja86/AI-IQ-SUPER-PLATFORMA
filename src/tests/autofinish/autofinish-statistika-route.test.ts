// Autofinish — autofinish-statistika Route Coverage Test
...
import { GET } from '../../app/api/autofinish-statistika/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-statistika — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-statistika/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-statistika', {

// Autofinish — laureatski-kodek Route Coverage Test
...
import { GET } from '../../app/api/laureatski-kodek/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 laureatski-kodek — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/laureatski-kodek/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/laureatski-kodek', {

// Autofinish — auth/owner-otp Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 auth/owner-otp — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/auth/owner-otp/route.ts');

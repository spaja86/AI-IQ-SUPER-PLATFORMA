// Autofinish — glavni-endzin-digitalne-industrije Route Coverage Test
...
import { GET } from '../../app/api/glavni-endzin-digitalne-industrije/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 glavni-endzin-digitalne-industrije — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/glavni-endzin-digitalne-industrije/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/glavni-endzin-digitalne-industrije', {

// Autofinish — omega-tachionski-modulacija Route Coverage Test
...
import { GET } from '../../app/api/omega-tachionski-modulacija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-tachionski-modulacija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-tachionski-modulacija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-tachionski-modulacija', {

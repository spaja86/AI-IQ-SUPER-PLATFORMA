// Autofinish — profesionalni-login-platni-pregled Route Coverage Test
...
import { GET } from '../../app/api/profesionalni-login-platni-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 profesionalni-login-platni-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/profesionalni-login-platni-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/profesionalni-login-platni-pregled', {

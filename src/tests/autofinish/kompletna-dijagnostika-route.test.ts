// Autofinish — kompletna-dijagnostika Route Coverage Test
...
import { GET } from '../../app/api/kompletna-dijagnostika/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 kompletna-dijagnostika — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/kompletna-dijagnostika/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/kompletna-dijagnostika', {

// Autofinish — omega-ai-raspodela-radno-vreme Route Coverage Test
...
import { GET } from '../../app/api/omega-ai-raspodela-radno-vreme/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-ai-raspodela-radno-vreme — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-ai-raspodela-radno-vreme/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-ai-raspodela-radno-vreme', {

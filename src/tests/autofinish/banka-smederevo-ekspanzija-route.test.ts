// Autofinish — banka-smederevo-ekspanzija Route Coverage Test
...
import { GET } from '../../app/api/banka-smederevo-ekspanzija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 banka-smederevo-ekspanzija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/banka-smederevo-ekspanzija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/banka-smederevo-ekspanzija', {

// Autofinish — cron/zdravlje Route Coverage Test
...
import { GET } from '../../app/api/cron/zdravlje/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 cron/zdravlje — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/cron/zdravlje/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/cron/zdravlje', {

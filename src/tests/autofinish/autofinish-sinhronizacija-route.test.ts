// Autofinish — autofinish-sinhronizacija Route Coverage Test
...
import { GET } from '../../app/api/autofinish-sinhronizacija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-sinhronizacija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-sinhronizacija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-sinhronizacija', {

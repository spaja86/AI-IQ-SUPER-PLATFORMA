// Autofinish — dijagnostika-mega-merge Route Coverage Test
...
import { GET } from '../../app/api/dijagnostika-mega-merge/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 dijagnostika-mega-merge — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/dijagnostika-mega-merge/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/dijagnostika-mega-merge', {

// Autofinish — autofinish-retrospektiva Route Coverage Test
...
import { GET } from '../../app/api/autofinish-retrospektiva/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-retrospektiva — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-retrospektiva/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-retrospektiva', {

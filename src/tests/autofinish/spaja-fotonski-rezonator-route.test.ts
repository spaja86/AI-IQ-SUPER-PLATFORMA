// Autofinish — spaja-fotonski-rezonator Route Coverage Test
...
import { GET } from '../../app/api/spaja-fotonski-rezonator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-fotonski-rezonator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-fotonski-rezonator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-fotonski-rezonator', {

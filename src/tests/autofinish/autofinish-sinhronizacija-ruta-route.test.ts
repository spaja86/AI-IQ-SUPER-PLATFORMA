// Autofinish — autofinish-sinhronizacija-ruta Route Coverage Test
...
import { GET } from '../../app/api/autofinish-sinhronizacija-ruta/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-sinhronizacija-ruta — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-sinhronizacija-ruta/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-sinhronizacija-ruta', {

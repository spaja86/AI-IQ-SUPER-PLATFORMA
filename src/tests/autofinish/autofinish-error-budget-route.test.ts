// Autofinish — autofinish-error-budget Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-error-budget — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-error-budget/route.ts');

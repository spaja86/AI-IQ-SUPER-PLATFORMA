// Autofinish — autofinish-napredak-tracker Route Coverage Test
...
import { GET } from '../../app/api/autofinish-napredak-tracker/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-napredak-tracker — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-napredak-tracker/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-napredak-tracker', {

// Autofinish — navigation-info Route Coverage Test
...
import { GET } from '../../app/api/navigation-info/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 navigation-info — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/navigation-info/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/navigation-info', {

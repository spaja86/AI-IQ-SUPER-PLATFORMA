// Autofinish — autofinish-cost-analytics Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-cost-analytics — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-cost-analytics/route.ts');

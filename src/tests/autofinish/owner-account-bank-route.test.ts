// Autofinish — owner-account-bank Route Coverage Test
...
import { GET } from '../../app/api/owner-account-bank/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 owner-account-bank — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/owner-account-bank/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/owner-account-bank', {

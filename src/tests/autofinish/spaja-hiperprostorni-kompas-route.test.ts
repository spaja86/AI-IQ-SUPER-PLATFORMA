// Autofinish — spaja-hiperprostorni-kompas Route Coverage Test
...
import { GET } from '../../app/api/spaja-hiperprostorni-kompas/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-hiperprostorni-kompas — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-hiperprostorni-kompas/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-hiperprostorni-kompas', {

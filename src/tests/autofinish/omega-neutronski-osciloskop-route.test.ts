// Autofinish — omega-neutronski-osciloskop Route Coverage Test
...
import { GET } from '../../app/api/omega-neutronski-osciloskop/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-neutronski-osciloskop — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-neutronski-osciloskop/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-neutronski-osciloskop', {

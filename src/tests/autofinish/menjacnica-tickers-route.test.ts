// Autofinish — menjacnica/tickers Route Coverage Test
...
import { GET } from '../../app/api/menjacnica/tickers/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 menjacnica/tickers — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/menjacnica/tickers/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/menjacnica/tickers', {

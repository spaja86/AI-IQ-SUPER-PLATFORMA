// Autofinish — omega-krionski-stabilizator Route Coverage Test
...
import { GET } from '../../app/api/omega-krionski-stabilizator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-krionski-stabilizator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-krionski-stabilizator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-krionski-stabilizator', {

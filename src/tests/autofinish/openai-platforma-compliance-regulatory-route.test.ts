// Autofinish — openai-platforma-compliance-regulatory Route Coverage Test
...
import { GET } from '../../app/api/openai-platforma-compliance-regulatory/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 openai-platforma-compliance-regulatory — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/openai-platforma-compliance-regulatory/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/openai-platforma-compliance-regulatory', {

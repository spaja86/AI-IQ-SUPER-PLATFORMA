// Autofinish — platforma-performanse Route Coverage Test
...
import { GET } from '../../app/api/platforma-performanse/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-performanse — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-performanse/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-performanse', {

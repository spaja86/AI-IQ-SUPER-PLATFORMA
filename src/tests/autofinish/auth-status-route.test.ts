// Autofinish — auth/status Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 auth/status — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/auth/status/route.ts');

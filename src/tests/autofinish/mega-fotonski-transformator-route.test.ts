// Autofinish — mega-fotonski-transformator Route Coverage Test
...
import { GET } from '../../app/api/mega-fotonski-transformator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 mega-fotonski-transformator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/mega-fotonski-transformator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/mega-fotonski-transformator', {

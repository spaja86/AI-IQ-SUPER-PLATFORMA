// Autofinish — spaja-pro-benchmark Route Coverage Test
...
import { GET } from '../../app/api/spaja-pro-benchmark/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-pro-benchmark — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-pro-benchmark/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-pro-benchmark', {

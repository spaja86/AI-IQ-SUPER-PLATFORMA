// Autofinish — auth/register Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 auth/register — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/auth/register/route.ts');

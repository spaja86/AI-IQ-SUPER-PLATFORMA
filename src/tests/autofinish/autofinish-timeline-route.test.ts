// Autofinish — autofinish-timeline Route Coverage Test
...
import { GET } from '../../app/api/autofinish-timeline/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-timeline — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-timeline/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-timeline', {

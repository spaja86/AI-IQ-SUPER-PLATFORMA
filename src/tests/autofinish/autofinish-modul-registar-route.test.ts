// Autofinish — autofinish-modul-registar Route Coverage Test
...
import { GET } from '../../app/api/autofinish-modul-registar/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-modul-registar — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-modul-registar/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-modul-registar', {

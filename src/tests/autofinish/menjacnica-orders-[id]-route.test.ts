// Autofinish — menjacnica/orders/[id] Route Coverage Test
...
import { GET } from '../../app/api/menjacnica/orders/[id]/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 menjacnica/orders/[id] — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/menjacnica/orders/[id]/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/menjacnica/orders/[id]', {

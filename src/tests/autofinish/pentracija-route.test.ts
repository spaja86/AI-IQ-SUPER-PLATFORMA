// Autofinish — pentracija Route Coverage Test
...
import { GET } from '../../app/api/pentracija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 pentracija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/pentracija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/pentracija', {

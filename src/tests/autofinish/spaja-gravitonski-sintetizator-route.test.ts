// Autofinish — spaja-gravitonski-sintetizator Route Coverage Test
...
import { GET } from '../../app/api/spaja-gravitonski-sintetizator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-gravitonski-sintetizator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-gravitonski-sintetizator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-gravitonski-sintetizator', {

// Autofinish — kompanije Route Coverage Test
...
import { GET } from '../../app/api/kompanije/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 kompanije — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/kompanije/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/kompanije', {

// Autofinish — paypal/portal Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 paypal/portal — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/paypal/portal/route.ts');

// Autofinish — kompanije-pregled Route Coverage Test
...
import { GET } from '../../app/api/kompanije-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 kompanije-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/kompanije-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/kompanije-pregled', {

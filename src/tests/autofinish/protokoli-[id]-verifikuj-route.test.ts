// Autofinish — protokoli/[id]/verifikuj Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 protokoli/[id]/verifikuj — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/protokoli/[id]/verifikuj/route.ts');

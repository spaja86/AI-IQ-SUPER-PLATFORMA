// Autofinish — autofinish-deployment-validacija Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-deployment-validacija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-deployment-validacija/route.ts');

// Autofinish — erste-banka-racuni Route Coverage Test
...
import { GET } from '../../app/api/erste-banka-racuni/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 erste-banka-racuni — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/erste-banka-racuni/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/erste-banka-racuni', {

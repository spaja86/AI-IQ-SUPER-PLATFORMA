// Autofinish — omega-evolucija-mapa Route Coverage Test
...
import { GET } from '../../app/api/omega-evolucija-mapa/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-evolucija-mapa — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-evolucija-mapa/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-evolucija-mapa', {

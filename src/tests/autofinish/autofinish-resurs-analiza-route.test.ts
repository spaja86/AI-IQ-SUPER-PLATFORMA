// Autofinish — autofinish-resurs-analiza Route Coverage Test
...
import { GET } from '../../app/api/autofinish-resurs-analiza/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-resurs-analiza — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-resurs-analiza/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-resurs-analiza', {

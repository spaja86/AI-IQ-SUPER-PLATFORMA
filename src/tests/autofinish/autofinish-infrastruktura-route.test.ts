// Autofinish — autofinish-infrastruktura Route Coverage Test
...
import { GET } from '../../app/api/autofinish-infrastruktura/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-infrastruktura — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-infrastruktura/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-infrastruktura', {

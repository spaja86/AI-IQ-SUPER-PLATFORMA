// Autofinish — repair-pregled Route Coverage Test
...
import { GET } from '../../app/api/repair-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 repair-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/repair-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/repair-pregled', {

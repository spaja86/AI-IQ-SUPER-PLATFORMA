// Autofinish — spaja-tacionski-rekombinator Route Coverage Test
...
import { GET } from '../../app/api/spaja-tacionski-rekombinator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-tacionski-rekombinator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-tacionski-rekombinator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-tacionski-rekombinator', {

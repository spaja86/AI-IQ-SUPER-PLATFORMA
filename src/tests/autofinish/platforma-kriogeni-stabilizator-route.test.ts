// Autofinish — platforma-kriogeni-stabilizator Route Coverage Test
...
import { GET } from '../../app/api/platforma-kriogeni-stabilizator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-kriogeni-stabilizator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-kriogeni-stabilizator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-kriogeni-stabilizator', {

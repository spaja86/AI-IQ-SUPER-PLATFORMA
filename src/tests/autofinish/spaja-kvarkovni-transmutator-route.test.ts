// Autofinish — spaja-kvarkovni-transmutator Route Coverage Test
...
import { GET } from '../../app/api/spaja-kvarkovni-transmutator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-kvarkovni-transmutator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-kvarkovni-transmutator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-kvarkovni-transmutator', {

// Autofinish — autofinish-metrike-ekosistem Route Coverage Test
...
import { GET } from '../../app/api/autofinish-metrike-ekosistem/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-metrike-ekosistem — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-metrike-ekosistem/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-metrike-ekosistem', {

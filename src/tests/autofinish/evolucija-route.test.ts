// Autofinish — evolucija Route Coverage Test
...
import { GET } from '../../app/api/evolucija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 evolucija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/evolucija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/evolucija', {

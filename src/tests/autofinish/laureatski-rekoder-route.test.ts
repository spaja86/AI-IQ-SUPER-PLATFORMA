// Autofinish — laureatski-rekoder Route Coverage Test
...
import { GET } from '../../app/api/laureatski-rekoder/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 laureatski-rekoder — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/laureatski-rekoder/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/laureatski-rekoder', {

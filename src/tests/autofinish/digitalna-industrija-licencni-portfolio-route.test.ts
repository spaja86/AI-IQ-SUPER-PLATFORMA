// Autofinish — digitalna-industrija-licencni-portfolio Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 digitalna-industrija-licencni-portfolio — Route Coverage Test Suite\n');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/digitalna-industrija-licencni-portfolio', {

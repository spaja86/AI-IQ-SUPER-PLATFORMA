// Autofinish — spaja-gravitacioni-harmonizer Route Coverage Test
...
import { GET } from '../../app/api/spaja-gravitacioni-harmonizer/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-gravitacioni-harmonizer — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-gravitacioni-harmonizer/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-gravitacioni-harmonizer', {

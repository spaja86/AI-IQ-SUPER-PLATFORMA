// Autofinish — ekosistem-zdravlje Route Coverage Test
...
import { GET } from '../../app/api/ekosistem-zdravlje/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 ekosistem-zdravlje — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ekosistem-zdravlje/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/ekosistem-zdravlje', {

// Autofinish — sajt-funkcionalnost-analiza Route Coverage Test
...
import { GET } from '../../app/api/sajt-funkcionalnost-analiza/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 sajt-funkcionalnost-analiza — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/sajt-funkcionalnost-analiza/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/sajt-funkcionalnost-analiza', {

// Autofinish — eksosistzdacija Route Coverage Test
...
import { GET } from '../../app/api/eksosistzdacija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 eksosistzdacija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/eksosistzdacija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/eksosistzdacija', {

// Autofinish — kategorije-pregled Route Coverage Test
...
import { GET } from '../../app/api/kategorije-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 kategorije-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/kategorije-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/kategorije-pregled', {

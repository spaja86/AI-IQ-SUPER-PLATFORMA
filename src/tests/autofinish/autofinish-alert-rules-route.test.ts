// Autofinish — autofinish-alert-rules Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-alert-rules — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-alert-rules/route.ts');

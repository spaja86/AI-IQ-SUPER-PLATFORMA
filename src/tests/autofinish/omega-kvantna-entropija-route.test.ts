// Autofinish — omega-kvantna-entropija Route Coverage Test
...
import { GET } from '../../app/api/omega-kvantna-entropija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-kvantna-entropija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-kvantna-entropija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-kvantna-entropija', {

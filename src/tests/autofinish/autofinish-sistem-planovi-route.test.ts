// Autofinish — autofinish-sistem-planovi Route Coverage Test
...
import { GET } from '../../app/api/autofinish-sistem-planovi/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-sistem-planovi — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-sistem-planovi/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-sistem-planovi', {

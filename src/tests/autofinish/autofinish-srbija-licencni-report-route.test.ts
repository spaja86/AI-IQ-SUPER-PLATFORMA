// Autofinish — autofinish-srbija-licencni-report Route Coverage Test
...
import { GET } from '../../app/api/autofinish-srbija-licencni-report/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-srbija-licencni-report — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-srbija-licencni-report/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-srbija-licencni-report', {

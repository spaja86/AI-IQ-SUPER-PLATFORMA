// Autofinish — omega-gravitacioni-sinhronizator Route Coverage Test
...
import { GET } from '../../app/api/omega-gravitacioni-sinhronizator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-gravitacioni-sinhronizator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-gravitacioni-sinhronizator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-gravitacioni-sinhronizator', {

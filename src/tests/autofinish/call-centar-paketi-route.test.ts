// Autofinish — call-centar/paketi Route Coverage Test
...
import { GET } from '../../app/api/call-centar/paketi/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 call-centar/paketi — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/call-centar/paketi/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/call-centar/paketi', {

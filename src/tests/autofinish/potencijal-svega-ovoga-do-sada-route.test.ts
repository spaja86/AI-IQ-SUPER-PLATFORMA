// Autofinish — potencijal-svega-ovoga-do-sada Route Coverage Test
...
import { GET } from '../../app/api/potencijal-svega-ovoga-do-sada/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 potencijal-svega-ovoga-do-sada — Route Coverage Test Suite\n');

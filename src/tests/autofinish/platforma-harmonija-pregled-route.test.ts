// Autofinish — platforma-harmonija-pregled Route Coverage Test
...
import { GET } from '../../app/api/platforma-harmonija-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-harmonija-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-harmonija-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-harmonija-pregled', {

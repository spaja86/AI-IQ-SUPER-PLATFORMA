// Autofinish — procesuiranje-3 Route Coverage Test
...
import { GET } from '../../app/api/procesuiranje-3/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 procesuiranje-3 — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/procesuiranje-3/route.ts');

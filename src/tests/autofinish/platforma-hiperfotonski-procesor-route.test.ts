// Autofinish — platforma-hiperfotonski-procesor Route Coverage Test
...
import { GET } from '../../app/api/platforma-hiperfotonski-procesor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-hiperfotonski-procesor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-hiperfotonski-procesor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-hiperfotonski-procesor', {

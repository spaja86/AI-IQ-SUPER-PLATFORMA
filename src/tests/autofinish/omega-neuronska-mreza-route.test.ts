// Autofinish — omega-neuronska-mreza Route Coverage Test
...
import { GET } from '../../app/api/omega-neuronska-mreza/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-neuronska-mreza — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-neuronska-mreza/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-neuronska-mreza', {

// Autofinish — mega-gravitacioni-invertor Route Coverage Test
...
import { GET } from '../../app/api/mega-gravitacioni-invertor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 mega-gravitacioni-invertor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/mega-gravitacioni-invertor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/mega-gravitacioni-invertor', {

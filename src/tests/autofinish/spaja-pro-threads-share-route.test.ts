// Autofinish — spaja-pro/threads/share Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-pro/threads/share — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-pro/threads/share/route.ts');

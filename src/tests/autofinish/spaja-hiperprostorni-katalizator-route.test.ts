// Autofinish — spaja-hiperprostorni-katalizator Route Coverage Test
...
import { GET } from '../../app/api/spaja-hiperprostorni-katalizator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-hiperprostorni-katalizator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-hiperprostorni-katalizator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-hiperprostorni-katalizator', {

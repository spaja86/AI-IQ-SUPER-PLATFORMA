// Autofinish — menjacnica-banka-integracija Route Coverage Test
...
import { GET } from '../../app/api/menjacnica-banka-integracija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 menjacnica-banka-integracija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/menjacnica-banka-integracija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/menjacnica-banka-integracija', {

// Autofinish — owner-identity Route Coverage Test
...
import { GET } from '../../app/api/owner-identity/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 owner-identity — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/owner-identity/route.ts');

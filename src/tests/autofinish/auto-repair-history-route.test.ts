// Autofinish — auto-repair/history Route Coverage Test
...
import { GET } from '../../app/api/auto-repair/history/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 auto-repair/history — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/auto-repair/history/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/auto-repair/history', {

// Autofinish — kvantna-koherencija-status Route Coverage Test
...
import { GET } from '../../app/api/kvantna-koherencija-status/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 kvantna-koherencija-status — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/kvantna-koherencija-status/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/kvantna-koherencija-status', {

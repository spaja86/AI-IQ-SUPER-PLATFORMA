// Autofinish — sajtovi Route Coverage Test
...
import { GET } from '../../app/api/sajtovi/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 sajtovi — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/sajtovi/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/sajtovi', {

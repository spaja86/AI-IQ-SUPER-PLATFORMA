// Autofinish — autofinish-security-audit Route Coverage Test
...
import { GET } from '../../app/api/autofinish-security-audit/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-security-audit — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-security-audit/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-security-audit', {

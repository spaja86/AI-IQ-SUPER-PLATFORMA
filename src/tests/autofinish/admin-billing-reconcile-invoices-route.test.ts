// Autofinish — admin/billing-reconcile-invoices Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 admin/billing-reconcile-invoices — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/admin/billing-reconcile-invoices/route.ts');

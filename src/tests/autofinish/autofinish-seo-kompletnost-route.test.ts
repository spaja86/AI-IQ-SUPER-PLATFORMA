// Autofinish — autofinish-seo-kompletnost Route Coverage Test
...
import { GET } from '../../app/api/autofinish-seo-kompletnost/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-seo-kompletnost — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-seo-kompletnost/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-seo-kompletnost', {

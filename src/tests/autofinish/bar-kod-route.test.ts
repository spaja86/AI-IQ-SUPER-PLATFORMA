// Autofinish — bar-kod Route Coverage Test
...
import { GET } from '../../app/api/bar-kod/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 bar-kod — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/bar-kod/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/bar-kod', {

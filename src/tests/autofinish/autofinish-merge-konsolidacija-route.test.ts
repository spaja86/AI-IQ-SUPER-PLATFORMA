// Autofinish — autofinish-merge-konsolidacija Route Coverage Test
...
import { GET } from '../../app/api/autofinish-merge-konsolidacija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-merge-konsolidacija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-merge-konsolidacija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-merge-konsolidacija', {

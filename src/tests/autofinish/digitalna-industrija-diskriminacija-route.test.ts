// Autofinish — digitalna-industrija-diskriminacija Route Coverage Test
...
import { GET } from '../../app/api/digitalna-industrija-diskriminacija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 digitalna-industrija-diskriminacija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/digitalna-industrija-diskriminacija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/digitalna-industrija-diskriminacija', {

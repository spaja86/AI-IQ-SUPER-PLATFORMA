// Autofinish — spaja-pro/analyze-code Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-pro/analyze-code — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-pro/analyze-code/route.ts');

// Autofinish — infrastructure Route Coverage Test
...
import { GET } from '../../app/api/infrastructure/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 infrastructure — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/infrastructure/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/infrastructure', {

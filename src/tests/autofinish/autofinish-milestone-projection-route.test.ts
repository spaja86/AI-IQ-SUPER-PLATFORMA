// Autofinish — autofinish-milestone-projection Route Coverage Test
...
import { GET } from '../../app/api/autofinish-milestone-projection/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-milestone-projection — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-milestone-projection/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-milestone-projection', {

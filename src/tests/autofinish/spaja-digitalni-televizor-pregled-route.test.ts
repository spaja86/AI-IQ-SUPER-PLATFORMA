// Autofinish — spaja-digitalni-televizor-pregled Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-digitalni-televizor-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-digitalni-televizor-pregled/route.ts');

// Autofinish — novcanik/withdraw Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 novcanik/withdraw — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/novcanik/withdraw/route.ts');

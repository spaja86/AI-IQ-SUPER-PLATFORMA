// Autofinish — io-openui-ao-gaming-platforma-pregled Route Coverage Test
...
import { GET } from '../../app/api/io-openui-ao-gaming-platforma-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 io-openui-ao-gaming-platforma-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/io-openui-ao-gaming-platforma-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/io-openui-ao-gaming-platforma-pregled', {

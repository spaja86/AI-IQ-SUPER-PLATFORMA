// Autofinish — industrija Route Coverage Test
...
import { GET } from '../../app/api/industrija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 industrija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/industrija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/industrija', {

// Autofinish — platforma-arhitektura Route Coverage Test
...
import { GET } from '../../app/api/platforma-arhitektura/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-arhitektura — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-arhitektura/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-arhitektura', {

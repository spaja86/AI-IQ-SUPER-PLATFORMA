// Autofinish — mobilna-mreza Route Coverage Test
...
import { GET } from '../../app/api/mobilna-mreza/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 mobilna-mreza — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/mobilna-mreza/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/mobilna-mreza', {

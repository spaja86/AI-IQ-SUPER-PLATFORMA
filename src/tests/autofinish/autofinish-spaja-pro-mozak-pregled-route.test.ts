// Autofinish — autofinish-spaja-pro-mozak-pregled Route Coverage Test
...
import { GET } from '../../app/api/autofinish-spaja-pro-mozak-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-spaja-pro-mozak-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-spaja-pro-mozak-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-spaja-pro-mozak-pregled', {

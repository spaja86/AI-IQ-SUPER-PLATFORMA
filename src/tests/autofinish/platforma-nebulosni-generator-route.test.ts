// Autofinish — platforma-nebulosni-generator Route Coverage Test
...
import { GET } from '../../app/api/platforma-nebulosni-generator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-nebulosni-generator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-nebulosni-generator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-nebulosni-generator', {

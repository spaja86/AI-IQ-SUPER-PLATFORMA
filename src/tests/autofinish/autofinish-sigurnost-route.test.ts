// Autofinish — autofinish-sigurnost Route Coverage Test
...
import { GET } from '../../app/api/autofinish-sigurnost/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-sigurnost — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-sigurnost/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-sigurnost', {

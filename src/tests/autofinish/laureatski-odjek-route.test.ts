// Autofinish — laureatski-odjek Route Coverage Test
...
import { GET } from '../../app/api/laureatski-odjek/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 laureatski-odjek — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/laureatski-odjek/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/laureatski-odjek', {

// Autofinish — ultra-vakuumski-generator Route Coverage Test
...
import { GET } from '../../app/api/ultra-vakuumski-generator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 ultra-vakuumski-generator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ultra-vakuumski-generator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/ultra-vakuumski-generator', {

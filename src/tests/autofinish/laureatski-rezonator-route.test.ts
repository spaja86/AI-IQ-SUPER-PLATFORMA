// Autofinish — laureatski-rezonator Route Coverage Test
...
import { GET } from '../../app/api/laureatski-rezonator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 laureatski-rezonator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/laureatski-rezonator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/laureatski-rezonator', {

// Autofinish — omega-plasmatski-kondenzator Route Coverage Test
...
import { GET } from '../../app/api/omega-plasmatski-kondenzator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-plasmatski-kondenzator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-plasmatski-kondenzator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-plasmatski-kondenzator', {

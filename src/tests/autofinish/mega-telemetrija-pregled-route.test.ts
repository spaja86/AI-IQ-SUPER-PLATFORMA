// Autofinish — mega-telemetrija-pregled Route Coverage Test
...
import { GET } from '../../app/api/mega-telemetrija-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 mega-telemetrija-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/mega-telemetrija-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/mega-telemetrija-pregled', {

// Autofinish — menjacnica-edukacija Route Coverage Test
...
import { GET } from '../../app/api/menjacnica-edukacija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 menjacnica-edukacija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/menjacnica-edukacija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/menjacnica-edukacija', {

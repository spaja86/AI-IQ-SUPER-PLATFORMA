// Autofinish — omega-neuronska-evolucija Route Coverage Test
...
import { GET } from '../../app/api/omega-neuronska-evolucija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-neuronska-evolucija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-neuronska-evolucija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-neuronska-evolucija', {

// Autofinish — autofinish-export Route Coverage Test
...
import { GET } from '../../app/api/autofinish-export/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-export — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-export/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-export', {

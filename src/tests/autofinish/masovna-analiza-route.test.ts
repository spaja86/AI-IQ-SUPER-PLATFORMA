// Autofinish — masovna-analiza Route Coverage Test
...
import { GET } from '../../app/api/masovna-analiza/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 masovna-analiza — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/masovna-analiza/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/masovna-analiza', {

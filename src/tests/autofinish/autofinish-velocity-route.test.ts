// Autofinish — autofinish-velocity Route Coverage Test
...
import { GET } from '../../app/api/autofinish-velocity/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-velocity — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-velocity/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-velocity', {

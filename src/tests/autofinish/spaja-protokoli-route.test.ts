// Autofinish — spaja-protokoli Route Coverage Test
...
import { GET } from '../../app/api/spaja-protokoli/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-protokoli — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-protokoli/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-protokoli', {

// Autofinish — billing-churn Route Coverage Test
...
import { GET } from '../../app/api/billing-churn/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 billing-churn — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/billing-churn/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/billing-churn', {

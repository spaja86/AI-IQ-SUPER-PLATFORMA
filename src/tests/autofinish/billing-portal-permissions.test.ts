// Autofinish #1140 — Billing Portal/Checkout Permission Tests (#24)
...
async function runTests(): Promise<void> {
  console.log('\n📋 Billing Portal/Checkout Permission Tests (#1140)\n');
  ...
  await test('AUTOFINISH_COUNT >= 1140', () => { assert(AUTOFINISH_COUNT >= 1140, `count=${AUTOFINISH_COUNT}`); });

// Autofinish #1133 — Billing Portal/Checkout Permission Tests (#24)
...
async function runTests(): Promise<void> {
  console.log('\n📋 Billing Portal/Checkout Permission Tests (#1133)\n');
  ...
  await test('AUTOFINISH_COUNT >= 1133', () => { assert(AUTOFINISH_COUNT >= 1133, `count=${AUTOFINISH_COUNT}`); });

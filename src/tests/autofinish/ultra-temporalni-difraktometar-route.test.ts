// Autofinish — ultra-temporalni-difraktometar Route Coverage Test
...
import { GET } from '../../app/api/ultra-temporalni-difraktometar/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 ultra-temporalni-difraktometar — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ultra-temporalni-difraktometar/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/ultra-temporalni-difraktometar', {

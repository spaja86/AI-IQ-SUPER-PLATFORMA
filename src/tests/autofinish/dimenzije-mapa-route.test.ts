// Autofinish — dimenzije-mapa Route Coverage Test
...
import { GET } from '../../app/api/dimenzije-mapa/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 dimenzije-mapa — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/dimenzije-mapa/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/dimenzije-mapa', {

// Autofinish — platforma-dimenzionalni-indeks Route Coverage Test
...
import { GET } from '../../app/api/platforma-dimenzionalni-indeks/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-dimenzionalni-indeks — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-dimenzionalni-indeks/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-dimenzionalni-indeks', {

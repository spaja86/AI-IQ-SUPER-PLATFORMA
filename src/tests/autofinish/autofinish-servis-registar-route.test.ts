// Autofinish — autofinish-servis-registar Route Coverage Test
...
import { GET } from '../../app/api/autofinish-servis-registar/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-servis-registar — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-servis-registar/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-servis-registar', {

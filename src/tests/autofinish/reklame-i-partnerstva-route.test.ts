// Autofinish — reklame-i-partnerstva Route Coverage Test
...
import { GET } from '../../app/api/reklame-i-partnerstva/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 reklame-i-partnerstva — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/reklame-i-partnerstva/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/reklame-i-partnerstva', {

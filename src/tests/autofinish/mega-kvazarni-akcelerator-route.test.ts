// Autofinish — mega-kvazarni-akcelerator Route Coverage Test
...
import { GET } from '../../app/api/mega-kvazarni-akcelerator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 mega-kvazarni-akcelerator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/mega-kvazarni-akcelerator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/mega-kvazarni-akcelerator', {

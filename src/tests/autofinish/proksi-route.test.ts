// Autofinish — proksi Route Coverage Test
...
import { GET } from '../../app/api/proksi/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 proksi — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/proksi/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/proksi', {

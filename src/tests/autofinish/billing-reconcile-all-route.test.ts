// Autofinish — billing-reconcile-all Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 billing-reconcile-all — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/billing-reconcile-all/route.ts');

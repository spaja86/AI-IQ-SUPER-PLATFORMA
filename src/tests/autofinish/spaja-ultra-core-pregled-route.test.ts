// Autofinish — spaja-ultra-core-pregled Route Coverage Test
...
import { GET } from '../../app/api/spaja-ultra-core-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-ultra-core-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-ultra-core-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-ultra-core-pregled', {

// Autofinish — blockchain-transakcije Route Coverage Test
...
import { GET } from '../../app/api/blockchain-transakcije/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 blockchain-transakcije — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/blockchain-transakcije/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/blockchain-transakcije', {

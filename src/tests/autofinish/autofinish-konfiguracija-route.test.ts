// Autofinish — autofinish-konfiguracija Route Coverage Test
...
import { GET } from '../../app/api/autofinish-konfiguracija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-konfiguracija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-konfiguracija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-konfiguracija', {

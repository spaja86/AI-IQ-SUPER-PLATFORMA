// Autofinish — autofinish-iteracija-monitor Route Coverage Test
...
import { GET } from '../../app/api/autofinish-iteracija-monitor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-iteracija-monitor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-iteracija-monitor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-iteracija-monitor', {

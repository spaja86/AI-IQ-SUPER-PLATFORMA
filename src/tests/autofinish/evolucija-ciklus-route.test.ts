// Autofinish — evolucija-ciklus Route Coverage Test
...
import { GET } from '../../app/api/evolucija-ciklus/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 evolucija-ciklus — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/evolucija-ciklus/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/evolucija-ciklus', {

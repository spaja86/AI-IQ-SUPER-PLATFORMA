// Autofinish — platforma-neutronski-akselerator Route Coverage Test
...
import { GET } from '../../app/api/platforma-neutronski-akselerator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-neutronski-akselerator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-neutronski-akselerator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-neutronski-akselerator', {

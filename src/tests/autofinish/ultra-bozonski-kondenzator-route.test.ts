// Autofinish — ultra-bozonski-kondenzator Route Coverage Test
...
import { GET } from '../../app/api/ultra-bozonski-kondenzator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 ultra-bozonski-kondenzator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ultra-bozonski-kondenzator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/ultra-bozonski-kondenzator', {

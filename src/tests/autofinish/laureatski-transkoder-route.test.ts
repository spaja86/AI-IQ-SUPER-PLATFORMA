// Autofinish — laureatski-transkoder Route Coverage Test
...
import { GET } from '../../app/api/laureatski-transkoder/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 laureatski-transkoder — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/laureatski-transkoder/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/laureatski-transkoder', {

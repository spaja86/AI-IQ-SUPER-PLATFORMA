// Autofinish — autofinish-podsistemi Route Coverage Test
...
import { GET } from '../../app/api/autofinish-podsistemi/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-podsistemi — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-podsistemi/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-podsistemi', {

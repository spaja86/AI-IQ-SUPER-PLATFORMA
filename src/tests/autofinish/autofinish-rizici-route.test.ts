// Autofinish — autofinish-rizici Route Coverage Test
...
import { GET } from '../../app/api/autofinish-rizici/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-rizici — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-rizici/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-rizici', {

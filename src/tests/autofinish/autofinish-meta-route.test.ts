// Autofinish — autofinish-meta Route Coverage Test
...
import { GET } from '../../app/api/autofinish-meta/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-meta — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-meta/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-meta', {

// Autofinish — kripto-trezor/compliance Route Coverage Test
...
import { GET } from '../../app/api/kripto-trezor/compliance/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 kripto-trezor/compliance — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/kripto-trezor/compliance/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/kripto-trezor/compliance', {

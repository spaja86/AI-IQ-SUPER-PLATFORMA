// Autofinish — omega-projekat-plasiranje Route Coverage Test
...
import { GET } from '../../app/api/omega-projekat-plasiranje/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-projekat-plasiranje — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-projekat-plasiranje/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-projekat-plasiranje', {

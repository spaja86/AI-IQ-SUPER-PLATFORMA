// Autofinish — gejming-likovi Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 gejming-likovi — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/gejming-likovi/route.ts');

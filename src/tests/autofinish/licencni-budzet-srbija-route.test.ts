// Autofinish — licencni-budzet-srbija Route Coverage Test
...
import { GET } from '../../app/api/licencni-budzet-srbija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 licencni-budzet-srbija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/licencni-budzet-srbija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/licencni-budzet-srbija', {

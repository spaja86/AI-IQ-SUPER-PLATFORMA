// Autofinish — autofinish-trend-kategorije Route Coverage Test
...
import { GET } from '../../app/api/autofinish-trend-kategorije/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-trend-kategorije — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-trend-kategorije/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-trend-kategorije', {

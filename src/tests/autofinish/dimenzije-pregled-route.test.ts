// Autofinish — dimenzije-pregled Route Coverage Test
...
import { GET } from '../../app/api/dimenzije-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 dimenzije-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/dimenzije-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/dimenzije-pregled', {

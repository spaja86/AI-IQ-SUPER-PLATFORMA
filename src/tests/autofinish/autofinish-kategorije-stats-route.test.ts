// Autofinish — autofinish-kategorije-stats Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-kategorije-stats — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-kategorije-stats/route.ts');

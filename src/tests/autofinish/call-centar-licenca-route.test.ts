// Autofinish — call-centar/licenca Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 call-centar/licenca — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/call-centar/licenca/route.ts');

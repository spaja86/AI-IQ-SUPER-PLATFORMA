// Autofinish — autofinish-top-iteracije Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-top-iteracije — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-top-iteracije/route.ts');

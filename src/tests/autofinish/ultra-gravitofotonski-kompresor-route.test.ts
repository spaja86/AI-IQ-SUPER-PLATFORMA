// Autofinish — ultra-gravitofotonski-kompresor Route Coverage Test
...
import { GET } from '../../app/api/ultra-gravitofotonski-kompresor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 ultra-gravitofotonski-kompresor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ultra-gravitofotonski-kompresor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/ultra-gravitofotonski-kompresor', {

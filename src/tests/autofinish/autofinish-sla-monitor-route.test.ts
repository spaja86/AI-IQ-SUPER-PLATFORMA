// Autofinish — autofinish-sla-monitor Route Coverage Test
...
import { GET } from '../../app/api/autofinish-sla-monitor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-sla-monitor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-sla-monitor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-sla-monitor', {

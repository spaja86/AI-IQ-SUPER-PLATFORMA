// Autofinish — autofinish-poslovni-tok Route Coverage Test
...
import { GET } from '../../app/api/autofinish-poslovni-tok/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-poslovni-tok — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-poslovni-tok/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-poslovni-tok', {

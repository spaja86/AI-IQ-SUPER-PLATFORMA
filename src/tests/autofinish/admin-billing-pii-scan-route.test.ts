// Autofinish — admin/billing-pii-scan Route Coverage Test
...
import { GET } from '../../app/api/admin/billing-pii-scan/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 admin/billing-pii-scan — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/admin/billing-pii-scan/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/admin/billing-pii-scan', {

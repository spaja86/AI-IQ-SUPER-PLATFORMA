// Autofinish — banka-transfer-dugovi Route Coverage Test
...
import { GET } from '../../app/api/banka-transfer-dugovi/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 banka-transfer-dugovi — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/banka-transfer-dugovi/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/banka-transfer-dugovi', {

// Autofinish — dijagnostika-demo-nalog Route Coverage Test
...
import { GET } from '../../app/api/dijagnostika-demo-nalog/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 dijagnostika-demo-nalog — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/dijagnostika-demo-nalog/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/dijagnostika-demo-nalog', {

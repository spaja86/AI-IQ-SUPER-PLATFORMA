// Autofinish — omega-torzijski-akcelerator Route Coverage Test
...
import { GET } from '../../app/api/omega-torzijski-akcelerator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-torzijski-akcelerator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-torzijski-akcelerator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-torzijski-akcelerator', {

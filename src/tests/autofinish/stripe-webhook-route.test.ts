// Autofinish — stripe/webhook Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 stripe/webhook — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/stripe/webhook/route.ts');

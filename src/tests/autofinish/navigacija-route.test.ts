// Autofinish — navigacija Route Coverage Test
...
import { GET } from '../../app/api/navigacija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 navigacija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/navigacija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/navigacija', {

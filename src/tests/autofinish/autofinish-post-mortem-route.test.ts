// Autofinish — autofinish-post-mortem Route Coverage Test
...
import { GET } from '../../app/api/autofinish-post-mortem/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-post-mortem — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-post-mortem/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-post-mortem', {

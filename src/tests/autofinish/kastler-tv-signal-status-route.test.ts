// Autofinish — kastler-tv-signal-status Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 kastler-tv-signal-status — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/kastler-tv-signal-status/route.ts');

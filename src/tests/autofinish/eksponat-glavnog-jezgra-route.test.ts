// Autofinish — eksponat-glavnog-jezgra Route Coverage Test
...
import { GET } from '../../app/api/eksponat-glavnog-jezgra/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 eksponat-glavnog-jezgra — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/eksponat-glavnog-jezgra/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/eksponat-glavnog-jezgra', {

// Autofinish — dijagnostika-glavni-endzin-monitoring Route Coverage Test
...
import { GET } from '../../app/api/dijagnostika-glavni-endzin-monitoring/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 dijagnostika-glavni-endzin-monitoring — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/dijagnostika-glavni-endzin-monitoring/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/dijagnostika-glavni-endzin-monitoring', {

// Autofinish — autofinish-istrazivanje-ekosistem Route Coverage Test
...
import { GET } from '../../app/api/autofinish-istrazivanje-ekosistem/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-istrazivanje-ekosistem — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-istrazivanje-ekosistem/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-istrazivanje-ekosistem', {

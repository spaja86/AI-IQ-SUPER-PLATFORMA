// Autofinish — laureatski-dekoder Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 laureatski-dekoder — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/laureatski-dekoder/route.ts');

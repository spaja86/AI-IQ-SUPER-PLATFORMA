// Autofinish — autofinish-integracija Route Coverage Test
...
import { GET } from '../../app/api/autofinish-integracija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-integracija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-integracija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-integracija', {

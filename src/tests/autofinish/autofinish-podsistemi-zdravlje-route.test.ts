// Autofinish — autofinish-podsistemi-zdravlje Route Coverage Test
...
import { GET } from '../../app/api/autofinish-podsistemi-zdravlje/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-podsistemi-zdravlje — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-podsistemi-zdravlje/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-podsistemi-zdravlje', {

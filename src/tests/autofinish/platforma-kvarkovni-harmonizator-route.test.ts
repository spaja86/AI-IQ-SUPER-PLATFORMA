// Autofinish — platforma-kvarkovni-harmonizator Route Coverage Test
...
import { GET } from '../../app/api/platforma-kvarkovni-harmonizator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-kvarkovni-harmonizator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-kvarkovni-harmonizator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-kvarkovni-harmonizator', {

// Autofinish — autofinish-resursi Route Coverage Test
...
import { GET } from '../../app/api/autofinish-resursi/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-resursi — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-resursi/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-resursi', {

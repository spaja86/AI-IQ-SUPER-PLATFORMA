// Autofinish — laureatski-talas Route Coverage Test
...
import { GET } from '../../app/api/laureatski-talas/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 laureatski-talas — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/laureatski-talas/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/laureatski-talas', {

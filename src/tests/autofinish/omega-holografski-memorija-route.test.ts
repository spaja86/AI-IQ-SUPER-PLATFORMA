// Autofinish — omega-holografski-memorija Route Coverage Test
...
import { GET } from '../../app/api/omega-holografski-memorija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-holografski-memorija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-holografski-memorija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-holografski-memorija', {

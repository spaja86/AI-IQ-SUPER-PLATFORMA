// Autofinish — ai-asistent Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 ai-asistent — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ai-asistent/route.ts');
  ...
  await test('POST odbija nevalidan JSON payload', async () => {
    const req = new Request('http://localhost/api/ai-asistent', {
      method: 'POST',

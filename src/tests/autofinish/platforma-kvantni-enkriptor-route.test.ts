// Autofinish — platforma-kvantni-enkriptor Route Coverage Test
...
import { GET } from '../../app/api/platforma-kvantni-enkriptor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-kvantni-enkriptor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-kvantni-enkriptor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-kvantni-enkriptor', {

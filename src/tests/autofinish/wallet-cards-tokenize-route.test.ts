// Autofinish — wallet/cards/tokenize Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 wallet/cards/tokenize — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/wallet/cards/tokenize/route.ts');

// Autofinish — full-ecosystem Route Coverage Test
...
import { GET } from '../../app/api/full-ecosystem/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 full-ecosystem — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/full-ecosystem/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/full-ecosystem', {

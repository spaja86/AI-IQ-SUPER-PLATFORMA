// Autofinish — profesionalni-mejl-banka-integracija Route Coverage Test
...
import { GET } from '../../app/api/profesionalni-mejl-banka-integracija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 profesionalni-mejl-banka-integracija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/profesionalni-mejl-banka-integracija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/profesionalni-mejl-banka-integracija', {

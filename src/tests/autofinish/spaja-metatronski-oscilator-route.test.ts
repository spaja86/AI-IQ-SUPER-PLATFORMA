// Autofinish — spaja-metatronski-oscilator Route Coverage Test
...
import { GET } from '../../app/api/spaja-metatronski-oscilator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-metatronski-oscilator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-metatronski-oscilator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-metatronski-oscilator', {

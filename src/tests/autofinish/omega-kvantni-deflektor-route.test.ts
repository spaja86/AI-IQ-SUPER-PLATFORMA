// Autofinish — omega-kvantni-deflektor Route Coverage Test
...
import { GET } from '../../app/api/omega-kvantni-deflektor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-kvantni-deflektor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-kvantni-deflektor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-kvantni-deflektor', {

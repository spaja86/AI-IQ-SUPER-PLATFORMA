// Autofinish — protokoli/export Route Coverage Test
...
import { GET } from '../../app/api/protokoli/export/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 protokoli/export — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/protokoli/export/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/protokoli/export', {

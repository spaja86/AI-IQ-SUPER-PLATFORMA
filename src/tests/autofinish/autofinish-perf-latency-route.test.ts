// Autofinish — autofinish-perf-latency Route Coverage Test
...
import { GET } from '../../app/api/autofinish-perf-latency/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-perf-latency — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-perf-latency/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-perf-latency', {

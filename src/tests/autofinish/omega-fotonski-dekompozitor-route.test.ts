// Autofinish — omega-fotonski-dekompozitor Route Coverage Test
...
import { GET } from '../../app/api/omega-fotonski-dekompozitor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-fotonski-dekompozitor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-fotonski-dekompozitor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-fotonski-dekompozitor', {

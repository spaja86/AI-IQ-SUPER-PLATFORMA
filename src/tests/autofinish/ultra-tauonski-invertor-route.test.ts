// Autofinish — ultra-tauonski-invertor Route Coverage Test
...
import { GET } from '../../app/api/ultra-tauonski-invertor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 ultra-tauonski-invertor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ultra-tauonski-invertor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/ultra-tauonski-invertor', {

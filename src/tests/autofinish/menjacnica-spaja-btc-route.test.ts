// Autofinish — menjacnica/spaja-btc Route Coverage Test
...
import { GET } from '../../app/api/menjacnica/spaja-btc/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 menjacnica/spaja-btc — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/menjacnica/spaja-btc/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/menjacnica/spaja-btc', {

// Autofinish — stripe/portal Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 stripe/portal — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/stripe/portal/route.ts');

// Autofinish — ultra-pionski-oscilator Route Coverage Test
...
import { GET } from '../../app/api/ultra-pionski-oscilator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 ultra-pionski-oscilator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/ultra-pionski-oscilator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/ultra-pionski-oscilator', {

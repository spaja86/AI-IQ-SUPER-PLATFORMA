// Autofinish — novcanik/ledger Route Coverage Test
...
import { GET } from '../../app/api/novcanik/ledger/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 novcanik/ledger — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/novcanik/ledger/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/novcanik/ledger', {

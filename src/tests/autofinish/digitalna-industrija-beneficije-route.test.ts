// Autofinish — digitalna-industrija-beneficije Route Coverage Test
...
import { GET } from '../../app/api/digitalna-industrija-beneficije/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 digitalna-industrija-beneficije — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/digitalna-industrija-beneficije/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/digitalna-industrija-beneficije', {

// Autofinish — platforms/health Route Coverage Test
...
import { GET } from '../../app/api/platforms/health/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforms/health — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforms/health/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforms/health', {

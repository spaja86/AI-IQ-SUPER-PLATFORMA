// Autofinish — banka-partneri Route Coverage Test
...
import { GET } from '../../app/api/banka-partneri/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 banka-partneri — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/banka-partneri/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/banka-partneri', {

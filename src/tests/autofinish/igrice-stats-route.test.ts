// Autofinish — igrice-stats Route Coverage Test
...
import { GET } from '../../app/api/igrice-stats/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 igrice-stats — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/igrice-stats/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/igrice-stats', {

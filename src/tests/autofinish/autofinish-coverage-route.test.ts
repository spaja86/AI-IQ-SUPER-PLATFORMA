// Autofinish — autofinish-coverage Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-coverage — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-coverage/route.ts');

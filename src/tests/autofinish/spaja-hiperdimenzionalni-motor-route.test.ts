// Autofinish — spaja-hiperdimenzionalni-motor Route Coverage Test
...
import { GET } from '../../app/api/spaja-hiperdimenzionalni-motor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-hiperdimenzionalni-motor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-hiperdimenzionalni-motor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-hiperdimenzionalni-motor', {

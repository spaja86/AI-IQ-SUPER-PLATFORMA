// Autofinish — autofinish-iteracija-raspon Route Coverage Test
...
import { GET } from '../../app/api/autofinish-iteracija-raspon/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-iteracija-raspon — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-iteracija-raspon/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-iteracija-raspon', {

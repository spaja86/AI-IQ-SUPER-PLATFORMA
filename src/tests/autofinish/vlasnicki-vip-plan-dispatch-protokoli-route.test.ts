// Autofinish — vlasnicki-vip-plan-dispatch-protokoli Route Coverage Test
...
import { GET } from '../../app/api/vlasnicki-vip-plan-dispatch-protokoli/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 vlasnicki-vip-plan-dispatch-protokoli — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/vlasnicki-vip-plan-dispatch-protokoli/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/vlasnicki-vip-plan-dispatch-protokoli', {

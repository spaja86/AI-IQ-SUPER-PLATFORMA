// Autofinish — omega-kvazarni-emiter Route Coverage Test
...
import { GET } from '../../app/api/omega-kvazarni-emiter/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-kvazarni-emiter — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-kvazarni-emiter/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-kvazarni-emiter', {

// Autofinish — issuer-licensing/issue Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 issuer-licensing/issue — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/issuer-licensing/issue/route.ts');

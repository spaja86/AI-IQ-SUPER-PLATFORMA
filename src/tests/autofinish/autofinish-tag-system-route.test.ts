// Autofinish — autofinish-tag-system Route Coverage Test
...
import { GET } from '../../app/api/autofinish-tag-system/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-tag-system — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-tag-system/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-tag-system', {

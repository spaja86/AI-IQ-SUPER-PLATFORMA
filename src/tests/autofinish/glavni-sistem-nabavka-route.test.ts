// Autofinish — glavni-sistem-nabavka Route Coverage Test
...
import { GET } from '../../app/api/glavni-sistem-nabavka/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 glavni-sistem-nabavka — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/glavni-sistem-nabavka/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/glavni-sistem-nabavka', {

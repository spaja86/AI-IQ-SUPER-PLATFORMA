// Autofinish — novcanik/accounts Route Coverage Test
...
import { GET } from '../../app/api/novcanik/accounts/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 novcanik/accounts — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/novcanik/accounts/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/novcanik/accounts', {

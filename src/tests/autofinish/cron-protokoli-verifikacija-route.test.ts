// Autofinish — cron/protokoli-verifikacija Route Coverage Test
...
import { GET } from '../../app/api/cron/protokoli-verifikacija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 cron/protokoli-verifikacija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/cron/protokoli-verifikacija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/cron/protokoli-verifikacija', {

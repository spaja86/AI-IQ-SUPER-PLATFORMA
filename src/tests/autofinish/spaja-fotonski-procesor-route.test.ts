// Autofinish — spaja-fotonski-procesor Route Coverage Test
...
import { GET } from '../../app/api/spaja-fotonski-procesor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-fotonski-procesor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-fotonski-procesor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-fotonski-procesor', {

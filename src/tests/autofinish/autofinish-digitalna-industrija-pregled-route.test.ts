// Autofinish — autofinish-digitalna-industrija-pregled Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-digitalna-industrija-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-digitalna-industrija-pregled/route.ts');

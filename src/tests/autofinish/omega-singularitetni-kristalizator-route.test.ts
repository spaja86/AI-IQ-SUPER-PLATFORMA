// Autofinish — omega-singularitetni-kristalizator Route Coverage Test
...
import { GET } from '../../app/api/omega-singularitetni-kristalizator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-singularitetni-kristalizator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-singularitetni-kristalizator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-singularitetni-kristalizator', {

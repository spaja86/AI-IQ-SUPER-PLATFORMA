// Autofinish — spaja-unit-testovi-suite Route Coverage Test
...
import { GET } from '../../app/api/spaja-unit-testovi-suite/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-unit-testovi-suite — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-unit-testovi-suite/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-unit-testovi-suite', {

// Autofinish — profesionalni-mejl-dijagnostika Route Coverage Test
...
import { GET } from '../../app/api/profesionalni-mejl-dijagnostika/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 profesionalni-mejl-dijagnostika — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/profesionalni-mejl-dijagnostika/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/profesionalni-mejl-dijagnostika', {

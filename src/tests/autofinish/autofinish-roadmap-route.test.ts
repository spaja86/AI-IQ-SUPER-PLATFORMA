// Autofinish — autofinish-roadmap Route Coverage Test
...
import { GET } from '../../app/api/autofinish-roadmap/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-roadmap — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-roadmap/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-roadmap', {

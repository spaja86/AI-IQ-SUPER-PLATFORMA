// Autofinish — organizacije Route Coverage Test
...
import { GET } from '../../app/api/organizacije/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 organizacije — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/organizacije/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/organizacije', {

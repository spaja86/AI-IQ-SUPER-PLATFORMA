// Autofinish — autofinish-optimizacija Route Coverage Test
...
import { GET } from '../../app/api/autofinish-optimizacija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 autofinish-optimizacija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/autofinish-optimizacija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/autofinish-optimizacija', {

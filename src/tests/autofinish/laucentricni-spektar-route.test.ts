// Autofinish — laucentricni-spektar Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 laucentricni-spektar — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/laucentricni-spektar/route.ts');

// Autofinish — wallet/cards/setup-intent Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 wallet/cards/setup-intent — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/wallet/cards/setup-intent/route.ts');

// Autofinish — platforma-fotonski-multipleksor Route Coverage Test
...
import { GET } from '../../app/api/platforma-fotonski-multipleksor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-fotonski-multipleksor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-fotonski-multipleksor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-fotonski-multipleksor', {

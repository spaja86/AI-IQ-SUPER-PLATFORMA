// Autofinish — spaja-antimaterijalski-transmutator Route Coverage Test
...
import { GET } from '../../app/api/spaja-antimaterijalski-transmutator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 spaja-antimaterijalski-transmutator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/spaja-antimaterijalski-transmutator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/spaja-antimaterijalski-transmutator', {

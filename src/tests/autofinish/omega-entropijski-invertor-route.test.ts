// Autofinish — omega-entropijski-invertor Route Coverage Test
...
import { GET } from '../../app/api/omega-entropijski-invertor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-entropijski-invertor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-entropijski-invertor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-entropijski-invertor', {

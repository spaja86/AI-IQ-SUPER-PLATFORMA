// Autofinish — mega-dijagnostika Route Coverage Test
...
import { GET } from '../../app/api/mega-dijagnostika/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 mega-dijagnostika — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/mega-dijagnostika/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/mega-dijagnostika', {

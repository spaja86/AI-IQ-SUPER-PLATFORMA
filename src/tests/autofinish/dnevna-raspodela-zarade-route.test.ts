// Autofinish — dnevna-raspodela-zarade Route Coverage Test
...
import { GET } from '../../app/api/dnevna-raspodela-zarade/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 dnevna-raspodela-zarade — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/dnevna-raspodela-zarade/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/dnevna-raspodela-zarade', {

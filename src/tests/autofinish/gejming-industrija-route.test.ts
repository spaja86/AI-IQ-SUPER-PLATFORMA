// Autofinish — gejming-industrija Route Coverage Test
...
import { GET } from '../../app/api/gejming-industrija/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 gejming-industrija — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/gejming-industrija/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/gejming-industrija', {

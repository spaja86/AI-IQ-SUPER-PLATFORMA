// Autofinish — omega-plazmeni-kondenzator Route Coverage Test
...
import { GET } from '../../app/api/omega-plazmeni-kondenzator/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 omega-plazmeni-kondenzator — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/omega-plazmeni-kondenzator/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/omega-plazmeni-kondenzator', {

// Autofinish — evolucija-pregled Route Coverage Test
...
import { GET } from '../../app/api/evolucija-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 evolucija-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/evolucija-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/evolucija-pregled', {

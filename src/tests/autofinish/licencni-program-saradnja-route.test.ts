// Autofinish — licencni-program-saradnja Route Coverage Test
...
async function runTests(): Promise<void> {
  console.log('\n🏁 licencni-program-saradnja — Route Coverage Test Suite\n');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/licencni-program-saradnja', {

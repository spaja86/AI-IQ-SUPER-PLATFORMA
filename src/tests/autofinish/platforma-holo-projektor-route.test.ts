// Autofinish — platforma-holo-projektor Route Coverage Test
...
import { GET } from '../../app/api/platforma-holo-projektor/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 platforma-holo-projektor — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/platforma-holo-projektor/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/platforma-holo-projektor', {

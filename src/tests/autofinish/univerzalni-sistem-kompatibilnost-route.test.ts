// Autofinish — univerzalni-sistem-kompatibilnost Route Coverage Test
...
import { GET } from '../../app/api/univerzalni-sistem-kompatibilnost/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 univerzalni-sistem-kompatibilnost — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/univerzalni-sistem-kompatibilnost/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/univerzalni-sistem-kompatibilnost', {

// Autofinish — mega-fotonski-kolajder Route Coverage Test
...
import { GET } from '../../app/api/mega-fotonski-kolajder/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 mega-fotonski-kolajder — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/mega-fotonski-kolajder/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/mega-fotonski-kolajder', {

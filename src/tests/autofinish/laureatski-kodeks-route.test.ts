// Autofinish — laureatski-kodeks Route Coverage Test
...
import { GET } from '../../app/api/laureatski-kodeks/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 laureatski-kodeks — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/laureatski-kodeks/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/laureatski-kodeks', {

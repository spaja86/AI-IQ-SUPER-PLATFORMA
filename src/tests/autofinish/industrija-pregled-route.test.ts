// Autofinish — industrija-pregled Route Coverage Test
...
import { GET } from '../../app/api/industrija-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 industrija-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/industrija-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/industrija-pregled', {

// Autofinish — sistem-pregled Route Coverage Test
...
import { GET } from '../../app/api/sistem-pregled/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 sistem-pregled — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/sistem-pregled/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/sistem-pregled', {

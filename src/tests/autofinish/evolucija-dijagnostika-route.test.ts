// Autofinish — evolucija-dijagnostika Route Coverage Test
...
import { GET } from '../../app/api/evolucija-dijagnostika/route';

async function runTests(): Promise<void> {
  console.log('\n🏁 evolucija-dijagnostika — Route Coverage Test Suite\n');

  const routePath = path.resolve(process.cwd(), 'src/app/api/evolucija-dijagnostika/route.ts');
  ...
  await test('GET smoke provera', async () => {
    const request = new Request('http://localhost/api/evolucija-dijagnostika', {

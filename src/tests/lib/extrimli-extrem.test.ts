...
async function runTests(): Promise<void> {
  ...
  await test('DOK/DIK/DAK/DUK/FOR consistency health preserves EXTREM vs EXTRONDOL ownership boundary', () => {
    ...
    assert(developerCreateMaticneCelijeSupplemental?.visualReference.includes('908ab1a4-5a00-4f93-971a-2cd8e331119d'), 'developer/create MATIČNE ĆELIJE supplemental visual reference mismatch');
    ...
    assert(
      report.dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.currentImplementationStage.acceptanceEvidence.join(',') ===
        'dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection,dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.covecnostAuditVisualReference,dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.covecnostAuditVisualReference.supplementalVisualReferences,dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.covecnostAuditVisualReference.companionAuditVisualReferences,dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.aiPlateOffer,spajaKod.publicSignals.developerAndCreateStatus,radniTaktMozgaMislilac.readiness,metrikoProgramiranje.readiness,sinemetrickoProgramiranje.readiness,paradijogonalnoProgrimiranje.readiness,vrhProgramskogEkviladenta.readiness',

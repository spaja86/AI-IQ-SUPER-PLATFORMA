...
async function runTests(): Promise<void> {
  ...
  await test('default report exposes Developer/Create lock through the shared roadmap', () => {
    ...
    assert(sarkazamPrivrednaGranaDigitalizmaTrack.summarySafePublicFields.join(',') === 'canonicalAlias,status,blockerReason,reviewPosture,downstreamReference,scopeClassification', 'developer/create Sarkazam summary-safe fields mismatch');

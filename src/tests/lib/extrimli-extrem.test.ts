...
async function runTests(): Promise<void> {
  ...
  await test('DOK/DIK/DAK/DUK/FOR consistency health preserves EXTREM vs EXTRONDOL ownership boundary', () => {
    ...
    assert(report.dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.inspektori.justicePath.reviewPosture !== 'REVIEW_REQUIRED', 'developer/create INSPEKTORI review posture should not be forced into REVIEW_REQUIRED by the mandatory human-review gate alone');
    assert(

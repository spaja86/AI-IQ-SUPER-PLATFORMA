...
async function runTests(): Promise<void> {
  ...
  await test('DOK/DIK/DAK/DUK/FOR consistency health preserves EXTREM vs EXTRONDOL ownership boundary', () => {
    ...
    assert(report.dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.covecnostAuditVisualReference.supplementalVisualReferences.length === 1, 'developer/create supplemental visual reference count mismatch');
    assert(report.dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.covecnostAuditVisualReference.supplementalVisualReferences[0]?.canonicalNarrativeId === 'covecanstvo-zivot-je-najveca-igra', 'developer/create supplemental visual narrative id mismatch');
    ...
    assert(report.dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.currentImplementationStage.acceptanceEvidence.join(',') === 'dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection,dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.covecnostAuditVisualReference,dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.covecnostAuditVisualReference.supplementalVisualReferences,spajaKod.publicSignals.developerAndCreateStatus,radniTaktMozgaMislilac.readiness,metrikoProgramiranje.readiness,sinemetrickoProgramiranje.readiness,paradijogonalnoProgrimiranje.readiness,vrhProgramskogEkviladenta.readiness', 'developer/create EXTREM acceptance evidence mismatch');

...
async function runTests(): Promise<void> {
  ...
  await test('DOK/DIK/DAK/DUK/FOR consistency health preserves EXTREM vs EXTRONDOL ownership boundary', () => {
    ...
    assert(report.dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.packageOutputs.auditShortSummary.includes('PRIRODNE MATIČNE ĆELIJE / KUKURUZ'), 'developer/create package audit summary should mention KUKURUZ');
    assert(report.dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.packageOutputs.publicSummary.includes('tri URL-locked pending-title reference'), 'developer/create package public summary should mention URL-locked visuals');

...
async function runTests(): Promise<void> {
  ...
  await test('DOK/DIK/DAK/DUK/FOR consistency health preserves EXTREM vs EXTRONDOL ownership boundary', () => {
    ...
    assert(report.dokDikDakDukConsistencyHealth.developerAndCreateRepoWideReflection.inspektori.justicePath.reviewPosture === 'ALIGNED', 'developer/create INSPEKTORI review posture should stay aligned when technical justice-path signals are healthy');
    assert(

...
async function runTests(): Promise<void> {
  ...
  await test('DOK/DIK/DAK/DUK/FOR consistency health stays deterministic across technical and governance layers', () => {
    ...
    assert(report.spajaKod.publicSignals.smartProgramskiJezikStatus === implementationPackage.smartProgramskiJezikPackage.technicalProfile.status, 'SPAJA KOD smart language status mismatch');
    assert(report.spajaKod.developerAndCreateImplementationPackage.smartProgramskiJezikSummary.canonicalName === implementationPackage.smartProgramskiJezikPackage.canonicalName, 'SPAJA KOD smart language canonical name mismatch');

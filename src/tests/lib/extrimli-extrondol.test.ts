  ...
  await test('report includes bounded orchestration score and degraded policy', () => {
    ...
    assert(
      releaseAuditAcceptanceEvidence.indexOf('releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.aiIqLaboratorijaTrack')
        > releaseAuditAcceptanceEvidence.indexOf('releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.radniProstorTrack')
      ...
      'developer/create release audit acceptance evidence must place AI IQ LABORATORIJA after RADNI PROSTOR and RADIO after AI IQ press tracks',
    );

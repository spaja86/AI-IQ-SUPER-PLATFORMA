...
async function runTests(): Promise<void> {
  ...
  await test('report maps RADNI TAKT MOZGA (MISLILAC) into WAWE governance, audit summary, downstream sync, and SPAJA KOD epilog', () => {
    ...
    assert(report.releaseAuditSummary.radniTaktMozgaMislilacGovernance.epilogijaCovecnosti.canonicalNarrativeId === 'zivot-je-igra-sitni-koraci-covecanstvo', 'radni takt canonical narrative id mismatch');
    assert(report.releaseAuditSummary.radniTaktMozgaMislilacGovernance.epilogijaCovecnosti.citation.includes('Život je igra'), 'radni takt audit epilog citation mismatch');
    assert(report.releaseAuditSummary.radniTaktMozgaMislilacGovernance.epilogijaCovecnosti.visualReference.includes('a1346923-892c-47ab-bd58-d9ef9fcbabff'), 'radni takt audit epilog visual reference mismatch');
    ...
    assert(report.releaseAuditSummary.radniTaktMozgaMislilacGovernance.epilogijaCovecnosti.packageOutputs.masterEpilog.includes('čovečanstvo mora'), 'radni takt audit master epilog mismatch');
    ...
    assert(report.spajaKod.epilogijaCovecnosti.visualReference.includes('a1346923-892c-47ab-bd58-d9ef9fcbabff'), 'SPAJA KOD epilog visual reference mismatch');
    assert(report.spajaKod.epilogijaCovecnosti.packageOutputs.posterSummary.includes('čuvaj ljude i prirodu'), 'SPAJA KOD poster summary mismatch');
    ...
    assert(report.radniTaktMozgaMislilac.reasons.includes('epilog:canonical-zivot-je-igra-sitni-koraci-covecanstvo'), 'radni takt canonical epilog governance reason missing');

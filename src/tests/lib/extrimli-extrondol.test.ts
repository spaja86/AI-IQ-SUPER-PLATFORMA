...
async function runTests(): Promise<void> {
  ...
  await test('report includes bounded orchestration score and degraded policy', () => {
    ...
    assert(report.releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.covecnostAuditVisualReference.visualReference.includes('19687ee8-363f-4c10-ba2d-bd451598b4df'), 'developer/create release audit ČOVEČNOST visual reference mismatch');
    ...
    assert(report.releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.companionAuditVisualReferences[0].canonicalNarrativeId === 'covecanstvo-osecaj-osebenosti-developer-create-vrh-radni-takt', 'developer/create release audit companion narrative id mismatch');
    assert(report.releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.companionAuditVisualReferences[0].visualReference.includes('9273c07f-5c03-4db4-a469-d22d456596f9'), 'developer/create release audit companion visual reference mismatch');
    assert(report.releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.companionAuditVisualReferences[0].imageToSignalProfile.signalOutputs.readinessStatus === report.releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.status, 'developer/create release audit companion readiness status mismatch');

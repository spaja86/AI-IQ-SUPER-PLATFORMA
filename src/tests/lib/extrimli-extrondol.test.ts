...
async function runTests(): Promise<void> {
  ...
  await test('report maps RADNI TAKT MOZGA (MISLILAC) into WAWE governance, audit summary, downstream sync, and SPAJA KOD epilog', () => {
    ...
    assert(report.radniTaktMozgaMislilac.reasons.includes('epilog:canonical-sunce-suncanica-prirodni-odnosi'), 'radni takt canonical epilog governance reason missing');

...
async function runTests(): Promise<void> {
  ...
  await test('DOK/DIK/DAK/DUK/FOR consistency health stays deterministic across technical and governance layers', () => {
    ...
    assert(report.developerAndCreateRepoWideReflection.inspektori.justicePath.reviewPosture !== 'REVIEW_REQUIRED', 'developer/create INSPEKTORI justice-path posture should not be forced into REVIEW_REQUIRED by the mandatory human-review gate alone');

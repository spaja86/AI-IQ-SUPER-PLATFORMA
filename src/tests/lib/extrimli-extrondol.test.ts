...
async function runTests(): Promise<void> {
  ...
  await test('report includes bounded orchestration score and degraded policy', () => {
    ...
    assert(releaseAuditMaticneCelijeSupplemental?.visualReference.includes('908ab1a4-5a00-4f93-971a-2cd8e331119d'), 'developer/create release audit MATIČNE ĆELIJE supplemental visual reference mismatch');
    ...
    assert(
      report.releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.roadmapExecution.acceptanceEvidence.join(',') ===
        'developerAndCreateRepoWideReflection,releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance,releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.covecnostAuditVisualReference.supplementalVisualReferences,releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.covecnostAuditVisualReference.companionAuditVisualReferences,releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.aiPlateGovernance,spajaKod.publicSignals.developerAndCreateStatus,spajaKod.publicSignals.aiPlateStatus',
    ...
    assert(spajaKodMaticneCelijeSupplemental?.visualReference.includes('908ab1a4-5a00-4f93-971a-2cd8e331119d'), 'SPAJA KOD developer/create MATIČNE ĆELIJE supplemental visual reference mismatch');

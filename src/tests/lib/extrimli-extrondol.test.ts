...
async function runTests(): Promise<void> {
  ...
  await test('report maps RADNI TAKT MOZGA (MISLILAC) into WAWE governance, audit summary, downstream sync, and SPAJA KOD epilog', () => {
    ...
    assert(report.releaseAuditSummary.radniTaktMozgaMislilacGovernance.epilogijaCovecnosti.visualReference.includes('e7fe3fd0-5dae-4ba9-8e96-939eb6fd5565'), 'radni takt audit epilog visual reference mismatch');
    ...
    assert(report.spajaKod.epilogijaCovecnosti.visualReference.includes('e7fe3fd0-5dae-4ba9-8e96-939eb6fd5565'), 'SPAJA KOD epilog visual reference mismatch');

...
async function runTests(): Promise<void> {
  ...
  await test('report includes bounded orchestration score and degraded policy', () => {
    ...
    assert(report.releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.covecnostAuditVisualReference.supplementalVisualReferences.length === 1, 'developer/create release audit supplemental visual count mismatch');
    ...
    assert(report.releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.roadmapExecution.acceptanceEvidence.join(',') === 'developerAndCreateRepoWideReflection,releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance,releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.covecnostAuditVisualReference.supplementalVisualReferences,spajaKod.publicSignals.developerAndCreateStatus', 'developer/create release audit acceptance evidence mismatch');

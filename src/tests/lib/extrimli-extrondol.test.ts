...
async function runTests(): Promise<void> {
  ...
  await test('report includes bounded orchestration score and degraded policy', () => {
    ...
    assert(report.releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.covecnostAuditVisualReference.supplementalVisualReferences[1].canonicalNarrativeId === 'covecanstvo-entizujazam-zvezde-misli-inovacije-developer-create', 'developer/create release audit ENTIZUJAŽAM supplemental narrative id mismatch');
    assert(report.releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.covecnostAuditVisualReference.supplementalVisualReferences[1].visualReference.includes('f7b3e102-e0a0-4885-a93e-040f09454737'), 'developer/create release audit ENTIZUJAŽAM supplemental visual reference mismatch');
    assert(report.releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.covecnostAuditVisualReference.supplementalVisualReferences[1].imageToSignalProfile.signalOutputs.readinessStatus === report.releaseAuditSummary.developerAndCreateRepoWideReflectionGovernance.status, 'developer/create release audit ENTIZUJAŽAM supplemental readiness status mismatch');
    ...
    assert(report.spajaKod.developerAndCreateVisualReflection.supplementalVisualReferences[1].visualReference.includes('f7b3e102-e0a0-4885-a93e-040f09454737'), 'SPAJA KOD developer/create ENTIZUJAŽAM supplemental visual reference mismatch');

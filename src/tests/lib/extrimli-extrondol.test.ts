...
async function runTests(): Promise<void> {
  ...
  await test('DOK/DIK/DAK/DUK/FOR consistency health stays deterministic across technical and governance layers', () => {
    ...
    assert(report.developerAndCreateRepoWideReflection.inspektori.justicePath.reviewPosture === 'ALIGNED', 'developer/create INSPEKTORI justice-path posture should stay aligned when technical signals are healthy');

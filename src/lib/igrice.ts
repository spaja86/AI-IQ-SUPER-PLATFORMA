...
export const igrice: Igrica[] = [
  ...
  // ─── Horizont 2 Gaming Ekspanzija ─────────────────────────────────────────
  {
    id: 'igrica-kvantni-lavirint',
    naziv: 'KVANTNI LAVIRINT',
    opis: 'Lavirint koji postoji u kvantnoj superponiranoj formi — više putanja simultano, igrač kolapsira realnost izborom. U višim dimenzijama lavirint se grana na eksponencijalan broj kvantnih stanja. Svaka dimenzija (D) dodaje novi sloj kvantnih odluka.',
    ikona: '⚛️',
    kategorija: 'logicka',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '720D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'Kvantna superponiranost putanja — više rešenja simultano',
      'Kolaps talasne funkcije izborom igrača',
      'Heisenbergova nesigurnost: pozicija ili brzina, ne oba',
      'Entanglement parovi soba — promena jedne menja drugu',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-game-engine', 'omega-ai-engine', 'spaja-quantum-renderer'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-svemirski-osvajac',
    naziv: 'SVEMIRSKI OSVAJAČ',
    opis: 'Civilizacijska strategija osvajanja galaksije. Izgradnja flote, kolonizacija planeta, diplomatija sa vanzemaljskim rasama. U višim dimenzijama galaksija se proširuje u 4D+ prostor sa hiperboličkim svemirskim rutama.',
    ikona: '🚀',
    kategorija: 'strategija',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '1440D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'Civilizacijska izgradnja — flota, kolonije, tehnologije',
      '50+ planeta za kolonizaciju sa jedinstvenim resursima',
      '10 vanzemaljskih rasa sa diplomacijom i ratom',
      'Warp drive i hiperbolički svemir u 1440D+',
      'Multiplayer galaktičke bitke do 8 igrača',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-multiplayer-server', 'spaja-game-engine', 'spaja-ai-npc', 'spaja-procedural-gen'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-metaversum-builder',
    naziv: 'METAVERSUM BUILDER',
    opis: 'Izgradnja sopstvenog metaversum sveta — dizajniraj, gradi, monetizuj. NFT integracija za digitalne predmete i prostor. U višim dimenzijama prostor se proširuje u beskonačne holografske slojeve.',
    ikona: '🌐',
    kategorija: 'avantura',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '1440D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'Drag-and-drop gradnja virtuelnog sveta',
      'NFT mint direktno iz igrice za digitalne predmete',
      'Ekonomija sa sopstvenom valutom i tržištem',
      'Import 3D modela i muzike',
      'Holografski prikaz u 2880D+',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-game-engine', 'spaja-nft-engine', 'spaja-3d-renderer', 'spaja-ekonomija-engine'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-ai-chess-master',
    naziv: 'AI CHESS MASTER',
    opis: 'Šah naredne generacije — OMEGA AI protivnik sa 21 persona koji igra na nivou svetskog šampiona. U višim dimenzijama tabla se proširuje na 12×12 i 16×16, sa novim figurama po dimenziji.',
    ikona: '♟️',
    kategorija: 'logicka',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '360D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'OMEGA AI protivnik — svih 21 persona kao protivničke strategije',
      '360D: 8×8 klasičan šah',
      '720D: 10×10 sa 4 nove figure',
      '1440D: 12×12 Dimenzionalni Šah',
      '2880D: 14×14 sa dimenzionalnim prolazima',
      '5760D: 16×16 Holografski Šah',
      'Analiza poteza pomoću SpajaPro AI',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['omega-ai-engine', 'spaja-game-engine'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-nft-fighter',
    naziv: 'NFT FIGHTER',
    opis: 'Boraci su NFT-ovi — igrač poseduje svog borca na blockchain-u. Pobedama osvaja nove NFT predmete i sposobnosti. U višim dimenzijama borbe se odvijaju u 3D+ prostoru sa fizikalnim simulacijama.',
    ikona: '🥊',
    kategorija: 'borbena',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '720D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'Borca poseduje igrač kao NFT — potpuno vlasništvo',
      'Zarada NFT nagrada pobedom u turnirima',
      'P2P borbe i globalni turniri sa nagradnim fondom',
      '100+ boraca sa unique sposobnostima',
      '3D fizikalna simulacija u 1440D+',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-nft-engine', 'spaja-game-engine', 'spaja-blockchain-engine', 'spaja-multiplayer-server'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-crypto-tycoon',
    naziv: 'CRYPTO TYCOON',
    opis: 'Ekonomska simulacija kripto tržišta — izgradnja crypto berze, mining farme, DeFi protokola. AI simulira realna tržišna kretanja. U višim dimenzijama tržište se proširuje na multi-chain ekonomiju.',
    ikona: '💰',
    kategorija: 'strategija',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '720D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'Izgradnja kripto berze sa realnim prometom',
      'Mining farme — GPU i ASIC optimizacija',
      'DeFi protokoli — yield farming, liquidity pools',
      'AI simulacija tržišnih ciklusa (bull/bear/crab)',
      'Multi-chain ekonomija u 1440D+',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-ekonomija-engine', 'spaja-game-engine', 'omega-ai-engine'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-esports-manager',
    naziv: 'ESPORTS MANAGER',
    opis: 'Menadžer esports tima — skupljaj igrače, trenirај ih, učestvuj u globalnim turnirima. AI simulira protivničke timove. U višim dimenzijama upravljaš multi-game organizacijom.',
    ikona: '🎮',
    kategorija: 'strategija',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '360D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      '100+ igrača sa unique statistikama i ličnošću',
      'Trening sistem za razvoj sposobnosti',
      'Globalni turniri sa realnim nagradnim fondovima',
      'Sponzorstvo, mediji, fanbase upravljanje',
      'Multi-game organizacija u 1440D+',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-game-engine', 'spaja-ai-npc', 'omega-ai-engine'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-dimenzionalni-vozac',
    naziv: 'DIMENZIONALNI VOZAČ',
    opis: 'Trke kroz portale između dimenzija — staza prelazi iz 360D u 720D, 1440D u toku iste trke. Svaki portal menja fiziku i pravila. Vozila se prilagođavaju aktivnoj dimenziji.',
    ikona: '🏁',
    kategorija: 'akcija',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '720D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'Portali između dimenzija usred trke',
      'Fizika se menja po dimenziji (gravitacija, trenje, aerodinamika)',
      'Vozila sa dimenzionalnim modifikacijama',
      '30 staza × 5 dimenzija = 150 jedinstvenih iskustava',
      'Multiplayer trke do 12 igrača',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-physics-engine', 'spaja-game-engine', 'spaja-shader-compiler', 'spaja-multiplayer-server'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-ai-dungeon-omega',
    naziv: 'AI DUNGEON OMEGA',
    opis: 'Beskrajno generisana RPG avantura — SpajaPro AI kreira unique priče, likove i svetove za svakog igrača. Svaka sesija je potpuno drugačija. U višim dimenzijama priče se granaju u paralelne realnosti.',
    ikona: '🏰',
    kategorija: 'avantura',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '720D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'SpajaPro 13 AI kreira beskonačno unique priče',
      'Svaki NPC ima ličnost i pamćenje konteksta',
      'Grananje narativa na osnovu odluka igrača',
      '∞ generisanih tamnica i bossova',
      'Paralelne realnosti priče u 2880D+',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-ai-gen-engine', 'omega-ai-engine', 'spaja-game-engine'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-globalna-dominacija',
    naziv: 'GLOBALNA DOMINACIJA',
    opis: 'Geopolitička strategija — kontroliši nacije, ekonomije, armije i tehnologiju da osvoji svet. AI simulira realne geopolitičke dinamike. U višim dimenzijama svet se proširuje na svemirske kolonije.',
    ikona: '🌍',
    kategorija: 'strategija',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '1440D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      '195 nacija sa realnim resursima i politikama',
      'Ekonomska, vojna, tehnološka i diplomatska moć',
      'AI geopolitičke dinamike — savezi, ratovi, trgovina',
      'Nuklearno oružje, cyber ratovanje, svemirska trka',
      'Svemirske kolonije u 2880D+',
      'Multiplayer do 10 igrača',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['omega-ai-engine', 'spaja-game-engine', 'spaja-multiplayer-server', 'spaja-procedural-gen'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-muzicki-vizionar',
    naziv: 'MUZIČKI VIZIONAR',
    opis: 'Ritam i kreativna muzička igrica — SpajaPro AI generiše muziku u realnom vremenu na osnovu igračevog stila. Igrač kreira, miksuje i performuje. U višim dimenzijama muzika postaje holografska svetlosna umetnost.',
    ikona: '🎵',
    kategorija: 'akcija',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '720D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'AI kompozitor — SpajaPro 9 generiše muziku u realnom vremenu',
      'Beat matching i ritam izazovi',
      'Studio za miksovanje sa virtualnim instrumentima',
      'Globalni muzički turniri',
      'Holografska svetlosna umetnost u 2880D+',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-audio-engine', 'spaja-game-engine', 'omega-ai-engine', 'spaja-shader-compiler'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-nano-graditelj',
    naziv: 'NANO GRADITELJ',
    opis: 'Gradnja na nano-skali — dizajniraš molekule, nano-robote i materijale budućnosti. Naučna tačnost uz zabavnu mehaniku. U višim dimenzijama nano-konstrukcije postaju kvantne strukture.',
    ikona: '🔬',
    kategorija: 'logicka',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '720D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'Naučno tačna simulacija nano-struktura',
      '500+ hemijskih elemenata i veza',
      'Dizajn nano-robota sa realnom fizikom',
      'SpajaPro AI validacija naučne tačnosti',
      'Kvantne strukture u 2880D+',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-physics-engine', 'spaja-game-engine', 'omega-ai-engine'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-telepat-dvoboj',
    naziv: 'TELEPAT DVOBOJ',
    opis: 'PvP igrica zasnovana na čitanju protivnikovog pokreta — AI analizira obrasce i predviđa sledeći potez. Dvoboj uma, ne refleksa. U višim dimenzijama igrači imaju pristup paralelnim strategijama.',
    ikona: '🧠',
    kategorija: 'borbena',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '720D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'AI čita obrazce igračevih odluka i predviđa sledeći potez',
      'Dvoboj psihologije — blef, kontra-blef, meta-igra',
      'Tournamenet ladder sa ELO ratovanjem',
      'Replay analiza sa SpajaPro AI komentarom',
      'Paralelne strategije u 2880D+',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['omega-ai-engine', 'spaja-game-engine', 'spaja-multiplayer-server'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-biotech-lab',
    naziv: 'BIOTECH LAB',
    opis: 'Simulacija biotehnološke laboratorije — dizajniraj genome, leči bolesti, kreira nove organizme. SpajaPro AI validira biološku tačnost. U višim dimenzijama rada sa 4D proteinskim strukturama.',
    ikona: '🧬',
    kategorija: 'logicka',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '1440D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'CRISPR gen-editing simulator',
      '1000+ gena i proteinskih struktura',
      'Lečenje virtualnih bolesti razvijanjem lekova',
      'SpajaPro 8 AI validacija biohemijske tačnosti',
      '4D proteinske strukture u 1440D+',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-physics-engine', 'omega-ai-engine', 'spaja-3d-renderer'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-omega-survival',
    naziv: 'OMEGA SURVIVAL',
    opis: 'Preživljavanje u post-apokaliptičnom svetu sa AI protivnicima i dinamičkim ekosistemom. Svaka sesija generiše unique okruženje. U višim dimenzijama svet se širi na paralelne apokalipse.',
    ikona: '☢️',
    kategorija: 'avantura',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '720D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'Proceduralno generisan svet pri svakom startovanju',
      'Dinamički ekosistem — AI fauna i flora evoluira',
      'Izgradnja baze, zanatlstvo, istraživanje',
      'Multiplayer kooperativno preživljavanje do 4 igrača',
      'Paralelne apokalipse u 2880D+',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-procedural-gen', 'spaja-ai-npc', 'spaja-game-engine', 'spaja-multiplayer-server'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-finansijski-titan',
    naziv: 'FINANSIJSKI TITAN',
    opis: 'Postani finansijski titan — trading, M&A, IPO, venture capital, real estate, kripto. AI simulira realna globalna tržišta sa historijskim ciklusima i crnim labudovima.',
    ikona: '📊',
    kategorija: 'strategija',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '720D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'Real-time simulacija globalnih finansijskih tržišta',
      'Trading akcijama, kripto, forex, robom',
      'M&A, IPO, venture capital odluke',
      'Crni labud eventi — market crash, regulatory shock',
      'ESG investiranje sa uticajem na reputaciju',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['omega-ai-engine', 'spaja-ekonomija-engine', 'spaja-game-engine'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-smart-city-architect',
    naziv: 'SMART CITY ARCHITECT',
    opis: 'Izgradnja grada budućnosti — AI optimizuje saobraćaj, energiju, zdravstvo, obrazovanje. Integriše IoT, 5G, autonomous vehicles. U višim dimenzijama grad se proširuje na podvodne i svemirske zone.',
    ikona: '🏙️',
    kategorija: 'strategija',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '1440D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'AI upravljanje saobraćajem, energijom, otpadom',
      'IoT senzori, 5G mreža, autonomous vehicles',
      'Zadovoljstvo građana i ekološki otisak',
      'Katastrofalni eventi — zemljotresi, energetske krize',
      'Podvodni i svemirski gradski prošireci u 2880D+',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-procedural-gen', 'omega-ai-engine', 'spaja-game-engine', 'spaja-ekonomija-engine'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-vremenski-ratnik',
    naziv: 'VREMENSKI RATNIK',
    opis: 'Borbena igrica kroz vremenska razdoblja — od praistorije do daleke budućnosti. Svaki period ima unique oružja, fiziku i taktike. Dimenzije određuju pristupačnost vremenskih perioda.',
    ikona: '⚔️',
    kategorija: 'borbena',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '720D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      '20 vremenskih perioda — praistorija, antika, srednji vek, budućnost',
      'Unique oružja i taktike po periodu',
      'Kombosistemi koji se menjaju kroz vreme',
      'Boss borbe sa čuvarima vremenske linije',
      'Cross-period borbe u 2880D+',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-game-engine', 'spaja-physics-engine', 'spaja-shader-compiler', 'spaja-ai-npc'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-kosmicki-rudari',
    naziv: 'KOSMIČKI RUDARI',
    opis: 'Rudarenje asteroida i planeta u beskonačnom svemiru. Izgradnja svemirske baze, prodaja resursa, tržišna ekonomija. U višim dimenzijama rudaraš u 4D+ prostoru sa egzotičnom materijom.',
    ikona: '⛏️',
    kategorija: 'avantura',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '1440D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      '1000+ asteroida i planeta sa različitim resursima',
      'Svemirska baza — izgradnja, nadgradnja, odbrana',
      'Tržišna ekonomija resursa sa AI dinamičnim cenama',
      'Kooperativno rudarenje do 6 igrača',
      'Egzotična 4D materija u 2880D+',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-game-engine', 'spaja-procedural-gen', 'spaja-ekonomija-engine', 'spaja-multiplayer-server'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-omega-jackpot',
    naziv: 'OMEGA JACKPOT',
    opis: 'Dimenzionalna jackpot igrica sa garantovanim isplatama. Svaka dimenzija donosi veće šanse i nagrade. SpajaPro AI garantuje fer slučajnost i transparentnost. AIIQ-Coin integracija.',
    ikona: '🎰',
    kategorija: 'akcija',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '360D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'Provably fair RNG — blockchain verificiran',
      'AIIQ-Coin integracija za nagrade',
      'Progressive jackpot koji raste sa dimenzijom',
      'Transparentna RTP matrica po dimenziji',
      'VIP sistem sa dimenzionalnim bonusima',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',

...
export const igrice: Igrica[] = [
  ...
  {
    id: 'igrica-dotamaster',
    naziv: 'DOTAMASTER',
    opis: 'Ekstremno napredna master MOBA igrica — evoluirani naslednik Dota 1350. Igrači prolaze kroz master rang sistem (Bronze → Silver → Gold → Platinum → Diamond → Master → GrandMaster → DOTAMASTER) kroz dimenzionalne arene. U 360D klasičan 5v5, u 5760D beskonačne dimenzionalne arene sa 1350+ heroja i inter-dimenzionalnim turnirima. DOTAMASTER titula se osvaja samo kroz vrhunsko dimenzionalno majstorstvo.',
    ikona: '🏆',
    kategorija: 'mmo',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '2880D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'Master rang sistem sa 8 nivoa (Bronze → DOTAMASTER)',
      '1350+ heroja sa dimenzionalnim skilovima',
      'Master turniri i liga sistema po dimenzijama',
      'Real-time kooperativni i kompetitivni mečevi',
      'DOTAMASTER titula za vrh leaderboard-a',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-game-engine', 'spaja-multiplayer-server', 'spaja-ai-npc', 'spaja-networking-sdk', 'spaja-anti-cheat', 'spaja-leaderboard'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  ...
  },
  {
    ...
    naziv: 'MASTER POKER',
    opis: 'MASTER POKER je SPAJA Texas Hold’em simulacija bez real-money klađenja. V1 je single-table iskustvo (igrač + bot protivnici) sa determinističkim rundama, auditable potezima i dimenzionalnim prikazom od 360D do 5760D unutar postojeće gaming platforme.',
    ikona: '🃏',
    kategorija: 'strategija',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '720D',
    ...
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-game-engine', 'spaja-ai-engine', 'spaja-anti-cheat', 'spaja-networking-sdk', 'spaja-leaderboard'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  ...
  {
    id: 'igrica-filmska-industrija',
    naziv: 'Filmska Industrija',
    opis: 'Simulacija kompletne filmske produkcije kroz dimenzije 360D–5760D. Upravljaš scenarijem, režijom, kamerom, montažom i distribucijom uz geometrijske slojeve i dimenzionalne zakone. Više dimenzije donose složenije setove, više kadrova i naprednije vizuelne efekte.',
    ikona: '🎬',
    kategorija: 'simulacija',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '1440D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'Produkcija filma kroz dimenzionalne faze',
      'Režija, kadar i montaža po dimenzijama',
      'VFX i render pipeline u višim dimenzijama',
      'Distribucija i bioskopski plasman kroz gejming industriju',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-game-engine', 'spaja-animation-engine', 'spaja-vr-ar-engine', 'omega-ai-engine'],
    zahtevi: OBAVEZNI_ZAHTEVI,
  },
  {
    id: 'igrica-biskop-sa-dimenzijama',
    naziv: 'Biskop sa Dimenzijama',
    opis: 'Strateška igrica fokusirana na figuru biskopa i dijagonalnu dominaciju kroz dimenzionalne table. U 360D pravila su klasična, dok u višim dimenzijama biskop prelazi između geometrijskih slojeva i koristi portale za taktičku prednost.',
    ikona: '♝',
    kategorija: 'strategija',
    podrzaneDimenzije: sveDimenzije,
    podrazumevanaDimenzija: '720D',
    dimenzionalniRezimi: kreirajDimenzionalneRezime(sveDimenzije),
    funkcije: [
      'Biskop-specifične strategije i dijagonalna kontrola',
      'Dimenzionalne table sa geometrijskim pravilima',
      'Portali između slojeva za taktičke manevre',
      'AI protivnik sa adaptivnim nivoima težine',
      'Pita dimenziju (D) prilikom pokretanja',
    ],
    status: 'aktivna',
    preporuceniProizvodi: ['spaja-game-engine', 'spaja-ai-engine', 'spaja-multiplayer-server', 'spaja-leaderboard'],

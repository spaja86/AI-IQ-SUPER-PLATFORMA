...
export const gejmingEntiteti: GejmingEntitet[] = [
...

  {
    ...
    tip: 'lik-igriv',
    kategorijaDizajna: 'fantazija',
    opis: 'Igrivi lik za MANKAY AND TIGER — okretni majmun majstor agilnosti. Oblačen u vitki majmunski oklop koji se prilagođava dimenziji. U 5760D zlatni repni spiral i hiperbolički skokovi između platformi čine ga gotovo neuhvatljivim protivnikom.',
    ikona: '🐒',
    igricaId: 'igrica-mankay-and-tiger',
    dimenzije: ['360D', '720D', '1440D', '2880D', '5760D'],
    status: 'aktivan',
    atributi: ['Agilnost: 97', 'Brzina: 95', 'Snaga: 60', 'Inteligencija: 88'],
    sposobnosti: ['Dimenzionalni skok', 'Bananin udar', 'Spiralno penjanje', 'MANKAY-TIGER fuzija'],
    vizuelniStil: 'Vitki majmunski oklop koji se prilagođava dimenziji, zlatni repni spiral u višim D',
    inspiracija: 'Arhetipski trickster lik — majmun trickster',
  },
  {
    id: 'entitet-tiger',
    naziv: 'TIGER',
    tip: 'lik-igriv',
    kategorijaDizajna: 'fantazija',
    opis: 'Drugi igrivi lik za MANKAY AND TIGER — razjareni tigar komandant sile. Nosi moćan tigrovski oklop sa živim prugama koje svetlucaju prema snazi dimenzije. U 5760D spiralni rep i hiperboličke erupcije čine ga najmoćnijim borbenim likom.',
    ikona: '🐯',
    igricaId: 'igrica-mankay-and-tiger',
    dimenzije: ['360D', '720D', '1440D', '2880D', '5760D'],
    status: 'aktivan',
    atributi: ['Snaga: 98', 'Napad: 96', 'Odbrana: 80', 'Brzina: 78'],
    sposobnosti: ['Tigrovski skok', 'Rezonantni urlik', 'Dimenzionalni napad', 'MANKAY-TIGER fuzija'],
    vizuelniStil: 'Moćan tigrovski oklop sa živim prugama koje svetlucaju prema dimenziji, spiralni rep u 5760D',
    inspiracija: 'Mitološki tigar sile i moći',
  },
  {
    id: 'entitet-okruzenje-dzungla-arena',
    naziv: 'Džungla Arena',
    tip: 'okruzenje',
    kategorijaDizajna: 'fantazija',
    opis: 'Dimenzionalna džungla arena za MANKAY AND TIGER. U 360D bazična borba između drveća, u 720D rezonantne liane i elipsoidne platforme, u 1440D spiralne staze između džungle i otvorenog prostora, u 5760D potpuna džungla sa hiperboličkim erupcijama vegetacije i particle efektima.',
    ikona: '🌿',
    igricaId: 'igrica-mankay-and-tiger',
    dimenzije: ['360D', '720D', '1440D', '2880D', '5760D'],
    status: 'aktivan',
    atributi: ['Geometrijski slojevi: 2–4', 'Vegetacija: dinamična', 'Platforme: dimenzionalne', 'Vidljivost: šumska'],
    sposobnosti: ['Dimenzionalno drveće', 'Rezonantne liane', 'Spiralni tuneli džungle', 'Hiperbolička erupcija'],
    vizuelniStil: 'Gusta džungla sa dimenzionalnim biljkama, zlatno-zelena paleta, spiralni efekti u višim D',
    inspiracija: 'Tropska džungla susreće dimenzionalni prostor',
  },
  {
    id: 'entitet-oruzje-primalna-saka',
    naziv: 'Primalna Šaka',
    tip: 'oruzje',
    kategorijaDizajna: 'fantazija',
    opis: 'Legendarno oružje MANKAY AND TIGER — primalna šaka koja kombinuje agilnost majmuna i snagu tigra u jednom udaru. Mankay je koristi za brze serije, TIGER za razorne udarce. U višim dimenzijama šaka se transformiše u spiralnu fuziju primalnih sila.',
    ikona: '🥊',
    igricaId: 'igrica-mankay-and-tiger',
    dimenzije: ['360D', '720D', '1440D', '2880D', '5760D'],
    status: 'aktivan',
    atributi: ['Brzina udarca: 90', 'Snaga udarca: 85', 'Fuziona šteta: 175', 'Dimenzionalni bonus: +42%'],
    sposobnosti: ['Brza serija udaraca', 'Razorni tigrovski udarac', 'MANKAY-TIGER fuzioni prasak', 'Dimenzionalni knock-out'],
    vizuelniStil: 'Rukavica od primalnog kristala sa majmunsko-tigarskim simbolima, spiralni efekti u višim D',
    inspiracija: 'Primalna sila životinjskog sveta fuzionisana u jedno oružje',
  },

  // ─── EKSTREMINACIJA EGLANA ────────────────────────────────────────
  {
    id: 'entitet-ratnik-svetlosti',
    naziv: 'Ratnik Svetlosti',
    tip: 'lik-igriv',
    kategorijaDizajna: 'fantazija',
    opis: 'Heroj 1 za EKSTREMINACIJU EGLANA — uravnoteženi borac sa štitom i mačem. Nosi sjajni oklop od kristalizovane svetlosti koji apsorbuje dimenzionalne napade. U višim dimenzijama oklop pulsira rezonantnim prstenevima i odbija projektile. Njegova Štitna Refleksija (Q) vraća Eglanove projektile nazad ka bossu.',
    ikona: '⚔️',
    igricaId: 'igrica-ekstreminacija-eglana',
    dimenzije: ['360D', '720D', '1440D', '2880D', '5760D'],
    status: 'aktivan',
    atributi: ['Napad: 75', 'Odbrana: 95', 'Brzina: 70', 'Izdržljivost: 90'],
    sposobnosti: ['Štitni odboj (Q) — reflektuje projektile', 'Mačevalački napad', 'Svetlosna eksplozija', 'Dimenzionalni štit'],
    vizuelniStil: 'Sjajni oklop od kristalizovane svetlosti sa rezonantnim prstenevima u višim D, zlatno-bijela paleta',
    inspiracija: 'Arhetipski ratnik svetlosti — odbrana i ravnoteža',
  },
  {
    id: 'entitet-senka-ubojica',
    naziv: 'Senka Ubojica',
    tip: 'lik-igriv',
    kategorijaDizajna: 'fantazija',
    opis: 'Heroj 2 za EKSTREMINACIJU EGLANA — brza agilna atentatorkinja, stakleni top. Nosi oklop od kondenzovane tame koji se stapa sa dimenzionalnom prazninom. U višim dimenzijama njena nevidljivost postaje savršena — nestaje iz Eglanovog vidnog polja na pun sekund. Njena Senka Nevidljivosti (Q) daje kratku neosetljivost i brzinu.',
    ikona: '🗡️',
    igricaId: 'igrica-ekstreminacija-eglana',
    dimenzije: ['360D', '720D', '1440D', '2880D', '5760D'],
    status: 'aktivan',
    atributi: ['Napad: 95', 'Odbrana: 55', 'Brzina: 98', 'Izdržljivost: 60'],
    sposobnosti: ['Senka Nevidljivosti (Q) — privremena neosetljivost', 'Brzi ubod', 'Spiralni niz udaraca', 'Dimenzionalni skok'],
    vizuelniStil: 'Oklop od kondenzovane tame, ljubičasto-crna paleta, spiralni efekti u višim D',
    inspiracija: 'Arhetipska seneška atentatorkinja — brzina i preciznost',
  },
  {
    id: 'entitet-eglan',
    naziv: 'EGLAN',
    tip: 'lik-npc',
    kategorijaDizajna: 'horror',
    opis: 'Krajnji boss EKSTREMINACIJE EGLANA — drevni dimenzionalni entitet koji proguta svetlost i realnost. Vizuelno: masivni tamni elipsoid okružen rotacionim rezonantnim prstenevima koji se gase u crnoj rupi. U 360D oslabljeni džin tame sa sporim projektilima; u 5760D potpuna dimenzionalna manifestacija sa 4 faze, dimenzionalnim minionima i razornim šok talasima.',
    ikona: '👁️',
    igricaId: 'igrica-ekstreminacija-eglana',
    dimenzije: ['360D', '720D', '1440D', '2880D', '5760D'],
    status: 'aktivan',
    atributi: ['HP: 360D=1000 / 5760D=5000', 'Faze napada: 4', 'Minioni: 0–8 po dimenziji', 'Šok val interval: 10s u berserk fazi'],
    sposobnosti: ['Navođeni projektili (Faza 1)', 'Dimenzionalni laser (Faza 2)', 'Spawn miniona (Faza 3)', 'Berserk šok val (Faza 4)'],
    vizuelniStil: 'Masivni tamni elipsoid sa rotacionim rezonantnim prstenevima, crno-ljubičasta paleta, pulsira prema HP',
    inspiracija: 'Arhetipski krajnji boss — drevni entitet tame i praznine',
  },
  {
    id: 'entitet-dimenzionalna-bezdan-arena',
    naziv: 'Dimenzionalna Bezdan Arena',
    tip: 'okruzenje',
    kategorijaDizajna: 'horror',
    opis: 'Dimenzionalna arena praznine za EKSTREMINACIJU EGLANA. U 360D tamna ravna platforma sa slabim hiperboličkim linijama na podlozi; u 720D rezonantni prsteni se pojavljuju oko arene; u 1440D spiralne staze praznine uvijaju ivice; u 5760D potpuna void arena sa partikulama tame i hiperboličkim erupcijama praznine.',
    ikona: '🕳️',
    igricaId: 'igrica-ekstreminacija-eglana',
    dimenzije: ['360D', '720D', '1440D', '2880D', '5760D'],
    status: 'aktivan',
    atributi: ['Geometrijski slojevi: 2–4', 'Void partikule: dinamične', 'Rezonantni prsteni: dimenzionalni', 'Vidljivost: tamna'],
    sposobnosti: ['Dimenzionalni void pozadinа', 'Rezonantni prsteni arene', 'Spiralne staze praznine', 'Hiperbolička erupcija void-a'],
    vizuelniStil: 'Tamna void arena sa crno-ljubičastom paletom, hiperboličke linije na podlozi, prsteni praznine u višim D',
    inspiracija: 'Praznina između dimenzija — mesto gde EGLAN čeka',
  },
];

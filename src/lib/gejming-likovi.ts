...
export const gejmingEntiteti: GejmingEntitet[] = [
  ...
  },
  {
    ...
    dimenzije: ['360D', '720D', '1440D'],
    status: 'aktivan',
    atributi: ['Mudrост: 100', 'Strpljenje: 100', 'Znanje: 100'],
  ...
  },
  {
    ...
    opis: 'Visoko-performansni sportski kostim za spiralne trke. Aerodnamičan dizajn sa integrisanim SPAJA senzorima za reakcijsko vreme.',
    ikona: '👔',
    igricaId: 'igrica-spiralni-trke',
    dimenzije: ['360D', '720D', '1440D'],
    status: 'aktivan',

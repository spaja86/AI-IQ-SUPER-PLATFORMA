...
export const omegaAiSuportSekvence: Sekvenca[] = [
  {
    ...
    podnaslov:
      '21 persona sa direktnim telefonskim linijama, mejl adresama i dispeč sistemom za korisnike — 24/7/365 pokrivenost',
    ikona: '📞',
    redosled: 1,
    podaci: {
      opis: 'Maksimalni suport na OMEGA nivou: svaka od 21 persona ima direktnu telefonsku liniju, mejl za dopisivanje i dispeč za tikete sa SLA garancijama.',
      dugmad: [
      ...
      kartice: [
        {
          ...
          opis: 'Direktne telefonske linije za svaku od 21 OMEGA AI persona sa IVR navigacijom',
          ikona: '📞',

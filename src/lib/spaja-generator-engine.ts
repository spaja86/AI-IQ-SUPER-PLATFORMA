...
export const generisaniEngini: GenerisaniEngine[] = [
...

  {
    ...
    opis: 'SPAJA Univerzalni Endžin prevučen preko svih 95 igrica na IO/OPENUI/AO platformi (io-openui-ao.vercel.app). Dimenzionalno renderovanje 360D-5760D, SpajaPro 6-15 integracija, OMEGA AI podrška, Proksi mrežna optimizacija. Link: https://chatgpt.com/c/688e73aa-ecf8-8006-a7bd-b7d796498ae7',
    ikona: '🎮',
    tip: 'gaming',
    status: 'aktivan',
    verzija: '1.0.0',
  ...
  {
    id: 'engine-spajapro-13-evolucija',
    naziv: 'SpajaPro 13 Evolucija Engine',
    opis: 'Genetski algoritmi i samo-evolucija promptova — engine koji se unapređuje kroz svaku sesiju. Meta-prompt generisanje, autonomno učenje iz feedbacka.',
    ikona: '🧬',
    tip: 'ai',
    status: 'aktivan',
    verzija: '13.0.0',
    ciljniModul: 'src/lib/spaja-pro-13-evolucija.ts',
    mogucnosti: ['Genetski algoritmi', 'Samo-evolucija promptova', 'Meta-prompt generisanje', 'Fitness evaluacija', 'Autonomno učenje', 'Prompt verzionisanje', '256K kontekst'],
    generisanDatum: '2026-07-26',
    optimizacija: 95,
  },
  {
    id: 'engine-spajapro-14-matriks',
    naziv: 'SpajaPro 14 Matriks Engine',
    opis: '8×8 neurološka matrica — 64 čvora, simultana orkestracija svih OMEGA AI persona, sinaptički transfer, cross-persona dispatch.',
    ikona: '🧮',
    tip: 'ai',
    status: 'generisanje',
    verzija: '14.0.0',
    ciljniModul: 'src/lib/spaja-pro-matriks.ts',
    mogucnosti: ['8×8 Matrica (64 čvora)', 'Sinaptički transfer', 'Ekscitatorni/inhibitorni/modulatorni signali', 'Klaster dispatch', 'Cross-persona orkestracija', '512K kontekst'],
    generisanDatum: '2026-07-26',
    optimizacija: 80,
  },
  {
    id: 'engine-spajapro-15-omega-universal',
    naziv: 'SpajaPro 15 Omega Universal Engine',
    opis: 'Ultimativni boss engine — superponira sve SpajaPro v6–v14 simultano. Kvazi-kvantni procesor, holografski interfejs, 1M token kontekst, 196+ jezika.',
    ikona: '🌟',
    tip: 'ai',
    status: 'planiran',
    verzija: '15.0.0',
    ciljniModul: 'src/lib/spaja-pro-omega-universal.ts',
    mogucnosti: ['Superponiranje v6–v14', 'Kvantni procesor', 'Holografski interfejs (2D/3D/AR/VR/XR/Holo)', 'Telepatska sinhronizacija', '196+ jezika', '1M token kontekst'],
    generisanDatum: '2026-07-26',
    optimizacija: 50,
  },
  {
    id: 'engine-ai-trading',
    naziv: 'AI Trading Engine',
    opis: 'Algoritamski trading engine — 10+ strategija, multi-exchange (crypto/forex/akcije/DeFi), SpajaPro AI predikcije, ESG scoring.',
    ikona: '📈',
    tip: 'finansije',
    status: 'aktivan',
    verzija: '1.0.0',
    ciljniModul: 'src/lib/ai-trading-engine.ts',
    mogucnosti: ['10+ trading strategija', 'Crypto/Forex/Akcije/DeFi/Roba', 'AI sentiment analiza', 'ESG investiranje', 'Risk management', 'Backtest engine', 'Multi-exchange'],
    generisanDatum: '2026-07-26',
    optimizacija: 90,
  },
  {
    id: 'engine-omega-ai-ekspanzija',
    naziv: 'OMEGA AI Ekspanzija Engine (Oktave 9–12)',
    opis: 'Proširenje OMEGA AI sa 21 na 33 persona u 12 oktava — Metaversum, Kvantno, Svemirsko, Beskonačno.',
    ikona: '♾️',
    tip: 'ai',
    status: 'aktivan',
    verzija: '2.0.0',
    ciljniModul: 'src/lib/omega-ai.ts',
    mogucnosti: ['12 novih persona', '4 nove oktave (9–12)', 'Metaversum Arhitekta', 'Kvantni Arhitekta', 'Svemirski Pilot', 'Beskonačni Evolver', 'Omega Svest', 'Civilizacijski Arhitekta'],
    generisanDatum: '2026-07-26',
    optimizacija: 100,
  },
  {
    id: 'engine-gaming-ekspanzija',
    naziv: 'Gaming Ekspanzija Engine (20 Novih Igara)',
    opis: 'Horizont 2 gaming ekspanzija — 20 novih igara: kvantna, svemirska, metaversum, esports, NFT, finansijska i civilizacijska tematika.',
    ikona: '🎮',
    tip: 'gaming',
    status: 'aktivan',
    verzija: '2.0.0',
    ciljniModul: 'src/lib/igrice.ts',
    mogucnosti: ['Kvantni Lavirint', 'Svemirski Osvajač', 'Metaversum Builder', 'NFT Fighter', 'Crypto Tycoon', 'AI Dungeon Omega', 'Smart City Architect', 'Omega Jackpot', '20 novih igara ukupno'],
    generisanDatum: '2026-07-26',
    optimizacija: 100,
  },
];

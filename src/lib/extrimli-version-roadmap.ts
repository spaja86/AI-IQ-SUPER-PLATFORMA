...
const EXTRIMLI_VERSION_ROADMAP: ExtrimliVersionRoadmap = {
  ...
  versions: [
    ...
    },
    {
      ...
      status: 'PLANNED',
      summary: 'Locks V2 as the additive-only canonical mapping layer that standardizes readiness, degraded, audit, downstream sync, and VRH terminology between core EXTRIMLI and higher governance surfaces.',
    ...
    },
    {
      ...
      summary: 'Expands v3 as the advanced readiness layer with additive EXTREM profiling for exponential progression, octaval topology, sequential reproduction, exposure, torque, and stable aggregate inputs.',
    ...
    },
    {
      ...
      status: 'ACTIVE-EXPANSION',
      summary: 'Makes EXTREM the mandatory profiler and freeze gate with deterministic READY | WATCH | BLOCKED governance for conflict intensity, optimization tier, resolution readiness, VRH fallback hardening, browser bottleneck audit, and additive epic elikvadenti uplift readiness.',
    ...
    },
    {
      ...
      focusArea: 'release',
      status: 'ACTIVE-EXPANSION',
      summary: 'Makes EXTRONDOL the primary WAWE orchestration surface for release audit, VRH downstream summary propagation, payment/compliance gates, rollback-aware rollout decisions, and epic elikvadenti review/freeze propagation.',

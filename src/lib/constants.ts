...
export const APP_VERSION = '46.90.0';
...
export const TOTAL_API_ROUTES = 1044;
export const TOTAL_ROUTES = 1103;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2356;

// Autofinish
export const AUTOFINISH_COUNT = 1191;

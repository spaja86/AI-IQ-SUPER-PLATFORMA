...
export const APP_VERSION = '46.61.0';
...
export const TOTAL_API_ROUTES = 1006;
export const TOTAL_ROUTES = 1065;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2280;

// Autofinish
export const AUTOFINISH_COUNT = 1161;

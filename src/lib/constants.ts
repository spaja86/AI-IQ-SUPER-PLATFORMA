...
export const APP_VERSION = '39.4.0';
...
export const TOTAL_API_ROUTES = 627;
export const TOTAL_ROUTES = 684;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 839;

// Autofinish
export const AUTOFINISH_COUNT = 426;

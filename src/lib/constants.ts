...
export const APP_VERSION = '46.20.0';
...
export const TOTAL_API_ROUTES = 972;
export const TOTAL_ROUTES = 999;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2182;

// Autofinish
export const AUTOFINISH_COUNT = 1099;

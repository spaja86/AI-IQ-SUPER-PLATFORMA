...
export const APP_VERSION = '46.27.0';
...
export const TOTAL_API_ROUTES = 973;
export const TOTAL_ROUTES = 1000;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2196;

// Autofinish
export const AUTOFINISH_COUNT = 1106;

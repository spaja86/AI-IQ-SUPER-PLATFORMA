...
// Ekosistem
export const TOTAL_PAGES = 31;
export const TOTAL_API_ROUTES = 335;
export const TOTAL_ROUTES = 371;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 352;

// Autofinish
export const AUTOFINISH_COUNT = 180;

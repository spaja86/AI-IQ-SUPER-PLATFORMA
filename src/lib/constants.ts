...
export const APP_VERSION = '39.7.0';
...
export const TOTAL_API_ROUTES = 642;
export const TOTAL_ROUTES = 699;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 869;

// Autofinish
export const AUTOFINISH_COUNT = 441;

...
export const APP_VERSION = '32.5.0';
...
export const TOTAL_API_ROUTES = 273;
export const TOTAL_ROUTES = 306;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 286;

// Autofinish
export const AUTOFINISH_COUNT = 155;

...
export const APP_VERSION = '41.8.0';
...
export const TOTAL_API_ROUTES = 747;
export const TOTAL_ROUTES = 804;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1079;

// Autofinish
export const AUTOFINISH_COUNT = 546;

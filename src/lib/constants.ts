...
export const APP_VERSION = '41.7.0';
...
export const TOTAL_API_ROUTES = 742;
export const TOTAL_ROUTES = 799;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1069;

// Autofinish
export const AUTOFINISH_COUNT = 541;

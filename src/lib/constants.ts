...
export const APP_VERSION = '42.34.0';
...
export const TOTAL_API_ROUTES = 919;
export const TOTAL_ROUTES = 973;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1400;

// Autofinish
export const AUTOFINISH_COUNT = 711;

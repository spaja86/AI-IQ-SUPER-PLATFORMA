...
// Ekosistem
export const TOTAL_PAGES = 38;
export const TOTAL_API_ROUTES = 383;
export const TOTAL_ROUTES = 424;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 434;

// Autofinish
export const AUTOFINISH_COUNT = 186;

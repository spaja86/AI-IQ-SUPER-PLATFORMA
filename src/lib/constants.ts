...
export const APP_VERSION = '42.21.0';
...
export const TOTAL_API_ROUTES = 862;
export const TOTAL_ROUTES = 919;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1309;

// Autofinish
export const AUTOFINISH_COUNT = 661;

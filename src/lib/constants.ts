...
export const APP_VERSION = '38.1.0';
...
export const TOTAL_API_ROUTES = 592;
export const TOTAL_ROUTES = 649;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 667;

// Autofinish
export const AUTOFINISH_COUNT = 363;

...
export const APP_VERSION = '40.3.0';
...
export const TOTAL_API_ROUTES = 672;
export const TOTAL_ROUTES = 729;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 929;

// Autofinish
export const AUTOFINISH_COUNT = 471;

...
export const APP_VERSION = '46.63.0';
...
export const TOTAL_API_ROUTES = 1008;
export const TOTAL_ROUTES = 1067;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2284;

// Autofinish
export const AUTOFINISH_COUNT = 1163;

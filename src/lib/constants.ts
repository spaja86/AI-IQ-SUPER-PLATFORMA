...
export const APP_VERSION = '42.5.0';
...
export const TOTAL_API_ROUTES = 782;
export const TOTAL_ROUTES = 839;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1149;

// Autofinish
export const AUTOFINISH_COUNT = 581;

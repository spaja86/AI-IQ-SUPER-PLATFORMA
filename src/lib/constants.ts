...
export const APP_VERSION = '42.4.0';
...
export const TOTAL_API_ROUTES = 777;
export const TOTAL_ROUTES = 834;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1139;

// Autofinish
export const AUTOFINISH_COUNT = 576;

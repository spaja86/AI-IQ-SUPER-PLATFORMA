...
export const APP_VERSION = '42.7.0';
...
export const TOTAL_API_ROUTES = 792;
export const TOTAL_ROUTES = 849;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1169;

// Autofinish
export const AUTOFINISH_COUNT = 591;

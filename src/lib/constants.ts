...
export const APP_VERSION = '46.76.0';
...
export const TOTAL_API_ROUTES = 1028;
export const TOTAL_ROUTES = 1087;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2326;

// Autofinish
export const AUTOFINISH_COUNT = 1176;

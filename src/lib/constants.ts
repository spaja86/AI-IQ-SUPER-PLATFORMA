...
export const APP_VERSION = '46.55.0';
...
export const TOTAL_API_ROUTES = 1000;
export const TOTAL_ROUTES = 1059;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2268;

// Autofinish
export const AUTOFINISH_COUNT = 1155;

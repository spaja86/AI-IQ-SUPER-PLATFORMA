...
export const APP_VERSION = '37.5.0';
...
export const OMEGA_AI_INSTANCI = 40_000_000;

// Ekosistem
export const TOTAL_PAGES = 29;
export const TOTAL_API_ROUTES = 309;
export const TOTAL_ROUTES = 339;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 322;

// Autofinish
export const AUTOFINISH_COUNT = 165;

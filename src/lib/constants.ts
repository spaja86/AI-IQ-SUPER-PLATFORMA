...
export const APP_VERSION = '46.70.0';
...
export const TOTAL_API_ROUTES = 1015;
export const TOTAL_ROUTES = 1074;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2298;

// Autofinish
export const AUTOFINISH_COUNT = 1170;

...
export const APP_VERSION = '42.30.0';
...
export const TOTAL_API_ROUTES = 902;
export const TOTAL_ROUTES = 960;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1395;

// Autofinish
export const AUTOFINISH_COUNT = 705;

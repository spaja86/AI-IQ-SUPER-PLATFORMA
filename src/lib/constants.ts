...
export const APP_VERSION = '46.85.0';
...
export const TOTAL_API_ROUTES = 1036;
export const TOTAL_ROUTES = 1095;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2340;

// Autofinish
export const AUTOFINISH_COUNT = 1183;

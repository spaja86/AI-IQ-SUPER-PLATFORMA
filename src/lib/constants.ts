...
export const APP_VERSION = '46.83.0';
...
export const TOTAL_API_ROUTES = 1034;
export const TOTAL_ROUTES = 1093;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2336;

// Autofinish
export const AUTOFINISH_COUNT = 1181;

...
// Ekosistem
export const TOTAL_PAGES = 51;
export const TOTAL_API_ROUTES = 591;
export const TOTAL_ROUTES = 645;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 695;

// Autofinish
export const AUTOFINISH_COUNT = 356;

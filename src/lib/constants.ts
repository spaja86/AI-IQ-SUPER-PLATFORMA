...
export const APP_VERSION = '42.19.0';
...
export const TOTAL_API_ROUTES = 852;
export const TOTAL_ROUTES = 909;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1289;

// Autofinish
export const AUTOFINISH_COUNT = 651;

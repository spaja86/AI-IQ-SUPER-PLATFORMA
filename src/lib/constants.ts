...
export const APP_VERSION = '50.5.0';
...
// Ekosistem
export const TOTAL_PAGES = 57;
export const TOTAL_API_ROUTES = 1105;
export const TOTAL_ROUTES = 1171;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2364;

// Autofinish
export const AUTOFINISH_COUNT = 1236;

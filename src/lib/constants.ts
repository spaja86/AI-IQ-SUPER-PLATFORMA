...
export const APP_VERSION = '41.1.0';
...
export const TOTAL_API_ROUTES = 712;
export const TOTAL_ROUTES = 769;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1009;

// Autofinish
export const AUTOFINISH_COUNT = 511;

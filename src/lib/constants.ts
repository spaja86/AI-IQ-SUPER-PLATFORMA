...
export const APP_VERSION = '39.3.0';
...
export const TOTAL_API_ROUTES = 622;
export const TOTAL_ROUTES = 679;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 829;

// Autofinish
export const AUTOFINISH_COUNT = 421;

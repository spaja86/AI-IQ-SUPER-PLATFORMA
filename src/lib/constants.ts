...
export const APP_VERSION = '46.81.0';
...
export const TOTAL_API_ROUTES = 1032;
export const TOTAL_ROUTES = 1091;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2332;

// Autofinish
export const AUTOFINISH_COUNT = 1179;

...
export const APP_VERSION = '41.5.0';
...
export const TOTAL_API_ROUTES = 732;
export const TOTAL_ROUTES = 789;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1049;

// Autofinish
export const AUTOFINISH_COUNT = 531;

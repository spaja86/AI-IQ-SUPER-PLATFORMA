...
// Ekosistem
export const TOTAL_PAGES = 37;
export const TOTAL_API_ROUTES = 378;
export const TOTAL_ROUTES = 418;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 421;

// Autofinish
export const AUTOFINISH_COUNT = 182;

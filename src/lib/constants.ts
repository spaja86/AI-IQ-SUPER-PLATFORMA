...
export const APP_VERSION = '42.3.0';
...
export const TOTAL_API_ROUTES = 772;
export const TOTAL_ROUTES = 829;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1129;

// Autofinish
export const AUTOFINISH_COUNT = 571;

...
export const APP_VERSION = '46.79.0';
...
export const TOTAL_API_ROUTES = 1031;
export const TOTAL_ROUTES = 1090;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2330;

// Autofinish
export const AUTOFINISH_COUNT = 1178;

...
export const APP_VERSION = '46.68.0';
...
export const TOTAL_API_ROUTES = 1013;
export const TOTAL_ROUTES = 1072;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2294;

// Autofinish
export const AUTOFINISH_COUNT = 1168;

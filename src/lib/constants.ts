...
export const APP_VERSION = '46.59.0';
...
export const TOTAL_API_ROUTES = 1004;
export const TOTAL_ROUTES = 1063;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2276;

// Autofinish
export const AUTOFINISH_COUNT = 1159;

...
export const APP_VERSION = '45.18.0';
...
export const TOTAL_API_ROUTES = 952;
export const TOTAL_ROUTES = 979;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 1978;

// Autofinish
export const AUTOFINISH_COUNT = 997;

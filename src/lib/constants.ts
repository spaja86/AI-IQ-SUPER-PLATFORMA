...
export const APP_VERSION = '46.72.0';
...
export const TOTAL_API_ROUTES = 1017;
export const TOTAL_ROUTES = 1076;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2302;

// Autofinish
export const AUTOFINISH_COUNT = 1172;

...
export const APP_VERSION = '40.5.0';
...
export const TOTAL_API_ROUTES = 682;
export const TOTAL_ROUTES = 739;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 949;

// Autofinish
export const AUTOFINISH_COUNT = 481;

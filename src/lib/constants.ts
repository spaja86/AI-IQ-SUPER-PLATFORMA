...
export const APP_VERSION = '40.4.0';
...
export const TOTAL_API_ROUTES = 677;
export const TOTAL_ROUTES = 734;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 939;

// Autofinish
export const AUTOFINISH_COUNT = 476;

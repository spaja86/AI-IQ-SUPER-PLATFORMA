...
export const APP_VERSION = '42.25.0';
...
export const TOTAL_API_ROUTES = 882;
export const TOTAL_ROUTES = 939;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1349;

// Autofinish
export const AUTOFINISH_COUNT = 681;

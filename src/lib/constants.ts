...
export const APP_VERSION = '59.53.0';
...
// Ekosistem
export const TOTAL_PAGES = 126;
export const TOTAL_API_ROUTES = 1201;
export const TOTAL_ROUTES = 1327;
export const TOTAL_IGRICA = 97;
export const TOTAL_GEJMING_ENTITETA = 45;
export const TOTAL_DIAGNOSTIKA = 2374;

// Autofinish
export const AUTOFINISH_COUNT = 1387;

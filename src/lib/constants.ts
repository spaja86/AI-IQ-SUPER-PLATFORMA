...
export const APP_VERSION = '42.14.0';
...
export const TOTAL_API_ROUTES = 827;
export const TOTAL_ROUTES = 884;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1239;

// Autofinish
export const AUTOFINISH_COUNT = 626;

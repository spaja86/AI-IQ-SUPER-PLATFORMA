...
export const APP_VERSION = '39.2.0';
...
export const TOTAL_API_ROUTES = 617;
export const TOTAL_ROUTES = 674;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 819;

// Autofinish
export const AUTOFINISH_COUNT = 416;

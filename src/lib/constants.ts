...
export const APP_VERSION = '36.5.0';
...
export const TOTAL_API_ROUTES = 299;
export const TOTAL_ROUTES = 332;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 312;

// Autofinish
export const AUTOFINISH_COUNT = 163;

...
export const APP_VERSION = '46.93.0';
...
export const TOTAL_API_ROUTES = 1047;
export const TOTAL_ROUTES = 1106;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2362;

// Autofinish
export const AUTOFINISH_COUNT = 1194;

...
export const APP_VERSION = '41.9.0';
...
export const TOTAL_API_ROUTES = 752;
export const TOTAL_ROUTES = 809;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1089;

// Autofinish
export const AUTOFINISH_COUNT = 551;

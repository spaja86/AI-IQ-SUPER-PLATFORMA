...
export const APP_VERSION = '46.82.0';
...
export const TOTAL_API_ROUTES = 1033;
export const TOTAL_ROUTES = 1092;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2334;

// Autofinish
export const AUTOFINISH_COUNT = 1180;

...
export const APP_VERSION = '45.86.0';
...
export const TOTAL_API_ROUTES = 968;
export const TOTAL_ROUTES = 995;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2114;

// Autofinish
export const AUTOFINISH_COUNT = 1065;

...
export const APP_VERSION = '42.15.0';
...
export const TOTAL_API_ROUTES = 832;
export const TOTAL_ROUTES = 889;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1249;

// Autofinish
export const AUTOFINISH_COUNT = 631;

...
export const APP_VERSION = '39.8.0';
...
export const TOTAL_API_ROUTES = 647;
export const TOTAL_ROUTES = 704;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 879;

// Autofinish
export const AUTOFINISH_COUNT = 446;

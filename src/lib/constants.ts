...
export const APP_VERSION = '46.86.0';
...
export const TOTAL_API_ROUTES = 1040;
export const TOTAL_ROUTES = 1099;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2348;

// Autofinish
export const AUTOFINISH_COUNT = 1187;

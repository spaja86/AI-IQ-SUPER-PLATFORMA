...
export const APP_VERSION = '42.18.0';
...
export const TOTAL_API_ROUTES = 847;
export const TOTAL_ROUTES = 904;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1279;

// Autofinish
export const AUTOFINISH_COUNT = 646;

...
export const APP_VERSION = '42.2.0';
...
export const TOTAL_API_ROUTES = 767;
export const TOTAL_ROUTES = 824;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1119;

// Autofinish
export const AUTOFINISH_COUNT = 566;

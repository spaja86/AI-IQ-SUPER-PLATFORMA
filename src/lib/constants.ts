...
export const APP_VERSION = '46.66.0';
...
export const TOTAL_API_ROUTES = 1011;
export const TOTAL_ROUTES = 1070;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2290;

// Autofinish
export const AUTOFINISH_COUNT = 1166;

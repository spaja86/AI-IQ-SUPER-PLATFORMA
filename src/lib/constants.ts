...
export const APP_VERSION = '59.77.0';
...
// Ekosistem
export const TOTAL_PAGES = 131;
export const TOTAL_API_ROUTES = 1241;
export const TOTAL_ROUTES = 1371;
export const TOTAL_IGRICA = 97;
export const TOTAL_GEJMING_ENTITETA = 45;
export const TOTAL_DIAGNOSTIKA = 2404;

// Autofinish
export const AUTOFINISH_COUNT = 1425;

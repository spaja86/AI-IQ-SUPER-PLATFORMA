...
export const APP_VERSION = '28.5.0';
...
// Ekosistem
export const TOTAL_PAGES = 28;
export const TOTAL_API_ROUTES = 243;
export const TOTAL_ROUTES = 275;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 245;

// Autofinish
export const AUTOFINISH_COUNT = 147;

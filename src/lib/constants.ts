...
export const APP_VERSION = '40.7.0';
...
export const TOTAL_API_ROUTES = 692;
export const TOTAL_ROUTES = 749;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 969;

// Autofinish
export const AUTOFINISH_COUNT = 491;

...
export const APP_VERSION = '42.20.0';
...
export const TOTAL_API_ROUTES = 857;
export const TOTAL_ROUTES = 914;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1299;

// Autofinish
export const AUTOFINISH_COUNT = 656;

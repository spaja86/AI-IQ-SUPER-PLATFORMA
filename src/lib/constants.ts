...
export const APP_VERSION = '46.87.0';
...
export const TOTAL_API_ROUTES = 1041;
export const TOTAL_ROUTES = 1100;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2350;

// Autofinish
export const AUTOFINISH_COUNT = 1188;

...
export const APP_VERSION = '46.71.0';
...
export const TOTAL_API_ROUTES = 1016;
export const TOTAL_ROUTES = 1075;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2300;

// Autofinish
export const AUTOFINISH_COUNT = 1171;

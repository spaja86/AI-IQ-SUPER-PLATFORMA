...
export const APP_VERSION = '17.5.0';
...
export const TOTAL_API_ROUTES = 133;
export const TOTAL_ROUTES = 165;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 134;

// Autofinish
export const AUTOFINISH_COUNT = 125;

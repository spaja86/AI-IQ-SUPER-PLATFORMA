...
export const APP_VERSION = '42.10.0';
...
export const TOTAL_API_ROUTES = 807;
export const TOTAL_ROUTES = 864;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1199;

// Autofinish
export const AUTOFINISH_COUNT = 606;

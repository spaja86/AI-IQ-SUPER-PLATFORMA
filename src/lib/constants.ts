...
export const APP_VERSION = '46.58.0';
...
export const TOTAL_API_ROUTES = 1003;
export const TOTAL_ROUTES = 1062;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2274;

// Autofinish
export const AUTOFINISH_COUNT = 1158;

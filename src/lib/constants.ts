...
export const APP_VERSION = '42.12.0';
...
export const TOTAL_API_ROUTES = 817;
export const TOTAL_ROUTES = 874;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1219;

// Autofinish
export const AUTOFINISH_COUNT = 616;

...
export const APP_VERSION = '41.2.0';
...
export const TOTAL_API_ROUTES = 717;
export const TOTAL_ROUTES = 774;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1019;

// Autofinish
export const AUTOFINISH_COUNT = 516;

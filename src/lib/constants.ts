...
export const APP_VERSION = '34.0.0';
...
export const TOTAL_API_ROUTES = 283;
export const TOTAL_ROUTES = 316;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 296;

// Autofinish
export const AUTOFINISH_COUNT = 158;

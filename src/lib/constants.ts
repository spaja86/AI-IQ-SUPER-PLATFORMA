...
export const APP_VERSION = '39.9.0';
...
export const TOTAL_API_ROUTES = 652;
export const TOTAL_ROUTES = 709;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 889;

// Autofinish
export const AUTOFINISH_COUNT = 451;

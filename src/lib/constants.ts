...
export const APP_VERSION = '46.60.0';
...
export const TOTAL_API_ROUTES = 1005;
export const TOTAL_ROUTES = 1064;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2278;

// Autofinish
export const AUTOFINISH_COUNT = 1160;

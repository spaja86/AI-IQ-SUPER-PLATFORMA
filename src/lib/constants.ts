...
// Ekosistem
export const TOTAL_PAGES = 46;
export const TOTAL_API_ROUTES = 549;
export const TOTAL_ROUTES = 601;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 580;

// Autofinish
export const AUTOFINISH_COUNT = 327;

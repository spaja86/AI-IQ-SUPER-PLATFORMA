...
export const APP_VERSION = '46.73.0';
...
export const TOTAL_API_ROUTES = 1018;
export const TOTAL_ROUTES = 1077;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2304;

// Autofinish
export const AUTOFINISH_COUNT = 1173;

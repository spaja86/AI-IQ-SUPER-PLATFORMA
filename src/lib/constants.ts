...
export const APP_VERSION = '46.53.0';
...
export const TOTAL_API_ROUTES = 998;
export const TOTAL_ROUTES = 1057;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2264;

// Autofinish
export const AUTOFINISH_COUNT = 1153;

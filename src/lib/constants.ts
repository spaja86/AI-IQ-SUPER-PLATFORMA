...
export const APP_VERSION = '42.17.0';
...
export const TOTAL_API_ROUTES = 842;
export const TOTAL_ROUTES = 899;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1269;

// Autofinish
export const AUTOFINISH_COUNT = 641;

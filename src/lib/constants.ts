...
export const APP_VERSION = '40.2.0';
...
export const TOTAL_API_ROUTES = 667;
export const TOTAL_ROUTES = 724;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 919;

// Autofinish
export const AUTOFINISH_COUNT = 466;

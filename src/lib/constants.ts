...
export const APP_VERSION = '42.22.0';
...
export const TOTAL_API_ROUTES = 867;
export const TOTAL_ROUTES = 924;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1319;

// Autofinish
export const AUTOFINISH_COUNT = 666;

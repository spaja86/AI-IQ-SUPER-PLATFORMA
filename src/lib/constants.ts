...
export const APP_VERSION = '42.43.0';
...
export const TOTAL_API_ROUTES = 921;
export const TOTAL_ROUTES = 975;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 1429;

// Autofinish
export const AUTOFINISH_COUNT = 722;

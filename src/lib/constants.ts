...
export const APP_VERSION = '46.67.0';
...
export const TOTAL_API_ROUTES = 1012;
export const TOTAL_ROUTES = 1071;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2292;

// Autofinish
export const AUTOFINISH_COUNT = 1167;

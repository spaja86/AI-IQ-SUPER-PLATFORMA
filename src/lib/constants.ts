...
export const APP_VERSION = '38.9.0';
...
export const TOTAL_API_ROUTES = 602;
export const TOTAL_ROUTES = 659;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 789;

// Autofinish
export const AUTOFINISH_COUNT = 401;

...
export const APP_VERSION = '42.23.0';
...
export const TOTAL_API_ROUTES = 872;
export const TOTAL_ROUTES = 929;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1329;

// Autofinish
export const AUTOFINISH_COUNT = 671;

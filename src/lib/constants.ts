...
export const APP_VERSION = '42.27.0';
...
export const TOTAL_API_ROUTES = 892;
export const TOTAL_ROUTES = 949;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1369;

// Autofinish
export const AUTOFINISH_COUNT = 691;

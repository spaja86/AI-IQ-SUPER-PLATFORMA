...
export const APP_VERSION = '41.3.0';
...
export const TOTAL_API_ROUTES = 722;
export const TOTAL_ROUTES = 779;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1029;

// Autofinish
export const AUTOFINISH_COUNT = 521;

...
export const APP_VERSION = '42.6.0';
...
export const TOTAL_API_ROUTES = 787;
export const TOTAL_ROUTES = 844;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1159;

// Autofinish
export const AUTOFINISH_COUNT = 586;

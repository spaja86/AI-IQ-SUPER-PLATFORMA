...
export const APP_VERSION = '42.8.0';
...
export const TOTAL_API_ROUTES = 797;
export const TOTAL_ROUTES = 854;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1179;

// Autofinish
export const AUTOFINISH_COUNT = 596;

...
export const APP_VERSION = '46.77.0';
...
export const TOTAL_API_ROUTES = 1029;
export const TOTAL_ROUTES = 1088;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2328;

// Autofinish
export const AUTOFINISH_COUNT = 1177;

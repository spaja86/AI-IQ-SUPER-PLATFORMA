...
export const APP_VERSION = '46.74.0';
...
export const TOTAL_API_ROUTES = 1019;
export const TOTAL_ROUTES = 1078;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2306;

// Autofinish
export const AUTOFINISH_COUNT = 1174;

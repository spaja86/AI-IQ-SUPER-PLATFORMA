...
export const APP_VERSION = '38.8.0';
...
export const TOTAL_API_ROUTES = 597;
export const TOTAL_ROUTES = 654;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 779;

// Autofinish
export const AUTOFINISH_COUNT = 396;

...
export const APP_VERSION = '35.5.0';
...
export const TOTAL_API_ROUTES = 289;
export const TOTAL_ROUTES = 322;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 302;

// Autofinish
export const AUTOFINISH_COUNT = 161;

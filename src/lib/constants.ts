...
export const APP_VERSION = '42.26.0';
...
export const TOTAL_API_ROUTES = 887;
export const TOTAL_ROUTES = 944;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1359;

// Autofinish
export const AUTOFINISH_COUNT = 686;

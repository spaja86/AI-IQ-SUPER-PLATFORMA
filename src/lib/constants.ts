...
export const APP_VERSION = '46.65.0';
...
export const TOTAL_API_ROUTES = 1010;
export const TOTAL_ROUTES = 1069;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2288;

// Autofinish
export const AUTOFINISH_COUNT = 1165;

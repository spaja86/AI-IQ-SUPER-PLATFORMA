...
export const APP_VERSION = '46.49.0';
...
export const TOTAL_API_ROUTES = 991;
export const TOTAL_ROUTES = 1050;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2258;

// Autofinish
export const AUTOFINISH_COUNT = 1137;

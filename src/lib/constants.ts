...
export const APP_VERSION = '46.56.0';
...
export const TOTAL_API_ROUTES = 1001;
export const TOTAL_ROUTES = 1060;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2270;

// Autofinish
export const AUTOFINISH_COUNT = 1156;

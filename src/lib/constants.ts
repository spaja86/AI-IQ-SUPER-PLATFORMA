...
export const APP_VERSION = '46.75.0';
...
export const TOTAL_API_ROUTES = 1020;
export const TOTAL_ROUTES = 1079;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2308;

// Autofinish
export const AUTOFINISH_COUNT = 1175;

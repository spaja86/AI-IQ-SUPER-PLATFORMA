...
export const APP_VERSION = '40.8.0';
...
export const TOTAL_API_ROUTES = 697;
export const TOTAL_ROUTES = 754;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 979;

// Autofinish
export const AUTOFINISH_COUNT = 496;

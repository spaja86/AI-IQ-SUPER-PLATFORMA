...
export const APP_VERSION = '46.57.0';
...
export const TOTAL_API_ROUTES = 1002;
export const TOTAL_ROUTES = 1061;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2272;

// Autofinish
export const AUTOFINISH_COUNT = 1157;

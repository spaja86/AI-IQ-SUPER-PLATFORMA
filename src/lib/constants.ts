...
// Ekosistem
export const TOTAL_PAGES = 39;
export const TOTAL_API_ROUTES = 429;
export const TOTAL_ROUTES = 471;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 590;

// Autofinish
export const AUTOFINISH_COUNT = 239;

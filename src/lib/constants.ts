...
export const APP_VERSION = '40.6.0';
...
export const TOTAL_API_ROUTES = 687;
export const TOTAL_ROUTES = 744;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 959;

// Autofinish
export const AUTOFINISH_COUNT = 486;

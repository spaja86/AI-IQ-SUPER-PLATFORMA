...
export const APP_VERSION = '39.6.0';
...
export const TOTAL_API_ROUTES = 637;
export const TOTAL_ROUTES = 694;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 859;

// Autofinish
export const AUTOFINISH_COUNT = 436;

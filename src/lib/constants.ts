...
export const APP_VERSION = '46.89.0';
...
export const TOTAL_API_ROUTES = 1043;
export const TOTAL_ROUTES = 1102;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2354;

// Autofinish
export const AUTOFINISH_COUNT = 1190;

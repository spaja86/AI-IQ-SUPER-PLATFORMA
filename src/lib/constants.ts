...
export const APP_VERSION = '46.54.0';
...
export const TOTAL_API_ROUTES = 999;
export const TOTAL_ROUTES = 1058;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2266;

// Autofinish
export const AUTOFINISH_COUNT = 1154;

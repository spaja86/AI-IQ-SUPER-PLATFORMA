...
export const APP_VERSION = '46.64.0';
...
export const TOTAL_API_ROUTES = 1009;
export const TOTAL_ROUTES = 1068;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2286;

// Autofinish
export const AUTOFINISH_COUNT = 1164;

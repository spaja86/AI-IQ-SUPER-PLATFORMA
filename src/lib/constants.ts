...
export const APP_VERSION = '39.5.0';
...
export const TOTAL_API_ROUTES = 632;
export const TOTAL_ROUTES = 689;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 849;

// Autofinish
export const AUTOFINISH_COUNT = 431;

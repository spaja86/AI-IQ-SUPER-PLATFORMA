...
export const APP_VERSION = '41.4.0';
...
export const TOTAL_API_ROUTES = 727;
export const TOTAL_ROUTES = 784;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1039;

// Autofinish
export const AUTOFINISH_COUNT = 526;

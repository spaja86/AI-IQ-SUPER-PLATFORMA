...
export const APP_VERSION = '46.69.0';
...
export const TOTAL_API_ROUTES = 1014;
export const TOTAL_ROUTES = 1073;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2296;

// Autofinish
export const AUTOFINISH_COUNT = 1169;

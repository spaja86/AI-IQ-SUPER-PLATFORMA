...
export const APP_VERSION = '46.92.0';
...
export const TOTAL_API_ROUTES = 1046;
export const TOTAL_ROUTES = 1105;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2360;

// Autofinish
export const AUTOFINISH_COUNT = 1193;

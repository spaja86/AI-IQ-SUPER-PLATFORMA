...
export const APP_VERSION = '42.1.0';
...
export const TOTAL_API_ROUTES = 762;
export const TOTAL_ROUTES = 819;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1109;

// Autofinish
export const AUTOFINISH_COUNT = 561;

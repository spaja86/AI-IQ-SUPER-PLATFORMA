...
export const APP_VERSION = '46.43.0';
...
export const TOTAL_API_ROUTES = 986;
export const TOTAL_ROUTES = 1045;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2228;

// Autofinish
export const AUTOFINISH_COUNT = 1122;

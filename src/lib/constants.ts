...
export const APP_VERSION = '41.6.0';
...
export const TOTAL_API_ROUTES = 737;
export const TOTAL_ROUTES = 794;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1059;

// Autofinish
export const AUTOFINISH_COUNT = 536;

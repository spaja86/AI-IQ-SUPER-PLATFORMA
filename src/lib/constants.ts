...
export const APP_VERSION = '46.88.0';
...
export const TOTAL_API_ROUTES = 1042;
export const TOTAL_ROUTES = 1101;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2352;

// Autofinish
export const AUTOFINISH_COUNT = 1189;

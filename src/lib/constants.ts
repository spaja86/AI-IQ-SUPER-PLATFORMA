...
export const APP_VERSION = '42.9.0';
...
export const TOTAL_API_ROUTES = 802;
export const TOTAL_ROUTES = 859;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1189;

// Autofinish
export const AUTOFINISH_COUNT = 601;

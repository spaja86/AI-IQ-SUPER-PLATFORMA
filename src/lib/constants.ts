...
export const APP_VERSION = '42.28.0';
...
export const TOTAL_API_ROUTES = 897;
export const TOTAL_ROUTES = 954;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1379;

// Autofinish
export const AUTOFINISH_COUNT = 696;

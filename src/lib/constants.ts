...
export const APP_VERSION = '42.13.0';
...
export const TOTAL_API_ROUTES = 822;
export const TOTAL_ROUTES = 879;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1229;

// Autofinish
export const AUTOFINISH_COUNT = 621;

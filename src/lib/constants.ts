...
export const APP_VERSION = '59.46.0';
...
export const TOTAL_API_ROUTES = 1196;
export const TOTAL_ROUTES = 1321;
export const TOTAL_IGRICA = 97;
export const TOTAL_GEJMING_ENTITETA = 45;
export const TOTAL_DIAGNOSTIKA = 2372;

// Autofinish
export const AUTOFINISH_COUNT = 1376;

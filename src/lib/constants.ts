...
export const APP_VERSION = '46.62.0';
...
export const TOTAL_API_ROUTES = 1007;
export const TOTAL_ROUTES = 1066;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2282;

// Autofinish
export const AUTOFINISH_COUNT = 1162;

...
export const APP_VERSION = '45.52.0';
...
export const TOTAL_API_ROUTES = 960;
export const TOTAL_ROUTES = 987;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2046;

// Autofinish
export const AUTOFINISH_COUNT = 1031;

...
export const APP_VERSION = '46.33.0';
...
export const TOTAL_API_ROUTES = 975;
export const TOTAL_ROUTES = 1002;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2208;

// Autofinish
export const AUTOFINISH_COUNT = 1112;

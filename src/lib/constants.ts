...
export const APP_VERSION = '42.11.0';
...
export const TOTAL_API_ROUTES = 812;
export const TOTAL_ROUTES = 869;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1209;

// Autofinish
export const AUTOFINISH_COUNT = 611;

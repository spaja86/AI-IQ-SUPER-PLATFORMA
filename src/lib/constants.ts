...
export const APP_VERSION = '45.69.0';
...
export const TOTAL_API_ROUTES = 964;
export const TOTAL_ROUTES = 991;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2080;

// Autofinish
export const AUTOFINISH_COUNT = 1048;

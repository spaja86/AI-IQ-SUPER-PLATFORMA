...
export const APP_VERSION = '31.5.0';
...
export const TOTAL_API_ROUTES = 263;
export const TOTAL_ROUTES = 296;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 276;

// Autofinish
export const AUTOFINISH_COUNT = 153;

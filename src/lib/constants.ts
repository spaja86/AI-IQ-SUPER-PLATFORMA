...
export const APP_VERSION = '42.24.0';
...
export const TOTAL_API_ROUTES = 877;
export const TOTAL_ROUTES = 934;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1339;

// Autofinish
export const AUTOFINISH_COUNT = 676;

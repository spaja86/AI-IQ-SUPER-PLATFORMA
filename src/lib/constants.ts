...
export const APP_VERSION = '45.35.0';
...
export const TOTAL_API_ROUTES = 956;
export const TOTAL_ROUTES = 983;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2012;

// Autofinish
export const AUTOFINISH_COUNT = 1014;

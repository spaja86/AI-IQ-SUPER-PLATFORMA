...
export const APP_VERSION = '39.1.0';
...
export const TOTAL_API_ROUTES = 612;
export const TOTAL_ROUTES = 669;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 809;

// Autofinish
export const AUTOFINISH_COUNT = 411;

...
export const APP_VERSION = '46.91.0';
...
export const TOTAL_API_ROUTES = 1045;
export const TOTAL_ROUTES = 1104;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2358;

// Autofinish
export const AUTOFINISH_COUNT = 1192;

...
export const APP_VERSION = '42.16.0';
...
export const TOTAL_API_ROUTES = 837;
export const TOTAL_ROUTES = 894;
export const TOTAL_IGRICA = 95;
export const TOTAL_DIAGNOSTIKA = 1259;

// Autofinish
export const AUTOFINISH_COUNT = 636;

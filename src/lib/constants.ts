...
export const APP_VERSION = '46.84.0';
...
export const TOTAL_API_ROUTES = 1035;
export const TOTAL_ROUTES = 1094;
export const TOTAL_IGRICA = 96;
export const TOTAL_DIAGNOSTIKA = 2338;

// Autofinish
export const AUTOFINISH_COUNT = 1182;

...
export const EXTRIMLI_DUEL_KING_CONTRACT_VERSION = 'v1-duel-king';
export const EXTRIMLI_DUEL_KING_MODULE_VERSION = '1.0.0';
export const EXTRIMLI_DUEL_KING_PERSONA_ID = 'extrimli-duel-king';

...
export const itProizvodi: ITProizvod[] = [
  ...
  { id: 'omega-ai-engine', naziv: 'OMEGA AI Engine', opis: 'Centralni AI engine za sve agente', ikona: '🧠', kategorija: 'ai', funkcije: ['Multi-model support', 'Fine-tuning', 'Inference optimization'], ciljnePlatforme: ['omega-ai-github', 'omega-ai-vercel', 'omega-ai-google'], uticaj: 'visok' },

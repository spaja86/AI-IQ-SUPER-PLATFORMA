...
export const platforme: Platforma[] = [
  ...
  },
  {
    ...
    funkcije: ['SpajaPro Prompt Chat', 'Laboratorija i Demo', 'AI modul sa Prompt-om', 'SpajaPro 6-15 integracija', 'Fizička laboratorija', 'Razvoj B2B softvera', 'Dota 1350', 'TRANSFORMERS 1350', 'BUBLI BABLI 1250', 'POKERMASTER'],

...
export const platforme: Platforma[] = [
  ...
  },
  {
    id: 'io-openui-ao',
    naziv: 'IO OPENUI AO',
    opis: 'Unified frontend za sve module ekosistema',
    kategorija: 'jezgro',
    ...
    status: 'razvoj',
    progres: 65,
    tehnologije: ['React', 'WebRTC', 'Socket.IO', 'Vercel'],
    funkcije: ['Banka modul', 'Menjacnica modul', 'AI modul', 'Chat'],
    deploy: { status: 'u_pripremi', framework: 'React', buildKomanda: 'npm run build' },
  },
  {
    id: 'ai-iq-menjacnica',
  ...
  },
  {
    ...
    opis: 'AI agent za automatizaciju GitHub operacija',
    kategorija: 'ai',
    ...
    status: 'spremna',
    progres: 90,
    tehnologije: ['TypeScript', 'GitHub API', 'OpenAI', 'Vercel'],
    funkcije: ['Code review', 'PR automation', 'Issue triage', 'CI/CD'],
    deploy: { status: 'aktivan', framework: 'Node.js', buildKomanda: 'tsc' },
  },
  {
    id: 'omega-ai-vercel',
  ...
  },
  {
    ...
    opis: 'Sistem od 5 specijalizovanih AI persona',
    kategorija: 'ai',
    ...
    status: 'razvoj',
    progres: 70,
    tehnologije: ['TypeScript', 'OpenAI', 'LangChain'],
    funkcije: ['Multi-persona AI', 'Specijalizovani agenti', 'Kolaboracija'],
    deploy: { status: 'neaktivan', framework: 'Node.js', buildKomanda: 'tsc' },
  },
  {
    id: 'openai-platforma',
    naziv: 'OpenAI Platforma',
    opis: 'Integracija sa OpenAI servisima',
    kategorija: 'ai',
    ...
    status: 'razvoj',
    progres: 60,
    tehnologije: ['TypeScript', 'OpenAI API', 'GPT-4', 'DALL-E'],
    funkcije: ['Chat API', 'Image generation', 'Embeddings', 'Fine-tuning'],
    deploy: { status: 'neaktivan', framework: 'Next.js', buildKomanda: 'next build' },
  },
  {
    id: 'input-output-copilot',
    naziv: 'Input/Output za Copilot',
    opis: 'I/O interfejs za GitHub Copilot integraciju',
    kategorija: 'alati',
    ...
    status: 'razvoj',
    progres: 82,
    tehnologije: ['TypeScript', 'GitHub Copilot API', 'VS Code Extension'],
    funkcije: ['Code suggestions', 'Context management', 'Custom prompts'],
    deploy: { status: 'u_pripremi', framework: 'Node.js', buildKomanda: 'tsc' },
  },
];

...
export const platforme: Platforma[] = [
  ...
  },
  {
    ...
    opis: 'Platformski modul za mapiranje, konsolidaciju i operativnu stabilizaciju ekosistemskih tokova.',
    kategorija: 'alati',
    repo: 'spaja86/AI-IQ-SUPER-PLATFORMA',
  ...
  },
  {
    id: 'mekartor',
    naziv: 'Mekartor',
    opis: 'Repo-local deployable surface za katalog-ready rollout, observability i audit governance bez downstream linked-repo zavisnosti.',
    kategorija: 'alati',
    repo: 'spaja86/AI-IQ-SUPER-PLATFORMA',
    ...
    status: 'aktivna',
    progres: 76,
    tehnologije: ['Next.js 16', 'TypeScript', 'Deploy Platforma', 'Vercel'],
    funkcije: ['Staged rollout', 'Health signal', 'Audit-ready promotion', 'Repo-local deploy governance'],
    deploy: { status: 'aktivan', provider: 'vercel', domen: 'ai-iq-super-platforma.vercel.app/mekartor', projectId: 'ai-iq-super-platforma', vercelProjekt: 'ai-iq-super-platforma', framework: 'Next.js 16', buildKomanda: 'next build' },
  },
  {
    id: 'deploy-platforma',
...
export function getBrojAktivnih(): number {
  return platforme.filter((p) => p.status === 'aktivna').length;
}

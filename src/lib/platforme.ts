...
export const platforme: Platforma[] = [
  ...
  {
    id: 'openai-platforma',
    naziv: 'OpenAI Platforma — SpajaPro v6-15',
    opis: 'OpenAI API integracija sa SpajaPro v6-15 endžinima i OMEGA AI sistemom. Umesto ChatGPT-a koristi se SpajaPro v6-15 engine sa naprednim Prompt sistemom. API ključ postavljen u openai-platform repozitorijumu (spaja86/openai-platform). Planovi: Starter $29/mes, Profesionalni $79/mes, Biznis $199/mes, Enterprise $499/mes, Unlimited VIP $999/mes. Zvanični sajt: https://openai.com/',
    kategorija: 'ai',
    ...
    status: 'spremna',
    progres: 100,
    tehnologije: ['TypeScript', 'OpenAI API', 'SpajaPro v6-15 Engine', 'OMEGA AI', 'Vercel'],
    funkcije: ['SpajaPro v6-15 umesto ChatGPT-a', 'OpenAI API integracija', 'OMEGA AI povezivanje', 'SpajaPro Prompt sistem', 'AI servisi za ekosistem', 'Vercel deploy integracija', 'Planovi: Starter/Pro/Biznis/Enterprise/Unlimited VIP', 'API ključ u repo'],

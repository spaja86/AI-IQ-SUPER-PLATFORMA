...
export const navigation: NavItem[] = [
  ...
  { label: 'Igrice', href: '/igrice', icon: '🎮', description: '98 igrica u 18 kategorija' },
  ...
  { label: 'Gaming Platforma', href: '/io-openui-ao-gaming-platforma', icon: '🎮', description: 'IO/OPENUI/AO Gaming - SPAJA Univerzalni Endzin nad 98 igrica (io-openui-ao.vercel.app)' },

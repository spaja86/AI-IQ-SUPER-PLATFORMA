...
export const navigation: NavItem[] = [
  ...
  { label: 'Eksponencijalne Funkcije', href: '/oktavne-eksponencijalne-funkcije', icon: '📈', description: 'Figuracioni centar eksponencijalnog objekta u funkcionalnim oktavama — f(x) = a*b^x+c' },
];

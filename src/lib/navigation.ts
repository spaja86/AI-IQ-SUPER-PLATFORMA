...
export const navigation: NavItem[] = [
  ...
  { label: 'Digitalna Industrija Kapitalni Rizik', href: '/digitalna-industrija-kapitalni-rizik', icon: '🏛️', description: 'Centralni registar adekvatnosti kapitala (CAR, CET1, Tier1/Tier2 i kapitalnog bafera) Digitalne Industrije u Republici Srbiji' },

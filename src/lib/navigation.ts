...
export const navigation: NavItem[] = [
  ...
  { label: 'Digitalni Kompjuter', href: '/spaja-digitalni-kompjuter', icon: '🖥️', description: 'SPAJA Digitalni Kompjuter — Maticna Ploca, Server, Procesor, GPU, Graficka, RAM, konzole, dzojstici' },
];

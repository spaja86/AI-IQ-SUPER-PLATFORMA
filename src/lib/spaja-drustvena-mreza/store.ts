...
export function getSpajaDrustvenaMrezaPregled(): SocialOverview {
  ...
  return {
    ...
    moduleVersion: SPAJA_DRUSTVENA_MREZA_MODULE_VERSION,
    apiRoutes: [
      '/api/spaja-drustvena-mreza/health',
      '/api/spaja-drustvena-mreza/pregled',
      '/api/spaja-drustvena-mreza/profiles',
      '/api/spaja-drustvena-mreza/feed',
      '/api/spaja-drustvena-mreza/groups',
      '/api/spaja-drustvena-mreza/messages',
      '/api/spaja-drustvena-mreza/events',
      '/api/spaja-drustvena-mreza/notifikacije',
    ],
    scopeBoundaries: {
      inScope: [
        'src/lib/spaja-drustvena-mreza/**',
        'src/app/api/spaja-drustvena-mreza/**',
        '/spaja-drustvena-mreza',
        'tests',
        'docs',
        'validator workflow',
        'persona/agent registration',
      ],
      outOfScope: [
        'deploy hook secrets',
        ...
        'private DMs outside repo-local model',
        'file uploads',
        'ads',
        'payment flows',
      ],
    ...
    moderationRules: [
      ...
      'duplikat objava, reakcija i flag-ova se odbijaju',
      ...
      'notifikacije zahtevaju recipientId, a mark-as-read je dozvoljen samo vlasniku',
    ],
    kpis: [

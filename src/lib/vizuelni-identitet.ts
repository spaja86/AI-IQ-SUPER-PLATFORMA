...
export const brendSmernice: BrendSmernice = {
  ...
  ikona: '🎨',
  boje: [
    { naziv: 'SPAJA Plava', hex: '#2563eb', rgb: 'rgb(37, 99, 235)', upotreba: 'Primarna boja — CTA, linkovi, interakcije' },
    { naziv: 'SPAJA Ljubičasta', hex: '#7c3aed', rgb: 'rgb(124, 58, 237)', upotreba: 'Akcent i gradijenti za hero/baner sekcije' },
    { naziv: 'SPAJA Indigo', hex: '#4f46e5', rgb: 'rgb(79, 70, 229)', upotreba: 'Sekundarni akcent i statusi' },
    { naziv: 'Pozadina', hex: '#060914', rgb: 'rgb(6, 9, 20)', upotreba: 'Osnovna pozadina shell-a' },
    { naziv: 'Površina 1', hex: '#0b1223', rgb: 'rgb(11, 18, 35)', upotreba: 'Kartice i sekcije nivo 1' },
    { naziv: 'Površina 2', hex: '#111a2f', rgb: 'rgb(17, 26, 47)', upotreba: 'Kartice i sekcije nivo 2' },
    { naziv: 'Tekst Primarni', hex: '#eef2ff', rgb: 'rgb(238, 242, 255)', upotreba: 'Naslovi i glavni tekst' },
    { naziv: 'Tekst Sekundarni', hex: '#a5b4d6', rgb: 'rgb(165, 180, 214)', upotreba: 'Opisni tekst i meta informacije' },
  ...
  principi: [
    ...
    'Gradijenti — plava→ljubičasta→indigo za hero/cta sekcije',
    'Emoji ikone — ARIA pristupačnost (role="img")',
    'Jedinstvena skala spacing/typography kroz ceo sajt',
    'Jasna stanja interakcije: hover/focus/active/disabled',

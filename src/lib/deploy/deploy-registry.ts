...
export const deployRegistry: DeployPlatformEntry[] = [
  ...
  },
  {
    id: 'mekartor',
    naziv: 'Mekartor',
    opis: 'Repo-local katalog i rollout gateway integrisan u postojeći deploy governance model',
    ikona: '🧭',
    vercelProjectId: 'ai-iq-super-platforma',
    deployHookEnvVar: 'VERCEL_DEPLOY_HOOK_MEKARTOR',
    produktionUrl: 'https://ai-iq-super-platforma.vercel.app/mekartor',
    healthUrl: 'https://ai-iq-super-platforma.vercel.app/api/mekartor',
    framework: 'Next.js 16',
    status: 'aktivan',
    manualTriggerEnabled: true,
  },

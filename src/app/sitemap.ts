...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const mediumHighPriority = ['/platforme', '/palasterizacija', '/perkolizonik', '/polimerzacija', '/polimerizacija-2', '/harmonizacija', '/kristalizacija', '/vektorizacija', '/sintetizacija', '/rezonancija', '/modulacija', '/eksosistzdacija', '/omega-ai', '/spaja-pro', '/igrice', '/gejming-industrija', '/gejming-likovi', '/it-proizvodi'];

...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    endpoints: [
      ...
      { metod: 'GET',  putanja: '/api/kripto-trezor/governance',      opis: 'Governance prijedlozi i glasanje: promjene parametara vault politike, time-lock i multi-sig konfiguracije', auth: true },
      { metod: 'GET',  putanja: '/api/kripto-trezor/compliance',      opis: 'Compliance izvještaj: AML/KYC/sanctions kontrole, warning i breach status provjera', auth: true },
    ],

...
export async function GET() {
  const moduli = [
    { naziv: 'Fotonsko Rezonatorno Jezgro', tip: 'Photon-Resonator-Core', status: 'aktivan' },
  ...
  return NextResponse.json({
    status: 'aktivan',
    naziv: 'ULTRA Fotonski Rezonator — Photon Resonation Engine',
    verzija: APP_VERSION,

    fotonskiRezonator: {
      ukupnoModula: moduli.length,
      model: 'ULTRA-FRE v1.0',
      snaga: '10¹²⁵ fotonskih rezonacija/s',

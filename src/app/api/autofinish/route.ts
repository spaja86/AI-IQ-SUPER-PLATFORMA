...
function getAutofinishOpis(n: number): string {
  const opisi: Record<number, string> = {
    ...
    730: `Autofinish #730 — Bezbednost i autentifikacija: OAuth2/JWT implementiran, sesije zaštićene, penetration testing prošao, 2 nove dijagnostičke provere (#730) u diagnostics.ts (TOTAL_DIAGNOSTIKA 1443→${TOTAL_DIAGNOSTIKA}), APP_VERSION 42.50.0→42.51.0, AUTOFINISH_COUNT 729→730, ${TOTAL_ROUTES} ruta, ${TOTAL_API_ROUTES} API, ${TOTAL_DIAGNOSTIKA} dijagnostike`,
  };

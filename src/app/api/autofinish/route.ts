...
function getAutofinishOpis(n: number): string {
  const opisi: Record<number, string> = {
    ...
    723: `Autofinish #723 — Verifikacija igrica i platforma: TOTAL_IGRICA 96 potvrđen, sve igrice aktivne i registrovane, 2 nove dijagnostičke provere (#723) u diagnostics.ts (TOTAL_DIAGNOSTIKA 1429→${TOTAL_DIAGNOSTIKA}), APP_VERSION 42.43.0→42.44.0, AUTOFINISH_COUNT 722→723, ${TOTAL_ROUTES} ruta, ${TOTAL_API_ROUTES} API, ${TOTAL_DIAGNOSTIKA} dijagnostike`,
  };

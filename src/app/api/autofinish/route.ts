...
function getAutofinishOpis(n: number): string {
  const opisi: Record<number, string> = {
    ...
    731: `Autofinish #731 — Performanse i optimizacija: query optimizacija izvršena, caching konfigurisan, response time poboljšan, 2 nove dijagnostičke provere (#731) u diagnostics.ts (TOTAL_DIAGNOSTIKA 1445→${TOTAL_DIAGNOSTIKA}), APP_VERSION 42.51.0→42.52.0, AUTOFINISH_COUNT 730→731, ${TOTAL_ROUTES} ruta, ${TOTAL_API_ROUTES} API, ${TOTAL_DIAGNOSTIKA} dijagnostike`,
  };

...
function getAutofinishOpis(n: number): string {
  const opisi: Record<number, string> = {
    ...
    724: `Autofinish #724 — Stabilnost sistema i pregled korisničkih modula: sve komponente operativne, sesije stabilne, 2 nove dijagnostičke provere (#724) u diagnostics.ts (TOTAL_DIAGNOSTIKA 1431→${TOTAL_DIAGNOSTIKA}), APP_VERSION 42.44.0→42.45.0, AUTOFINISH_COUNT 723→724, ${TOTAL_ROUTES} ruta, ${TOTAL_API_ROUTES} API, ${TOTAL_DIAGNOSTIKA} dijagnostike`,
  };

...
function getAutofinishOpis(n: number): string {
  const opisi: Record<number, string> = {
    ...
    1413: `Autofinish #1413 — Održavanje autofinish kontinuiteta: dodat eksplicitan istorijski opis za aktuelnu iteraciju kako fallback poruka ne bi bila aktivna u /api/autofinish paginaciji, AUTOFINISH_COUNT 1412→1413, APP_VERSION 59.70.0, ${TOTAL_ROUTES} ruta, ${TOTAL_API_ROUTES} API, ${TOTAL_DIAGNOSTIKA} dijagnostike`,
  };

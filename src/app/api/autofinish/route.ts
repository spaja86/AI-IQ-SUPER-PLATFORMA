...
function getAutofinishOpis(n: number): string {
  const opisi: Record<number, string> = {
    ...
    726: `Autofinish #726 — Proširenje modula i integracija novih servisa: svi moduli međusobno usklađeni, novi servisi registrovani i operativni, 2 nove dijagnostičke provere (#726) u diagnostics.ts (TOTAL_DIAGNOSTIKA 1435→${TOTAL_DIAGNOSTIKA}), APP_VERSION 42.46.0→42.47.0, AUTOFINISH_COUNT 725→726, ${TOTAL_ROUTES} ruta, ${TOTAL_API_ROUTES} API, ${TOTAL_DIAGNOSTIKA} dijagnostike`,
  };

  ...
  return NextResponse.json({
    ...
    kontakt: {
      ...
      mejlovi: [
        ...
        billingKontakt?.email ?? 'billing@spaja.rs',
    ...
    racuniAiIqWorldBank: [
      ...
      },
      {
        ...
        opis: 'Novi generisani EUR racun u AI IQ World Bank — za operativne troskove i placanje servisa',
    ...
    transferi: [
      {
        ...
        izvorBanka: 'AI IQ World Bank',
        destinacijaRacun: 'DIGI-IND-002-EUR',
        destinacijaBanka: 'AI IQ World Bank',
        iznos: 10_000,
        valuta: 'EUR',
        opis: 'Transfer 10.000 EUR sa glavnog racuna na novi generisani EUR racun za operativne troskove',
        status: 'izvrseno',
    ...
    dugoviSumarno: {
      opis: 'Pregled trenutnih dugova i obaveza Digitalne Industrije prema partnerima i servisima',
      ...
      ukupnoStavki: 1,
      napomena: 'Dugovi se sumarisu — ceka se konacna potvrda iznosa za Vercel. Ukupan dug za sada je oko $1.000.',
    },

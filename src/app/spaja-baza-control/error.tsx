  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-6">
      <div className="mx-auto max-w-lg text-center">
        ...
        <h1 className="mb-2 text-xl font-bold text-white">Spaja Baza Control — Greška</h1>
        <p className="mb-4 text-sm text-gray-400">
          {error.message || 'Došlo je do greške pri učitavanju stranice Spaja Baza Control.'}
        </p>
        {error.digest && (

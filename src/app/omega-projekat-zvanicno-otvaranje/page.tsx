...
export const metadata: Metadata = {
  ...
  description: 'Zvanično otvaranje OMEGA PROJEKTA prema monolizmima — verifikacija oktavnog monologa, matricno jedinjenje, egzocentrično jezgro — Kompanija SPAJA',
};

...
- Weekly enterprise AI package promotion must include downstream reference back to this repo plus an audit package; linked repo may consume summary status only.

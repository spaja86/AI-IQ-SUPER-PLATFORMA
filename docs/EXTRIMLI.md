...
- EXTRONDOL report builder može primiti governance evidence direktno ili kroz environment evidence (`EXTRONDOL_HUMAN_REVIEW_COMPLETE`, `EXTRONDOL_DOWNSTREAM_SYNC_COMPLETE`) bez menjanja WAWE modela.

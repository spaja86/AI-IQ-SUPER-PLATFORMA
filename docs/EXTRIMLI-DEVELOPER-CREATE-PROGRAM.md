...
- `KRALJEVSKI BAŠTA UNEVERZITE` je bounded additive-only alias unutar istog Developer/Create reflection paketa sa `canonicalNarrativeId=kraljevski-basta-uneverzite-prirodne-maticne-celije-covecanstvu`; objedinjuje `KRALJEVSKA PRODUKTIVNOST / PRAVNO GRAĐANSTVO / BAŠTA / EPILOG ČOVEČANSTVU` i `ČOVEČANSTVO — MATIČNE ĆELIJE I SPOZNAVANJE SEBE` bez novog runtime modula, bez novih formula i bez paralelnog source-of-truth sloja.

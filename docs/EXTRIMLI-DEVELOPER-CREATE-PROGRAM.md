...
- U okviru tog istog zaključanog modela, `POLJOPRIVREDNI FAKULTET` i `GRAĐEVINSKI FAKULTET` postaju additive-only oblasti u katalogu `testovi po oblastima`: prvi pokriva obrazovno-sertifikacioni ulaz za poljoprivrednike i gostoprimstvo, drugi projektovanje, infrastrukturu i operativnu spremnost gazdinstva.

...
- Backward-compatible alias: `EXTRIMLI_EXTREM_UZVISENI_DEGRADATION_PRESSURE_PERCENT` → accepted, ali nije kanonski naziv; kada su oba seta, kanonski `...CONFLICT_DEGRADATION_PRESSURE_PERCENT` ima prioritet.
